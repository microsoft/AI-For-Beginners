...
class SimpleNeuron:
    ...
    def train(self, inputs, target, learning_rate=0.2):
        """
...
def generate_training_data(num_samples=1000, center =5.5, radius = 3, x_range = (0,10), y_range=(0,10)):
    """
    ...
    for _ in range(num_samples):
        ...
        label = 1 if distance_squared <= radius**2 else 0
...
def main():
    ...
    training_data = generate_training_data(num_samples=1000, center =5.5, radius = 3, x_range = (0,10), y_range=(0,10))
