...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T20:12:25+00:00",
...
* **Hlboká matematika** za hlbokým učením. Na tento účel odporúčame knihu [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) od Iana Goodfellowa, Yoshua Bengia a Aarona Courvilla, ktorá je tiež dostupná online na [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).  
...
| 09  |            [Autoenkódery a VAEs](./lessons/4-ComputerVision/09-Autoencoders/README.md)             |           [PyTorch](./lessons/4-ComputerVision/09-Autoencoders/AutoEncodersPyTorch.ipynb) / [TensorFlow](./lessons/4-ComputerVision/09-Autoencoders/AutoencodersTF.ipynb)             |  |
...
* Materiály na predbežné čítanie
...
Ak ste v AI úplný začiatočník a chcete rýchle, praktické príklady, pozrite si naše [**Príklady pre začiatočníkov**](./examples/README.md)! Tieto zahŕňajú:
