...
* **[कॉग्निटिव सर्विसेज](https://azure.microsoft.com/services/cognitive-services/?WT.mc_id=academic-77998-bethanycheum)** का उपयोग करके बनाए गए व्यावहारिक AI अनुप्रयोग। इसके लिए, हम Microsoft Learn पर [विज़न](https://docs.microsoft.com/learn/paths/create-computer-vision-solutions-azure-cognitive-services/?WT.mc_id=academic-77998-bethanycheum), [नेचुरल लैंग्वेज प्रोसेसिंग](https://docs.microsoft.com/learn/paths/explore-natural-language-processing/?WT.mc_id=academic-77998-bethanycheum), **[Azure OpenAI सर्विस के साथ जनरेटिव AI](https://learn.microsoft.com/en-us/training/paths/develop-ai-solutions-azure-openai/?WT.mc_id=academic-77998-bethanycheum)** और अन्य मॉड्यूल से शुरुआत करने की सिफारिश करते हैं।
...
* कुछ अनुभागों में [**MS Learn**](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) मॉड्यूल्स के लिंक होते हैं जो संबंधित विषयों को कवर करते हैं।  
...
- 🧠 **सिंपल न्यूरल नेटवर्क** - स्क्रैच से न्यूरल नेटवर्क बनाएं  
...
ये उदाहरण AI अवधारणाओं को समझने में मदद करने के लिए डिज़ाइन किए गए हैं, इससे पहले कि आप पूरे पाठ्यक्रम में गहराई से जाएं।  

### 📚 पूरा पाठ्यक्रम सेटअप

- हमने आपके विकास पर्यावरण को सेटअप करने में मदद करने के लिए एक [सेटअप पाठ](./lessons/0-course-setup/setup.md) बनाया है।  
- शिक्षकों के लिए, हमने आपके लिए एक [पाठ्यक्रम सेटअप पाठ](./lessons/0-course-setup/for-teachers.md) भी बनाया है!  
- कोड को [VSCode या Codepace में कैसे चलाएं](./lessons/0-course-setup/how-to-run.md)  

इन चरणों का पालन करें:

रिपॉजिटरी को फोर्क करें: इस पृष्ठ के शीर्ष-दाएं कोने पर "Fork" बटन पर क्लिक करें।  

रिपॉजिटरी को क्लोन करें: `git clone https://github.com/microsoft/AI-For-Beginners.git`  
इस रिपॉजिटरी को बाद में आसानी से ढूंढने के लिए इसे स्टार (🌟) करना न भूलें।
...
यदि आप निर्माण करते समय उत्पाद पर प्रतिक्रिया देना चाहते हैं या कोई प्रश्न पूछना चाहते हैं, तो हमारे [Azure AI Foundry Developer Forum](https://aka.ms/foundry/forum) पर जाएं।

## क्विज़

> **क्विज़ के बारे में एक नोट**: सभी क्विज़ `etc\quiz-app` के Quiz-app फ़ोल्डर में हैं, या [ऑनलाइन यहां](https://ff-quizzes.netlify.app/) उपलब्ध हैं। ये पाठों के भीतर से लिंक किए गए हैं। क्विज़ ऐप को स्थानीय रूप से चलाया जा सकता है या Azure पर डिप्लॉय किया जा सकता है; `quiz-app` फ़ोल्डर में दिए गए निर्देशों का पालन करें। इन्हें धीरे-धीरे स्थानीयकृत किया जा रहा है।
...
यदि आप किसी समस्या में फंस जाते हैं या AI ऐप्स बनाने के बारे में कोई प्रश्न हैं, तो जुड़ें:

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

यदि आप निर्माण करते समय उत्पाद पर प्रतिक्रिया देना चाहते हैं या कोई त्रुटि पाते हैं, तो जाएं:
