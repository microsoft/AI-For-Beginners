...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:48:56+00:00",
...
* **डीप लर्निंग के पीछे गहन गणित**। इसके लिए, हम अनुशंसा करेंगे [डीप लर्निंग](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) इयान गुडफेलो, योशुआ बेंगियो और आरोन कौरविले द्वारा, जो ऑनलाइन भी उपलब्ध है [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/)।

_क्लाउड में AI_ विषयों के लिए एक सरल परिचय के लिए, आप [Azure पर कृत्रिम बुद्धिमत्ता के साथ शुरुआत करें](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) सीखने का रास्ता लेने पर विचार कर सकते हैं।
...
* प्री-रीडिंग सामग्री
* निष्पादन योग्य Jupyter नोटबुक्स, जो अक्सर फ्रेमवर्क (**PyTorch** या **TensorFlow**) के लिए विशिष्ट होती हैं। निष्पादन योग्य नोटबुक में बहुत सारा सैद्धांतिक सामग्री भी होती है, इसलिए विषय को समझने के लिए आपको कम से कम एक संस्करण (PyTorch या TensorFlow) का अध्ययन करना होगा।
...
हमारे [आधिकारिक AI Discord सर्वर](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) में शामिल हों ताकि आप इस कोर्स को लेने वाले अन्य शिक्षार्थियों से मिल सकें और नेटवर्क बना सकें और सहायता प्राप्त कर सकें।
...
## क्विज़ 
> **क्विज़ के बारे में एक नोट**: सभी क्विज़ Quiz-app फोल्डर में etc\quiz-app में संग्रहीत हैं, या [ऑनलाइन यहां](https://ff-quizzes.netlify.app/) उपलब्ध हैं। इन्हें पाठों के भीतर से जोड़ा गया है। Quiz-app को लोकल रूप से चलाया जा सकता है या Azure पर डिप्लॉय किया जा सकता है; `quiz-app` फोल्डर में दिए गए निर्देशों का पालन करें। इन्हें धीरे-धीरे स्थानीय भाषाओं में अनुवादित किया जा रहा है।

## मदद की आवश्यकता

क्या आपके पास सुझाव हैं या आपने वर्तनी या कोड में त्रुटियां पाई हैं? एक issue उठाएं या pull request बनाएं।
...
यदि आप कहीं अटक जाते हैं या AI ऐप्स बनाने के बारे में कोई प्रश्न हैं, तो जुड़ें:

[![Azure AI Foundry Discord](https://img.shields.io/badge/Discord-Azure_AI_Foundry_Community_Discord-blue?style=for-the-badge&logo=discord&color=5865f2&logoColor=fff)](https://aka.ms/foundry/discord)

यदि आपको उत्पाद से संबंधित फीडबैक देना है या निर्माण के दौरान कोई त्रुटि आती है, तो यहां जाएं:
