...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T08:41:59+00:00",
...
[![Forks za GitHub](https://img.shields.io/github/forks/microsoft/AI-For-Beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/AI-For-Beginners/network/)
...
* Njia tofauti za Akili Bandia, ikiwa ni pamoja na mbinu ya zamani ya alama na **Uwakilishi wa Maarifa** na hoja ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).
* **Mitandao ya Neva** na **Kujifunza kwa Kina**, ambayo ni msingi wa AI ya kisasa. Tutatumia mifano ya kanuni hizi muhimu kwa kutumia msimbo katika mifumo miwili maarufu - [TensorFlow](http://Tensorflow.org) na [PyTorch](http://pytorch.org).
...
* Mbinu za AI zisizo maarufu, kama vile **Algorithimu za Kijenetiki** na **Mifumo ya Wakala Wengi**.

Yale ambayo hatutashughulikia katika mtaala huu:
...
Kwa utangulizi rahisi wa mada za _AI katika Wingu_, unaweza kufikiria kuchukua njia ya kujifunza [Anza na akili bandia kwenye Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum).
...
| 05  |            [Utangulizi wa Mfumo (PyTorch/TensorFlow) na Overfitting](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Maabara](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
| IV  |            [**Uchambuzi wa Picha za Kompyuta**](./lessons/4-ComputerVision/README.md)             | [PyTorch](https://docs.microsoft.com/learn/modules/intro-computer-vision-pytorch/?WT.mc_id=academic-77998-cacaste) / [TensorFlow](https://docs.microsoft.com/learn/modules/intro-computer-vision-TensorFlow/?WT.mc_id=academic-77998-cacaste)| [Chunguza Uchambuzi wa Picha za Kompyuta kwenye Microsoft Azure](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) |
| 06  |            [Utangulizi wa Uchambuzi wa Picha za Kompyuta. OpenCV](./lessons/4-ComputerVision/06-IntroCV/README.md)             |           [Notebook](./lessons/4-ComputerVision/06-IntroCV/OpenCV.ipynb)         | [Maabara](./lessons/4-ComputerVision/06-IntroCV/lab/README.md) |
...
| 08  |            [Mitandao Iliyofunzwa Awali na Kujifunza Kuhamisha](./lessons/4-ComputerVision/08-TransferLearning/README.md) na [Mbinu za Mafunzo](./lessons/4-ComputerVision/08-TransferLearning/TrainingTricks.md)             |           [PyTorch](./lessons/4-ComputerVision/08-TransferLearning/TransferLearningPyTorch.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Maabara](./lessons/4-ComputerVision/08-TransferLearning/lab/README.md) |
...
| 10  |            [Mitandao ya Generative Adversarial & Uhamishaji wa Mtindo wa Kisanifu](./lessons/4-ComputerVision/10-GANs/README.md)             |           [PyTorch](./lessons/4-ComputerVision/10-GANs/GANPyTorch.ipynb) / [TensorFlow](./lessons/4-ComputerVision/10-GANs/GANTF.ipynb)             |  |
...
| 17  |            [Mitandao ya Kurudia ya Generative](./lessons/5-NLP/17-GenerativeNetworks/README.md)             |           [PyTorch](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/17-GenerativeNetworks/GenerativePyTorch.ipynb) / [TensorFlow](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/17-GenerativeNetworks/GenerativeTF.ipynb)             | [Maabara](./lessons/5-NLP/17-GenerativeNetworks/lab/README.md) |
...
| 22  |            [Kujifunza kwa Kina kwa Kuimarisha](./lessons/6-Other/22-DeepRL/README.md)             |           [PyTorch](./lessons/6-Other/22-DeepRL/CartPole-RL-PyTorch.ipynb) /[TensorFlow](./lessons/6-Other/22-DeepRL/CartPole-RL-TF.ipynb)             | [Maabara](./lessons/6-Other/22-DeepRL/lab/README.md) |
...
* Notebooks za Jupyter zinazoweza kutekelezwa, ambazo mara nyingi ni maalum kwa mfumo (**PyTorch** au **TensorFlow**). Notebook inayoweza kutekelezwa pia ina maudhui mengi ya nadharia, kwa hivyo ili kuelewa mada unahitaji kupitia angalau toleo moja la notebook (ama PyTorch au TensorFlow).
* **Maabara** yanapatikana kwa baadhi ya mada, ambayo yanakupa fursa ya kujaribu kutumia maudhui uliyoyajifunza kwenye tatizo maalum.
...
- Tumeunda [somo la usanidi](./lessons/0-course-setup/setup.md) ili kukusaidia kuanzisha mazingira yako ya maendeleo. - Kwa Walimu, tumeunda pia [somo la usanidi wa mtaala](./lessons/0-course-setup/for-teachers.md)!
...
Ikiwa una maoni ya bidhaa au maswali wakati wa kujenga tembelea [Jukwaa la Azure AI Foundry Developer](https://aka.ms/foundry/forum)
...
Una mapendekezo au umepata makosa ya tahajia au ya programu? Fungua suala au unda ombi la kuvuta (pull request).
...
* **✅ Muundaji wa Maswali ya Majaribio:** [Lateefah Bello](https://github.com/CinnamonXI), [MLSA](https://studentambassadors.microsoft.com/)
