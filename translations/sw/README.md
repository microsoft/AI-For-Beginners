...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T20:06:08+00:00",
...
* **Mitandao ya Neural** na **Kujifunza kwa Kina**, ambavyo ni msingi wa AI ya kisasa. Tutaonyesha dhana za mada hizi muhimu kwa kutumia msimbo katika mifumo miwili maarufu - [TensorFlow](http://Tensorflow.org) na [PyTorch](http://pytorch.org).  
* **Miundo ya Neural** kwa kazi na picha na maandishi. Tutashughulikia mifano ya hivi karibuni lakini huenda tukakosa hali ya kisasa zaidi.  
...
| 04  |                   [Perceptron ya Tabaka Nyingi na Kuunda Mfumo Wetu](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [Notebook](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [Lab](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |
...
| 10  |            [Mitandao ya Kizazi ya Adversarial & Uhamisho wa Mtindo wa Kisanifu](./lessons/4-ComputerVision/10-GANs/README.md)             |           [PyTorch](./lessons/4-ComputerVision/10-GANs/GANPyTorch.ipynb) / [TensorFlow](./lessons/4-ComputerVision/10-GANs/GANTF.ipynb)             |  |
...
| 20  |            [Miundo Mikubwa ya Lugha, Programu ya Maelekezo na Kazi za Few-Shot](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
| 22  |            [Kujifunza kwa Kuimarisha Kina](./lessons/6-Other/22-DeepRL/README.md)             |           [PyTorch](./lessons/6-Other/22-DeepRL/CartPole-RL-PyTorch.ipynb) /[TensorFlow](./lessons/6-Other/22-DeepRL/CartPole-RL-TF.ipynb)             | [Lab](./lessons/6-Other/22-DeepRL/lab/README.md) |
...
* **Labs** zinazopatikana kwa baadhi ya mada, ambazo zinakupa fursa ya kujaribu kutumia maudhui uliyoyajifunza kwa tatizo maalum.
...
Ikiwa wewe ni mpya kabisa kwa AI na unataka mifano ya haraka, ya vitendo, angalia [**Mifano Rafiki kwa Kompyuta**](./examples/README.md)! Hii inajumuisha:
...
Mifano hii imeundwa ili kukusaidia kuelewa dhana za AI kabla ya kuanza mtaala kamili.

### 📚 Mpangilio wa Mtaala Kamili

- Tumeunda [somo la mpangilio](./lessons/0-course-setup/setup.md) kukusaidia kuandaa mazingira yako ya maendeleo. - Kwa Walimu, tumeunda [somo la mpangilio wa mtaala](./lessons/0-course-setup/for-teachers.md) kwa ajili yako pia!
- Jinsi ya [Kuendesha msimbo katika VSCode au Codepace](./lessons/0-course-setup/how-to-run.md)

Fuata hatua hizi:

Fanya Fork ya Hifadhi: Bonyeza kitufe cha "Fork" kwenye kona ya juu-kulia ya ukurasa huu.
...
[![Copilot kwa Uandishi wa AI Pamoja](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
