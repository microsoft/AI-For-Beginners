...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:45:53+00:00",
...
* **Mitandao ya Neural** na **Kujifunza kwa Kina**, ambavyo ni msingi wa AI ya kisasa. Tutaelezea dhana za mada hizi muhimu kwa kutumia msimbo katika mifumo miwili maarufu - [TensorFlow](http://Tensorflow.org) na [PyTorch](http://pytorch.org).  
* **Miundo ya Neural** kwa kazi na picha na maandishi. Tutashughulikia mifano ya hivi karibuni lakini huenda tukakosa baadhi ya hali ya kisasa.  
...
| 04  |                   [Multi-Layered Perceptron na Kuunda Mfumo Wetu Wenyewe](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [Notebook](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [Lab](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |
...
| 08  |            [Mitandao Iliyofunzwa Awali na Kujifunza kwa Uhamisho](./lessons/4-ComputerVision/08-TransferLearning/README.md) na [Mbinu za Mafunzo](./lessons/4-ComputerVision/08-TransferLearning/TrainingTricks.md)             |           [PyTorch](./lessons/4-ComputerVision/08-TransferLearning/TransferLearningPyTorch.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Lab](./lessons/4-ComputerVision/08-TransferLearning/lab/README.md) |
...
| 10  |            [Mitandao ya Generative Adversarial & Uhamisho wa Mtindo wa Kisanii](./lessons/4-ComputerVision/10-GANs/README.md)             |           [PyTorch](./lessons/4-ComputerVision/10-GANs/GANPyTorch.ipynb) / [TensorFlow](./lessons/4-ComputerVision/10-GANs/GANTF.ipynb)             |  |
...
| 17  |            [Mitandao ya Generative ya Kurudiarudia](./lessons/5-NLP/17-GenerativeNetworks/README.md)             |           [PyTorch](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/17-GenerativeNetworks/GenerativePyTorch.ipynb) / [TensorFlow](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/17-GenerativeNetworks/GenerativeTF.ipynb)             | [Lab](./lessons/5-NLP/17-GenerativeNetworks/lab/README.md) |
...
| 22  |            [Kujifunza kwa Kuimarisha kwa Kina](./lessons/6-Other/22-DeepRL/README.md)             |           [PyTorch](./lessons/6-Other/22-DeepRL/CartPole-RL-PyTorch.ipynb) /[TensorFlow](./lessons/6-Other/22-DeepRL/CartPole-RL-TF.ipynb)             | [Lab](./lessons/6-Other/22-DeepRL/lab/README.md) |
...
* Jupyter Notebooks zinazoweza kutekelezwa, ambazo mara nyingi ni maalum kwa mfumo (**PyTorch** au **TensorFlow**). Notebook inayoweza kutekelezwa pia ina nyenzo nyingi za kinadharia, kwa hivyo ili kuelewa mada unahitaji kupitia angalau toleo moja la notebook (ama PyTorch au TensorFlow).
* **Maabara** yanayopatikana kwa baadhi ya mada, ambayo yanakupa fursa ya kujaribu kutumia nyenzo ulizojifunza kwa tatizo maalum.
...
- 🖼️ **Kainisha Picha** - Kainisha picha na maelezo ya kina
- 💬 **Hisia za Maandishi** - Changanua maandishi chanya/hasira

Mifano hii imeundwa ili kukusaidia kuelewa dhana za AI kabla ya kuingia kwenye mtaala kamili.

### 📚 Usanidi wa Mtaala Kamili

- Tumeunda [somo la usanidi](./lessons/0-course-setup/setup.md) kukusaidia kuandaa mazingira yako ya maendeleo. - Kwa Walimu, tumeunda [somo la usanidi wa mtaala](./lessons/0-course-setup/for-teachers.md) kwa ajili yako pia!
- Jinsi ya [Kuendesha msimbo katika VSCode au Codepace](./lessons/0-course-setup/how-to-run.md)

Fuata hatua hizi:

Fork Hifadhi: Bonyeza kitufe cha "Fork" kilicho juu-kulia ya ukurasa huu.
...
Jiunge na [seva rasmi ya AI ya Discord](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) kukutana na kuungana na wanafunzi wengine wanaochukua kozi hii na kupata msaada.

Ikiwa una maoni ya bidhaa au maswali wakati wa kujenga, tembelea [Jukwaa la Wataalamu wa Azure AI Foundry](https://aka.ms/foundry/forum)

## Maswali ya Quiz

> **Kuhusu maswali ya quiz**: Maswali yote ya quiz yamehifadhiwa kwenye folda ya Quiz-app katika etc\quiz-app, au [Mtandaoni Hapa](https://ff-quizzes.netlify.app/) Yameunganishwa kutoka ndani ya masomo, programu ya quiz inaweza kuendeshwa ndani ya nchi au kupelekwa kwenye Azure; fuata maelekezo kwenye folda ya `quiz-app`. Yanatafsiriwa hatua kwa hatua.

## Msaada Unahitajika

Je, una mapendekezo au umepata makosa ya tahajia au msimbo? Fungua suala au unda ombi la kuvuta.
...
### LangChain
[![LangChain4j kwa Kompyuta](https://img.shields.io/badge/LangChain4j%20kwa%20Kompyuta-22C55E?style=for-the-badge&&labelColor=E5E7EB&color=0553D6)](https://aka.ms/langchain4j-for-beginners)
[![LangChain.js kwa Kompyuta](https://img.shields.io/badge/LangChain.js%20kwa%20Kompyuta-22C55E?style=for-the-badge&labelColor=E5E7EB&color=0553D6)](https://aka.ms/langchainjs-for-beginners?WT.mc_id=m365-94501-dwahlin)
...
[![AI Inayozalisha kwa Kompyuta](https://img.shields.io/badge/AI%20Inayozalisha%20kwa%20Kompyuta-8B5CF6?style=for-the-badge&labelColor=E5E7EB&color=8B5CF6)](https://github.com/microsoft/generative-ai-for-beginners?WT.mc_id=academic-105485-koreyst)
