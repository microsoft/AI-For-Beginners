...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-24T09:11:04+00:00",
...
[![GitHub overvågere](https://img.shields.io/github/watchers/microsoft/AI-For-Beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/AI-For-Beginners/watchers/)  
...
Udforsk verdenen af **Kunstig Intelligens** (AI) med vores 12-ugers, 24-lektioners pensum! Det inkluderer praktiske lektioner, quizzer og laboratorier. Pensummet er begyndervenligt og dækker værktøjer som TensorFlow og PyTorch samt etik inden for AI.  
...
* **Neurale Arkitekturer** til arbejde med billeder og tekst. Vi vil dække nyere modeller, men kan mangle lidt på det nyeste inden for området.  
