...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T08:18:45+00:00",
...
* **Labbar** som är tillgängliga för vissa ämnen, vilket ger dig möjlighet att tillämpa det material du har lärt dig på ett specifikt problem.
...
Gå med i vår [officiella AI Discord-server](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) för att träffa och nätverka med andra elever som går denna kurs och få stöd.
...
## Quiz
> **En notering om frågesporter**: Alla frågesporter finns i mappen Quiz-app i etc\quiz-app, eller [Online Här](https://ff-quizzes.netlify.app/). De är länkade från lektionerna och frågesportsappen kan köras lokalt eller distribueras till Azure; följ instruktionerna i mappen `quiz-app`. De lokaliseras gradvis.
