...
* **Neurala arkitekturer** för att arbeta med bilder och text. Vi kommer att täcka aktuella modeller men kanske sakna det allra senaste.
* Mindre populära AI-metoder, såsom **Genetiska algoritmer** och **Multi-Agent Systems**.
...
* **Djup matematik** bakom djupinlärning. För detta skulle vi rekommendera [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) av Ian Goodfellow, Yoshua Bengio och Aaron Courville, som också finns tillgänglig online på [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).
...
- För lärare har vi också skapat en [kursuppsättningslektion](./lessons/0-course-setup/for-teachers.md)!  
- Hur man [kör koden i VSCode eller Codespace](./lessons/0-course-setup/how-to-run.md)  
