...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T09:20:45+00:00",
...
**Artificiell Intelligens** är en spännande vetenskaplig disciplin som studerar hur vi kan få datorer att uppvisa intelligent beteende, t.ex. göra sådant som människor är bra på.
...
Svag AI är mycket specialiserad och saknar mänskliga kognitiva förmågor eller generell problemlösningsförmåga utanför sitt begränsade område.|Stark AI är för närvarande ett teoretiskt koncept, och inget AI-system har nått denna nivå av generell intelligens.

För mer information, se **[Artificiell Allmän Intelligens](https://en.wikipedia.org/wiki/Artificial_general_intelligence)** (AGI).
...
* Tidiga schackprogram baserades på sökning – ett program försökte explicit uppskatta möjliga drag från en motståndare för ett givet antal kommande drag och valde ett optimalt drag baserat på den optimala positionen som kan uppnås inom några drag. Detta ledde till utvecklingen av den så kallade [alpha-beta beskärning](https://en.wikipedia.org/wiki/Alpha%E2%80%93beta_pruning) sökalgoritmen.
...
* Moderna program som vinner över mänskliga spelare baseras på neurala nätverk och [förstärkningsinlärning](https://en.wikipedia.org/wiki/Reinforcement_learning), där programmen lär sig att spela enbart genom att spela länge mot sig själva och lära sig av sina egna misstag – ungefär som människor gör när de lär sig spela schack. Men ett datorprogram kan spela många fler spel på mycket kortare tid och därmed lära sig mycket snabbare.
...
* Tidiga program av denna typ, såsom [Eliza](https://en.wikipedia.org/wiki/ELIZA), baserades på mycket enkla grammatiska regler och omformulering av inmatade meningar till frågor.
* Moderna assistenter, såsom Cortana, Siri eller Google Assistant, är alla hybridsystem som använder neurala nätverk för att konvertera tal till text och känna igen vår avsikt, och sedan använder vissa resonemang eller explicita algoritmer för att utföra önskade åtgärder.
* I framtiden kan vi förvänta oss en komplett neuralbaserad modell som hanterar dialoger självständigt. Den senaste GPT- och [Turing-NLG](https://turing.microsoft.com/) familjen av neurala nätverk visar stor framgång i detta.

<img alt="Turing-testets utveckling" src="images/turing-test-evol.png" width="70%"/>
...
Sedan dess har neurala nätverk visat sig vara mycket framgångsrika i många uppgifter:
...
Gå igenom AI:s och maskininlärningens historia genom att läsa [denna lektion](https://github.com/microsoft/ML-For-Beginners/tree/main/1-Introduction/2-history-of-ML). Välj ett element från sketchnoten i början av den lektionen eller denna och undersök det mer ingående för att förstå den kulturella kontexten som påverkat dess utveckling.
