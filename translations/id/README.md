...
Jelajahi dunia **Kecerdasan Buatan** (AI) dengan kurikulum 12 minggu, 24 pelajaran kami! Ini mencakup pelajaran praktis, kuis, dan lab. Kurikulum ini ramah pemula dan mencakup alat-alat seperti TensorFlow dan PyTorch, serta etika dalam AI
...
> ```
>
> Ini memberi Anda semua yang Anda butuhkan untuk menyelesaikan kursus dengan unduhan yang lebih cepat.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**Jika Anda ingin mendukung tambahan bahasa terjemahan yang didukung, lihat daftar [di sini](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
* **Jaringan Saraf** dan **Pembelajaran Mendalam**, yang merupakan inti dari AI modern. Kami akan mengilustrasikan konsep di balik topik penting ini menggunakan kode dalam dua framework paling populer - [TensorFlow](http://Tensorflow.org) dan [PyTorch](http://pytorch.org).
* **Arsitektur Saraf** untuk bekerja dengan gambar dan teks. Kami akan membahas model-model terbaru tetapi mungkin agak kurang dalam yang terkini.
...
* **Matematika Mendalam** di balik pembelajaran mendalam. Untuk ini, kami menyarankan [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) oleh Ian Goodfellow, Yoshua Bengio dan Aaron Courville, yang juga tersedia online di [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).

Untuk pengenalan ringan ke topik _AI di Cloud_, Anda dapat mempertimbangkan mengambil Jalur Pembelajaran [Memulai dengan kecerdasan buatan di Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum).

# Konten

|     |                                                                 Tautan Pelajaran                                                                  |                                           PyTorch/Keras/TensorFlow                                          | Lab                                                            |
| :-: | :------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: | ------------------------------------------------------------------------------ |
| 0  |                                 [Pengaturan Kursus](./lessons/0-course-setup/setup.md)                                 |                      [Pasang Lingkungan Pengembangan Anda](./lessons/0-course-setup/how-to-run.md)                       |   |
...
| 19  |            [Pengakuan Entitas Bernama](./lessons/5-NLP/19-NER/README.md)             |           [TensorFlow](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/19-NER/NER-TF.ipynb)             | [Lab](./lessons/5-NLP/19-NER/lab/README.md) |
...
* Materi pra-baca
* Jupyter Notebooks yang dapat dieksekusi, yang sering kali spesifik untuk kerangka kerja (**PyTorch** atau **TensorFlow**). Notebook yang dapat dieksekusi juga berisi banyak materi teoretis, jadi untuk memahami topik ini Anda perlu melalui setidaknya satu versi notebook (baik PyTorch atau TensorFlow).
...
Jika Anda benar-benar baru mengenal AI dan ingin contoh cepat yang praktis, lihat [**Contoh Ramah Pemula**](./examples/README.md) kami! Ini termasuk:

- 🌟 **Hello AI World** - Program AI pertama Anda (pengenalan pola)
- 🧠 **Jaringan Neural Sederhana** - Membangun jaringan neural dari awal  
- 🖼️ **Klasifikator Gambar** - Mengklasifikasikan gambar dengan komentar rinci
- 💬 **Sentimen Teks** - Menganalisis teks positif/negatif

Contoh-contoh ini dirancang untuk membantu Anda memahami konsep AI sebelum menelusuri kurikulum lengkap.

### 📚 Pengaturan Kurikulum Lengkap

- Kami telah membuat [pelajaran pengaturan](./lessons/0-course-setup/setup.md) untuk membantu Anda menyiapkan lingkungan pengembangan Anda. - Untuk para Pendidik, kami juga telah membuat [pelajaran pengaturan kurikulum](./lessons/0-course-setup/for-teachers.md) untuk Anda!
...
Jangan lupa beri bintang (🌟) pada repo ini untuk memudahkan pencarian nanti.
...
Jika Anda memiliki masukan produk atau pertanyaan selama pembangunan, kunjungi [Forum Pengembang Azure AI Foundry](https://aka.ms/foundry/forum)

## Kuis 

> **Catatan tentang kuis**: Semua kuis terdapat dalam folder Quiz-app di etc\quiz-app, atau [Online Di Sini](https://ff-quizzes.netlify.app/) Mereka terhubung dari dalam pelajaran, aplikasi kuis dapat dijalankan secara lokal atau dideploy ke Azure; ikuti petunjuk di folder `quiz-app`. Mereka sedang secara bertahap dilokalisasi.

## Butuh Bantuan

Apakah Anda memiliki saran atau menemukan kesalahan ejaan atau kode? Buat masalah atau buat permintaan tarik.
...
Jika Anda terjebak atau memiliki pertanyaan tentang membangun aplikasi AI. Bergabunglah dengan para pelajar dan pengembang berpengalaman dalam diskusi tentang MCP. Ini adalah komunitas yang mendukung di mana pertanyaan disambut dan pengetahuan dibagikan dengan bebas.

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

Jika Anda memiliki masukan produk atau kesalahan selama pembangunan kunjungi:
...
**Penafian**:  
Dokumen ini telah diterjemahkan menggunakan layanan terjemahan AI [Co-op Translator](https://github.com/Azure/co-op-translator). Meskipun kami berupaya untuk akurasi, harap diperhatikan bahwa terjemahan otomatis mungkin mengandung kesalahan atau ketidakakuratan. Dokumen asli dalam bahasa aslinya harus dianggap sebagai sumber yang otoritatif. Untuk informasi penting, disarankan menggunakan jasa terjemahan manusia profesional. Kami tidak bertanggung jawab atas kesalahpahaman atau kesalahan interpretasi yang timbul dari penggunaan terjemahan ini.
