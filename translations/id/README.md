...
* **Arsitektur Neural** untuk bekerja dengan gambar dan teks. Kami akan membahas model terbaru tetapi mungkin agak kurang dalam state-of-the-art.
...
Jika Anda benar-benar baru di AI dan ingin contoh cepat yang bisa langsung dipraktikkan, lihat [**Contoh Ramah Pemula**](./examples/README.md) kami! Ini termasuk:
...
> **Catatan tentang kuis**: Semua kuis terdapat di folder Quiz-app di etc\quiz-app, atau [Online Di Sini](https://ff-quizzes.netlify.app/) Kuis tersebut terhubung dari dalam pelajaran, aplikasi kuis dapat dijalankan secara lokal atau dideploy ke Azure; ikuti instruksi di folder `quiz-app`. Kuis-kuis ini sedang secara bertahap dilokalisasi.
