...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-07T13:24:14+00:00",
...
* **Arquitecturas Neuronales** para trabajar con imágenes y texto. Cubriremos modelos recientes, aunque puede que falte algo de lo más avanzado.  
...
| 08  |            [Redes Pre-entrenadas y Transfer Learning](./lessons/4-ComputerVision/08-TransferLearning/README.md) y [Trucos de Entrenamiento](./lessons/4-ComputerVision/08-TransferLearning/TrainingTricks.md)             |           [PyTorch](./lessons/4-ComputerVision/08-TransferLearning/TransferLearningPyTorch.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Laboratorio](./lessons/4-ComputerVision/08-TransferLearning/lab/README.md) |
...
* Notebooks ejecutables de Jupyter, que a menudo son específicos para el framework (**PyTorch** o **TensorFlow**). El notebook ejecutable también incluye mucho material teórico, por lo que para entender el tema es necesario revisar al menos una versión del notebook (ya sea PyTorch o TensorFlow).
...
- Cómo [Ejecutar el código en VSCode o CodeSpace](./lessons/0-course-setup/how-to-run.md)
...
¡Nuestro equipo produce otros planes de estudio! Échales un vistazo:
