...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-21T10:18:42+00:00",
...
#### Compatibilidad mediante GitHub Action (Automatizado y siempre actualizado)
...
**Si deseas que se admitan idiomas de traducción adicionales, están listados [aquí](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
* **Arquitecturas neuronales** para trabajar con imágenes y texto. Cubriremos modelos recientes pero puede que estemos un poco por detrás del estado del arte.
...
Para una introducción suave a los temas de _IA en la nube_ puedes considerar tomar la ruta de aprendizaje [Get started with artificial intelligence on Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) de Microsoft Learn.

# Contenido

|     |                                                                 Enlace de la lección                                                                  |                                           PyTorch/Keras/TensorFlow                                          | Laboratorio                                                            |
| :-: | :------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: | ------------------------------------------------------------------------------ |
| 0  |                                 [Course Setup](./lessons/0-course-setup/setup.md)                                 |                      [Configura tu entorno de desarrollo](./lessons/0-course-setup/how-to-run.md)                       |   |
| I  |               [**Introducción a la Inteligencia Artificial**](./lessons/1-Intro/README.md)      | | |
...
Si eres completamente nuevo en IA y quieres ejemplos breves y prácticos, ¡consulta nuestros [**Ejemplos para principiantes**](./examples/README.md)! Estos incluyen:
...
- 💬 **Sentimiento de texto** - Analizar texto positivo/negativo
...
Únete a nuestro [servidor oficial de Discord de IA](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) para conocer y establecer contactos con otros estudiantes que están tomando este curso y obtener apoyo.
...
> **Una nota sobre los cuestionarios**: Todos los cuestionarios están contenidos en la carpeta Quiz-app en etc\quiz-app, o [en línea aquí](https://ff-quizzes.netlify.app/) They are linked from within the lessons the quiz app can be run locally or deployed to Azure; follow the instruction in the `quiz-app` folder. They are gradually being localized.

## Se necesita ayuda

¿Tienes sugerencias o has encontrado errores ortográficos o de código? Abre un issue o crea un pull request.
