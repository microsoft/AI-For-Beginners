...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T08:38:32+00:00",
...
**Kecerdasan Buatan** adalah disiplin saintifik yang menarik yang mengkaji bagaimana kita boleh membuat komputer menunjukkan tingkah laku yang cerdas, contohnya melakukan perkara-perkara yang manusia pandai lakukan.

Pada asalnya, komputer dicipta oleh [Charles Babbage](https://en.wikipedia.org/wiki/Charles_Babbage) untuk beroperasi dengan nombor mengikut prosedur yang jelas - iaitu algoritma. Komputer moden, walaupun jauh lebih maju daripada model asal yang dicadangkan pada abad ke-19, masih mengikuti idea yang sama iaitu pengiraan terkawal. Oleh itu, adalah mungkin untuk memprogramkan komputer untuk melakukan sesuatu jika kita tahu urutan langkah yang tepat yang perlu dilakukan untuk mencapai matlamat tersebut.
...
> ✅ Menentukan umur seseorang daripada fotonya adalah tugas yang tidak boleh diprogramkan secara eksplisit, kerana kita tidak tahu bagaimana kita menghasilkan nombor dalam fikiran kita apabila melakukannya.

---

Namun, terdapat beberapa tugas yang kita tidak tahu secara eksplisit bagaimana untuk menyelesaikannya. Pertimbangkan menentukan umur seseorang daripada fotonya. Kita belajar melakukannya kerana kita telah melihat banyak contoh orang dari pelbagai umur, tetapi kita tidak dapat menjelaskan secara eksplisit bagaimana kita melakukannya, dan kita juga tidak dapat memprogramkan komputer untuk melakukannya. Inilah jenis tugas yang menarik perhatian **Kecerdasan Buatan** (AI).

✅ Fikirkan beberapa tugas yang boleh anda serahkan kepada komputer yang akan mendapat manfaat daripada AI. Pertimbangkan bidang kewangan, perubatan, dan seni - bagaimana bidang-bidang ini mendapat manfaat daripada AI hari ini?
...
Sistem AI ini tidak cerdas secara umum; ia cemerlang dalam melaksanakan tugas yang telah ditentukan tetapi tidak memiliki pemahaman atau kesedaran sebenar.|Sistem AI ini mempunyai keupayaan untuk melaksanakan sebarang tugas intelektual yang boleh dilakukan oleh manusia, menyesuaikan diri dengan pelbagai domain, dan memiliki bentuk kesedaran atau keinsafan diri.
...
AI Lemah sangat khusus dan tidak memiliki keupayaan kognitif seperti manusia atau keupayaan menyelesaikan masalah secara umum di luar domain sempitnya.|AI Kuat kini adalah konsep teori, dan tiada sistem AI yang telah mencapai tahap kecerdasan umum ini.
...
Untuk melihat kekaburan istilah *kecerdasan*, cuba jawab soalan: "Adakah kucing cerdas?". Orang yang berbeza cenderung memberikan jawapan yang berbeza kepada soalan ini, kerana tiada ujian yang diterima secara universal untuk membuktikan kenyataan itu benar atau tidak. Dan jika anda fikir ada - cuba jalankan kucing anda melalui ujian IQ...

✅ Luangkan masa sebentar untuk memikirkan bagaimana anda mendefinisikan kecerdasan. Adakah burung gagak yang boleh menyelesaikan labirin dan mendapatkan makanan dianggap cerdas? Adakah seorang kanak-kanak cerdas?

---

Apabila bercakap tentang AGI, kita perlu mempunyai cara untuk menentukan sama ada kita telah mencipta sistem yang benar-benar cerdas. [Alan Turing](https://en.wikipedia.org/wiki/Alan_Turing) mencadangkan satu cara yang dipanggil **[Ujian Turing](https://en.wikipedia.org/wiki/Turing_test)**, yang juga bertindak sebagai definisi kecerdasan. Ujian ini membandingkan sistem tertentu dengan sesuatu yang sememangnya cerdas - seorang manusia sebenar, dan kerana sebarang perbandingan automatik boleh dielakkan oleh program komputer, kita menggunakan seorang penyiasat manusia. Jadi, jika seorang manusia tidak dapat membezakan antara orang sebenar dan sistem komputer dalam dialog berasaskan teks - sistem itu dianggap cerdas.

> Chatbot bernama [Eugene Goostman](https://en.wikipedia.org/wiki/Eugene_Goostman), yang dibangunkan di St. Petersburg, hampir lulus ujian Turing pada tahun 2014 dengan menggunakan helah personaliti yang bijak. Ia mengumumkan terlebih dahulu bahawa ia adalah seorang budak lelaki Ukraine berusia 13 tahun, yang akan menjelaskan kekurangan pengetahuan dan beberapa ketidakkonsistenan dalam teks. Bot itu meyakinkan 30% hakim bahawa ia adalah manusia selepas dialog selama 5 minit, metrik yang Turing percaya mesin akan dapat lulus menjelang tahun 2000. Walau bagaimanapun, seseorang harus memahami bahawa ini tidak menunjukkan bahawa kita telah mencipta sistem cerdas, atau bahawa sistem komputer telah memperdayakan penyiasat manusia - sistem itu tidak memperdayakan manusia, tetapi pencipta bot yang melakukannya!

✅ Pernahkah anda diperdaya oleh chatbot sehingga anda fikir anda sedang bercakap dengan manusia? Bagaimana ia meyakinkan anda?

## Pendekatan Berbeza terhadap AI

Jika kita mahu komputer berkelakuan seperti manusia, kita perlu memodelkan cara kita berfikir di dalam komputer. Oleh itu, kita perlu cuba memahami apa yang menjadikan manusia cerdas.

> Untuk dapat memprogramkan kecerdasan ke dalam mesin, kita perlu memahami bagaimana proses membuat keputusan kita sendiri berfungsi. Jika anda melakukan sedikit introspeksi diri, anda akan menyedari bahawa terdapat beberapa proses yang berlaku secara bawah sedar – contohnya, kita boleh membezakan kucing daripada anjing tanpa memikirkannya - manakala yang lain melibatkan penaakulan.
...
Terdapat juga beberapa pendekatan lain yang mungkin terhadap kecerdasan:
...
Kita akan mempertimbangkan pendekatan-pendekatan ini kemudian dalam kursus, tetapi buat masa ini kita akan fokus pada dua arah utama: atas ke bawah dan bawah ke atas.
...
Manusia cenderung mempunyai beberapa peraturan dalam fikiran mereka yang membimbing proses membuat keputusan mereka. Contohnya, apabila seorang doktor mendiagnosis pesakit, dia mungkin menyedari bahawa seseorang itu demam, dan oleh itu mungkin terdapat beberapa keradangan yang berlaku di dalam badan. Dengan menggunakan satu set peraturan yang besar untuk masalah tertentu, seorang doktor mungkin dapat menghasilkan diagnosis akhir.

Pendekatan ini sangat bergantung pada **perwakilan pengetahuan** dan **penaakulan**. Mengekstrak pengetahuan daripada pakar manusia mungkin merupakan bahagian yang paling sukar, kerana seorang doktor dalam banyak kes tidak tahu dengan tepat mengapa dia menghasilkan diagnosis tertentu. Kadang-kadang penyelesaian hanya muncul dalam fikirannya tanpa pemikiran eksplisit. Beberapa tugas, seperti menentukan umur seseorang daripada foto, tidak boleh sama sekali dikurangkan kepada manipulasi pengetahuan.

### Pendekatan Bawah ke Atas

Sebagai alternatif, kita boleh cuba memodelkan elemen paling mudah di dalam otak kita – iaitu neuron. Kita boleh membina apa yang dipanggil **rangkaian neural tiruan** di dalam komputer, dan kemudian cuba mengajarnya untuk menyelesaikan masalah dengan memberikannya contoh. Proses ini serupa dengan bagaimana seorang bayi baru lahir belajar tentang persekitarannya dengan membuat pemerhatian.

✅ Lakukan sedikit penyelidikan tentang bagaimana bayi belajar. Apakah elemen asas otak bayi?

> | Bagaimana dengan ML?         |      |
> |--------------|-----------|
> | Bahagian Kecerdasan Buatan yang berdasarkan komputer belajar untuk menyelesaikan masalah berdasarkan beberapa data dipanggil **Pembelajaran Mesin**. Kita tidak akan mempertimbangkan pembelajaran mesin klasik dalam kursus ini - kami merujuk anda kepada kurikulum [Machine Learning for Beginners](http://aka.ms/ml-beginners) yang berasingan. |   ![ML untuk Pemula](../../../../translated_images/ml-for-beginners.9e4fed176fd5817d7d1f7d358302515186579cbf09b2a6c5bd8092b345da7f22.ms.png)    |

## Sejarah Ringkas AI

Kecerdasan Buatan bermula sebagai satu bidang pada pertengahan abad ke-20. Pada mulanya, pendekatan penaakulan simbolik adalah pendekatan yang dominan, dan ia membawa kepada beberapa kejayaan penting, seperti sistem pakar – program komputer yang mampu bertindak sebagai pakar dalam beberapa domain masalah yang terhad. Walau bagaimanapun, tidak lama kemudian menjadi jelas bahawa pendekatan sedemikian tidak berskala dengan baik. Mengekstrak pengetahuan daripada pakar, mewakilkannya di dalam komputer, dan memastikan pangkalan pengetahuan itu tepat ternyata menjadi tugas yang sangat kompleks, dan terlalu mahal untuk praktikal dalam banyak kes. Ini membawa kepada apa yang dipanggil [AI Winter](https://en.wikipedia.org/wiki/AI_winter) pada tahun 1970-an.
...
Apabila masa berlalu, sumber pengkomputeran menjadi lebih murah, dan lebih banyak data tersedia, pendekatan rangkaian neural mula menunjukkan prestasi yang hebat dalam bersaing dengan manusia dalam banyak bidang, seperti penglihatan komputer atau pemahaman ucapan. Dalam dekad yang lalu, istilah Kecerdasan Buatan kebanyakannya digunakan sebagai sinonim untuk Rangkaian Neural, kerana kebanyakan kejayaan AI yang kita dengar adalah berdasarkan mereka.

Kita boleh melihat bagaimana pendekatan berubah, contohnya, dalam mencipta program komputer bermain catur:

* Program catur awal berdasarkan carian – program secara eksplisit cuba menganggarkan kemungkinan langkah lawan untuk beberapa langkah seterusnya, dan memilih langkah yang optimum berdasarkan kedudukan optimum yang boleh dicapai dalam beberapa langkah. Ia membawa kepada pembangunan algoritma carian [pemangkasan alpha-beta](https://en.wikipedia.org/wiki/Alpha%E2%80%93beta_pruning).
* Strategi carian berfungsi dengan baik ke arah akhir permainan, di mana ruang carian dihadkan oleh sejumlah kecil langkah yang mungkin. Walau bagaimanapun, pada permulaan permainan, ruang carian adalah besar, dan algoritma boleh diperbaiki dengan belajar daripada perlawanan sedia ada antara pemain manusia. Eksperimen berikutnya menggunakan apa yang dipanggil [penaakulan berasaskan kes](https://en.wikipedia.org/wiki/Case-based_reasoning), di mana program mencari kes dalam pangkalan pengetahuan yang sangat serupa dengan kedudukan semasa dalam permainan.
* Program moden yang menang ke atas pemain manusia adalah berdasarkan rangkaian neural dan [pembelajaran pengukuhan](https://en.wikipedia.org/wiki/Reinforcement_learning), di mana program belajar bermain semata-mata dengan bermain lama terhadap dirinya sendiri dan belajar daripada kesilapannya sendiri – sama seperti manusia belajar bermain catur. Walau bagaimanapun, program komputer boleh bermain lebih banyak permainan dalam masa yang lebih singkat, dan oleh itu boleh belajar dengan lebih cepat.
...
* Pembantu moden, seperti Cortana, Siri atau Google Assistant adalah semua sistem hibrid yang menggunakan rangkaian neural untuk menukar ucapan kepada teks dan mengenali niat kita, dan kemudian menggunakan beberapa penaakulan atau algoritma eksplisit untuk melaksanakan tindakan yang diperlukan.
* Pada masa depan, kita mungkin menjangkakan model berasaskan neural sepenuhnya untuk mengendalikan dialog dengan sendirinya. Keluarga rangkaian neural GPT dan [Turing-NLG](https://www.microsoft.com/research/blog/turing-nlg-a-17-billion-parameter-language-model-by-microsoft) baru-baru ini menunjukkan kejayaan yang hebat dalam hal ini.
