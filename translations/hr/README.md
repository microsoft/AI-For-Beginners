...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T11:06:27+00:00",
...
* **Neuralne mreže** i **duboko učenje**, koji su srž moderne AI tehnologije. Ilustrirat ćemo koncepte iza ovih važnih tema koristeći kod u dva najpopularnija okvira - [TensorFlow](http://Tensorflow.org) i [PyTorch](http://pytorch.org).
* **Neuralne arhitekture** za rad s slikama i tekstom. Pokrit ćemo nedavne modele, iako možda nećemo obuhvatiti najnovije dostignuće.
...
| 08  |            [Unaprijed trenirane mreže i prijenosno učenje](./lessons/4-ComputerVision/08-TransferLearning/README.md) i [Trikovi za treniranje](./lessons/4-ComputerVision/08-TransferLearning/TrainingTricks.md)             |           [PyTorch](./lessons/4-ComputerVision/08-TransferLearning/TransferLearningPyTorch.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Laboratorij](./lessons/4-ComputerVision/08-TransferLearning/lab/README.md) |
...
* Izvršne Jupyter bilježnice, često specifične za okvir (**PyTorch** ili **TensorFlow**). Izvršna bilježnica također sadrži mnogo teorijskog materijala, pa je za razumijevanje teme potrebno proći barem jednu verziju bilježnice (bilo PyTorch ili TensorFlow).
...
Ovi primjeri osmišljeni su kako bi vam pomogli razumjeti AI koncepte prije nego što se upustite u cijeli kurikulum.
