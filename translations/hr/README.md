...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T12:14:58+00:00",
...
Istražite svijet **Umjetne inteligencije** (AI) s našim 12-tjednim, 24-lekcijskim nastavnim planom! Uključuje praktične lekcije, kvizove i laboratorijske vježbe. Nastavni plan je prilagođen početnicima i pokriva alate poput TensorFlow i PyTorch, kao i etiku u AI
...
**Ako želite da budu podržani dodatni jezici prijevoda, popis je dostupan [ovdje](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
* **Neuronske mreže** i **Duboko učenje**, koje su u središtu moderne AI. Ilustrirat ćemo koncepte iza ovih važnih tema koristeći kod u dva najpopularnija okvira - [TensorFlow](http://Tensorflow.org) i [PyTorch](http://pytorch.org).
* **Neuronske arhitekture** za rad sa slikama i tekstom. Pokrit ćemo nedavne modele, ali možda ćemo biti malo oskudni u najnovijim dostignućima.
...
* **Klasično strojno učenje**, koje je dobro opisano u našem [Nastavnom planu strojnog učenja za početnike](http://github.com/Microsoft/ML-for-Beginners).
* Praktične AI aplikacije izgrađene korištenjem **[Kognitivnih usluga](https://azure.microsoft.com/services/cognitive-services/?WT.mc_id=academic-77998-bethanycheum)**. Za to preporučujemo da započnete s modulima Microsoft Learn za [vid](https://docs.microsoft.com/learn/paths/create-computer-vision-solutions-azure-cognitive-services/?WT.mc_id=academic-77998-bethanycheum), [obradu prirodnog jezika](https://docs.microsoft.com/learn/paths/explore-natural-language-processing/?WT.mc_id=academic-77998-bethanycheum), **[Generativnu AI s Azure OpenAI uslugom](https://learn.microsoft.com/en-us/training/paths/develop-ai-solutions-azure-openai/?WT.mc_id=academic-77998-bethanycheum)** i druge.
* Specifične ML **Cloud okvire**, poput [Azure Machine Learning](https://azure.microsoft.com/services/machine-learning/?WT.mc_id=academic-77998-bethanycheum), [Microsoft Fabric](https://learn.microsoft.com/en-us/training/paths/get-started-fabric/?WT.mc_id=academic-77998-bethanycheum), ili [Azure Databricks](https://docs.microsoft.com/learn/paths/data-engineer-azure-databricks?WT.mc_id=academic-77998-bethanycheum). Razmotrite korištenje [Izgradite i upravljajte rješenjima strojnog učenja s Azure Machine Learning](https://docs.microsoft.com/learn/paths/build-ai-solutions-with-azure-ml-service/?WT.mc_id=academic-77998-bethanycheum) i [Izgradite i upravljajte rješenjima strojnog učenja s Azure Databricks](https://docs.microsoft.com/learn/paths/build-operate-machine-learning-solutions-azure-databricks/?WT.mc_id=academic-77998-bethanycheum) nastavnih putova.
* **Konverzacijska AI** i **Chat Botove**. Postoji zaseban [Nastavni put za stvaranje konverzacijskih AI rješenja](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum), a možete se također obratiti [ovom blog postu](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) za više detalja.
* **Duboku matematiku** iza dubokog učenja. Za to preporučujemo [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) autora Ian Goodfellow, Yoshua Bengio i Aaron Courville, koja je također dostupna online na [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).

Za nježni uvod u teme _AI u oblaku_ možete razmotriti pohađanje [Početak rada s umjetnom inteligencijom na Azureu](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) nastavnog puta.
...
| II |              **Simbolička AI**              |
| 02  |       [Predstavljanje znanja i ekspertni sustavi](./lessons/2-Symbolic/README.md)       |            [Ekspertni sustavi](./lessons/2-Symbolic/Animals.ipynb) /  [Ontologija](./lessons/2-Symbolic/FamilyOntology.ipynb) /[Graf pojmova](./lessons/2-Symbolic/MSConceptGraph.ipynb)                             |  |
...
| 05  |            [Uvod u Okvire (PyTorch/TensorFlow) i Prekomjerno Učenje](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Laboratorij](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
...
| 08  |            [Prethodno Naučene Mreže i Transferno Učenje](./lessons/4-ComputerVision/08-TransferLearning/README.md) i [Trikovi za Trening](./lessons/4-ComputerVision/08-TransferLearning/TrainingTricks.md)             |           [PyTorch](./lessons/4-ComputerVision/08-TransferLearning/TransferLearningPyTorch.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Laboratorij](./lessons/4-ComputerVision/08-TransferLearning/lab/README.md) |
...
| 10  |            [Generativne Protivničke Mreže i Prijenos Umjetničkog Stila](./lessons/4-ComputerVision/10-GANs/README.md)             |           [PyTorch](./lessons/4-ComputerVision/10-GANs/GANPyTorch.ipynb) / [TensorFlow](./lessons/4-ComputerVision/10-GANs/GANTF.ipynb)             |  |
...
| 14  |            [Semantičke Riječne Ugradnje. Word2Vec i GloVe](./lessons/5-NLP/14-Embeddings/README.md)             |           [PyTorch](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/14-Embeddings/EmbeddingsPyTorch.ipynb) / [TensorFlow](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/14-Embeddings/EmbeddingsTF.ipynb)             |  |
...
| 20  |            [Veliki Jezični Modeli, Programiranje Upita i Few-Shot Zadaci](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
| 23  |            [Sustavi s Više Agenta](./lessons/6-Other/23-MultiagentSystems/README.md)             |  | |
| VII |            **Etika AI** | | |
...
Ovi primjeri su dizajnirani da vam pomognu razumjeti AI koncepte prije nego što započnete s cjelokupnim kurikulumom.

### 📚 Postavljanje cjelokupnog kurikuluma

- Kreirali smo [lekciju za postavljanje](./lessons/0-course-setup/setup.md) koja će vam pomoći pri postavljanju vašeg razvojog okruženja. - Za edukatore smo također kreirali [lekciju za postavljanje kurikuluma](./lessons/0-course-setup/for-teachers.md)!
...
> **Napomena o kvizovima**: Svi kvizovi se nalaze u mapi Quiz-app u etc\quiz-app, ili [Online ovdje](https://ff-quizzes.netlify.app/) Povezani su iz lekcija, aplikacija za kviz može se pokrenuti lokalno ili implementirati na Azure; slijedite upute u mapi `quiz-app`. Postupno se lokaliziraju.
