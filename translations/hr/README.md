...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-05T16:31:55+00:00",
...
|![Sketchnote by @girlie_mac https://twitter.com/girlie_mac](../../translated_images/ai-overview.0857791951d19500.hr.png)|
|:---:|
| AI za početnike - _Sketchnote autora [@girlie_mac](https://twitter.com/girlie_mac)_ |

Istražite svijet **umjetne inteligencije** (UI) s našim 12-tjednim nastavnim planom koji uključuje 24 lekcije! Uključuje praktične lekcije, kvizove i laboratorijske vježbe. Nastavni plan je prilagođen početnicima i pokriva alate poput TensorFlow i PyTorch, kao i etiku u UI
...
**Ako želite da dodatni jezici budu podržani, dostupni su na popisu [ovdje](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
* **Neuronske mreže** i **Duboko učenje**, koje su u središtu moderne UI. Koncepte iza ovih važnih tema ilustrirat ćemo pomoću koda u dva najpopularnija okvira - [TensorFlow](http://Tensorflow.org) i [PyTorch](http://pytorch.org).
* **Neuronske arhitekture** za obradu slika i teksta. Pokrit ćemo nedavne modele, ali možda ćemo biti nešto ograničeni u najnovijim dostignućima.
* Manje popularne pristupe UI, kao što su **Genetski algoritmi** i **sustavi s više agenata**.
...
* Poslovne primjere korištenja **UI u poslovanju**. Razmotrite pohađanje [Uvod u UI za poslovne korisnike](https://docs.microsoft.com/learn/paths/introduction-ai-for-business-users/?WT.mc_id=academic-77998-bethanycheum) na Microsoft Learn ili [AI Business School](https://www.microsoft.com/ai/ai-business-school/?WT.mc_id=academic-77998-bethanycheum), razvijen u suradnji s [INSEAD](https://www.insead.edu/).
* **Klasično strojno učenje**, koje je dobro opisano u našem [Nastavnom planu za strojarstvo za početnike](http://github.com/Microsoft/ML-for-Beginners).
* Praktične AI primjene izgrađene koristeći **[Kognitivne usluge](https://azure.microsoft.com/services/cognitive-services/?WT.mc_id=academic-77998-bethanycheum)**. Za to preporučujemo da započnete s modulima Microsoft Learn o [vidu](https://docs.microsoft.com/learn/paths/create-computer-vision-solutions-azure-cognitive-services/?WT.mc_id=academic-77998-bethanycheum), [obradi prirodnog jezika](https://docs.microsoft.com/learn/paths/explore-natural-language-processing/?WT.mc_id=academic-77998-bethanycheum), **[Generativnoj UI s Azure OpenAI uslugom](https://learn.microsoft.com/en-us/training/paths/develop-ai-solutions-azure-openai/?WT.mc_id=academic-77998-bethanycheum)** i drugim.
* Specifične ML **cloud okvire**, poput [Azure Machine Learning](https://azure.microsoft.com/services/machine-learning/?WT.mc_id=academic-77998-bethanycheum), [Microsoft Fabric](https://learn.microsoft.com/en-us/training/paths/get-started-fabric/?WT.mc_id=academic-77998-bethanycheum) ili [Azure Databricks](https://docs.microsoft.com/learn/paths/data-engineer-azure-databricks?WT.mc_id=academic-77998-bethanycheum). Razmotrite korištenje nastavnih putova [Izgradite i upravljajte rješenjima strojnog učenja s Azure Machine Learning](https://docs.microsoft.com/learn/paths/build-ai-solutions-with-azure-ml-service/?WT.mc_id=academic-77998-bethanycheum) i [Izgradite i upravljajte rješenjima strojnog učenja s Azure Databricks](https://docs.microsoft.com/learn/paths/build-operate-machine-learning-solutions-azure-databricks/?WT.mc_id=academic-77998-bethanycheum).
* **Razgovorna UI** i **chat botovi**. Postoji poseban [nastavni put za stvaranje razgovornih UI rješenja](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum), a možete se također obratiti [ovom blogu](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) za više detalja.
* **Duboka matematika** iza dubokog učenja. Za to preporučujemo [Duboko učenje](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) autora Iana Goodfellowa, Yoshue Bengioa i Aarona Courvillea, koja je dostupna i online na [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).

Za nježni uvod u teme _UI u oblaku_ možete razmotriti [Nastavni put: Početak rada s umjetnom inteligencijom na Azureu](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum).

# Sadržaj

|     |                                                                 Poveznica na lekciju                                                                  |                                           PyTorch/Keras/TensorFlow                                          | Laboratorij                                                            |
| :-: | :------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: | ------------------------------------------------------------------------------ |
| 0  |                                 [Postavljanje tečaja](./lessons/0-course-setup/setup.md)                                 |                      [Postavljanje razvojnog okruženja](./lessons/0-course-setup/how-to-run.md)                       |   |
...
| 04  |                   [Višeslojni Perceptron i Izrada vlastitog okvira](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [Bilježnica](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [Laboratorij](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |
...
| 08  |            [Prije-trenirane mreže i prijenosno učenje](./lessons/4-ComputerVision/08-TransferLearning/README.md) i [Trikovi treniranja](./lessons/4-ComputerVision/08-TransferLearning/TrainingTricks.md)             |           [PyTorch](./lessons/4-ComputerVision/08-TransferLearning/TransferLearningPyTorch.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Laboratorij](./lessons/4-ComputerVision/08-TransferLearning/lab/README.md) |
...
| 10  |            [Generativne natjecateljske mreže i prijenos umjetničkog stila](./lessons/4-ComputerVision/10-GANs/README.md)             |           [PyTorch](./lessons/4-ComputerVision/10-GANs/GANPyTorch.ipynb) / [TensorFlow](./lessons/4-ComputerVision/10-GANs/GANTF.ipynb)             |  |
...
| 15  |            [Modeliranje jezika. Treniranje vlastitih ugradnji](./lessons/5-NLP/15-LanguageModeling/README.md)             |           [PyTorch](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/15-LanguageModeling/CBoW-PyTorch.ipynb) / [TensorFlow](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/15-LanguageModeling/CBoW-TF.ipynb)             | [Laboratorij](./lessons/5-NLP/15-LanguageModeling/lab/README.md) |
...
| 20  |            [Veliki modeli jezika, programiranje promptova i few-shot zadaci](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
| 24  |            [Etika umjetne inteligencije i odgovorna AI](./lessons/7-Ethics/README.md)             |           [Microsoft Learn: Principi odgovorne AI](https://docs.microsoft.com/learn/paths/responsible-ai-business-principles/?WT.mc_id=academic-77998-cacaste) | |
| IX  |            **Dodatno** | | |
...
* Materijal za prethodno čitanje
* Izvršne Jupyter bilježnice, često specifične za okvir (**PyTorch** ili **TensorFlow**). Izvršna bilježnica također sadrži mnogo teorijskog materijala, pa je za razumijevanje teme potrebno proći kroz barem jednu verziju bilježnice (bilo PyTorch ili TensorFlow).
* **Laboratorije** dostupne za neke teme, koje vam daju mogućnost da isprobate primjenu naučenog na određenom problemu.
* Neki dijelovi sadrže poveznice na module [**MS Learn**](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) koji pokrivaju povezane teme.

## Početak

### 🎯 Novi ste u AI? Počnite ovdje!
...
- 🌟 **Pozdrav svijetu AI-a** - Vaš prvi AI program (prepoznavanje uzoraka)
...
Ovi primjeri su dizajnirani da vam pomognu razumjeti AI koncepte prije nego što prijeđete na cjelokupni kurikulum.

### 📚 Postavljanje cjelokupnog kurikuluma

- Izradili smo [lekciju za postavljanje](./lessons/0-course-setup/setup.md) koja će vam pomoći s postavljanjem razvojne okoline. - Za nastavnike smo također izradili [lekciju za postavljanje kurikuluma](./lessons/0-course-setup/for-teachers.md)!
...
Ne zaboravite označiti (🌟) ovaj repozitorij da biste ga lakše pronašli kasnije.

## Upoznajte druge učenike

Pridružite se našem [službenom AI Discord serveru](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) da upoznate i povežete se s drugim polaznicima ovog tečaja te dobijete podršku.
...
> **Napomena o kvizovima**: Svi kvizovi nalaze se u mapi Quiz-app u etc\quiz-app, ili [Online Ovdje](https://ff-quizzes.netlify.app/). Povezani su iz lekcija, aplikacija za kvizove može se pokrenuti lokalno ili postaviti na Azure; slijedite upute u mapi `quiz-app`. Postupno se lokaliziraju.

## Treba pomoć

Imate li prijedloge ili ste pronašli pravopisne ili programske greške? Otvorite problem (issue) ili kreirajte zahtjev za promjenu (pull request).
...
Ako zapnete ili imate pitanja u vezi izrade AI aplikacija, pridružite se kolegama polaznicima i iskusnim programerima u raspravama o MCP-u. To je poticajna zajednica gdje su pitanja dobrodošla, a znanje slobodno dijeljeno.

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

Ako imate povratne informacije o proizvodu ili probleme tijekom izrade posjetite:
