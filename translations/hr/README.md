...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T08:59:16+00:00",
...
[![GitHub forkovi](https://img.shields.io/github/forks/microsoft/AI-For-Beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/AI-For-Beginners/network/)  
...
* **Neuronske mreže** i **duboko učenje**, koji su srž moderne AI tehnologije. Ilustrirat ćemo koncepte iza ovih važnih tema koristeći kod u dva najpopularnija okvira - [TensorFlow](http://Tensorflow.org) i [PyTorch](http://pytorch.org).  
* **Neuronske arhitekture** za rad s slikama i tekstom. Pokrit ćemo nedavne modele, iako možda nećemo obuhvatiti najnovije tehnologije.  
...
* **Duboka matematika** iza dubokog učenja. Za ovo preporučujemo [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) od Iana Goodfellowa, Yoshue Bengioa i Aarona Courvillea, koja je također dostupna online na [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).  

Za blagi uvod u _AI u oblaku_ teme, razmislite o pohađanju [Uvod u umjetnu inteligenciju na Azureu](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) na Microsoft Learn.  
...
| IX  |            **Dodaci** | | |
| 25  |            [Mreže s više modaliteta, CLIP i VQGAN](./lessons/X-Extras/X1-MultiModal/README.md)             |           [Bilježnica](./lessons/X-Extras/X1-MultiModal/Clip.ipynb)    | |
...
## Kvizovi 
> **Napomena o kvizovima**: Svi kvizovi nalaze se u mapi Quiz-app u etc\quiz-app ili [Online ovdje](https://ff-quizzes.netlify.app/). Povezani su unutar lekcija, a aplikacija za kviz može se pokrenuti lokalno ili postaviti na Azure; slijedite upute u mapi `quiz-app`. Kvizovi se postupno lokaliziraju.

## Potrebna pomoć

Imate li prijedloge ili ste pronašli pravopisne ili programske pogreške? Otvorite problem (issue) ili kreirajte pull request.
