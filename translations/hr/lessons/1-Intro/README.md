...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T09:00:37+00:00",
...
> Crtež bilješki izradio [Tomomi Imura](https://twitter.com/girlie_mac)
...
Izvorno, računala je osmislio [Charles Babbage](https://en.wikipedia.org/wiki/Charles_Babbage) kako bi radila s brojevima slijedeći dobro definirani postupak - algoritam. Moderna računala, iako znatno naprednija od originalnog modela predloženog u 19. stoljeću, i dalje slijede istu ideju kontroliranih izračuna. Stoga je moguće programirati računalo da obavi nešto ako znamo točan slijed koraka koji trebamo poduzeti kako bismo postigli cilj.

![Fotografija osobe](../../../../translated_images/dsh_age.d212a30d4e54fb5f68b94a624aad64bc086124bcbbec9561ae5bd5da661e22d8.hr.png)

> Fotografija autora [Vickie Soshnikova](http://twitter.com/vickievalerie)
...
Međutim, postoje neki zadaci za koje ne znamo eksplicitno kako ih riješiti. Razmislite o određivanju dobi osobe na temelju njezine fotografije. Nekako naučimo to raditi jer smo vidjeli mnogo primjera ljudi različite dobi, ali ne možemo eksplicitno objasniti kako to radimo, niti možemo programirati računalo da to učini. Upravo su takvi zadaci od interesa za **umjetnu inteligenciju** (skraćeno AI).
...
Ti AI sustavi nisu općenito inteligentni; izvrsni su u obavljanju unaprijed definiranog zadatka, ali nemaju pravo razumijevanje ili svijest.|Ti AI sustavi imaju sposobnost obavljanja bilo kojeg intelektualnog zadatka koji čovjek može obaviti, prilagoditi se različitim domenama i posjedovati oblik svijesti ili samosvijesti.
...
> [Fotografija](https://unsplash.com/photos/75715CVEJhI) autora [Amber Kipp](https://unsplash.com/@sadmax) s Unsplash-a
...
> Chatbot nazvan [Eugene Goostman](https://en.wikipedia.org/wiki/Eugene_Goostman), razvijen u Sankt-Peterburgu, bio je blizu prolaska Turingovog testa 2014. koristeći pametan trik s osobnošću. Na početku je objavio da je 13-godišnji ukrajinski dječak, što bi objasnilo nedostatak znanja i neke nedosljednosti u tekstu. Bot je uvjerio 30% sudaca da je čovjek nakon 5-minutnog dijaloga, metrika za koju je Turing vjerovao da će je stroj moći proći do 2000. Međutim, treba razumjeti da to ne znači da smo stvorili inteligentan sustav ili da je računalni sustav prevario ljudskog ispitivača - sustav nije prevario ljude, već su to učinili kreatori bota!
...
Ako želimo da se računalo ponaša poput čovjeka, moramo nekako modelirati naš način razmišljanja unutar računala. Posljedično, moramo pokušati razumjeti što čovjeka čini inteligentnim.
...
---------------------------------------|-------------------------------------
Pristup odozgo prema dolje modelira način na koji osoba razmišlja kako bi riješila problem. Uključuje izdvajanje **znanja** od čovjeka i njegovo predstavljanje u obliku čitljivom za računalo. Također moramo razviti način modeliranja **zaključivanja** unutar računala. | Pristup odozdo prema gore modelira strukturu ljudskog mozga, koji se sastoji od velikog broja jednostavnih jedinica nazvanih **neuroni**. Svaki neuron djeluje kao ponderirani prosjek svojih ulaza, a mrežu neurona možemo obučiti za rješavanje korisnih problema pružanjem **podataka za obuku**.
...
Ljudi obično imaju neka pravila u svojoj glavi koja vode njihove procese donošenja odluka. Na primjer, kada liječnik dijagnosticira pacijenta, može shvatiti da osoba ima povišenu temperaturu, pa bi moglo doći do neke upale u tijelu. Primjenom velikog skupa pravila na određeni problem liječnik može doći do konačne dijagnoze.
...
> | Što je s ML-om?         |      |
> |--------------|-----------|
> | Dio umjetne inteligencije koji se temelji na tome da računalo uči rješavati problem na temelju nekih podataka naziva se **strojno učenje**. Nećemo razmatrati klasično strojno učenje u ovom tečaju - upućujemo vas na zaseban kurikulum [Strojno učenje za početnike](http://aka.ms/ml-beginners). |   ![Strojno učenje za početnike](../../../../translated_images/ml-for-beginners.9e4fed176fd5817d7d1f7d358302515186579cbf09b2a6c5bd8092b345da7f22.hr.png)    |

## Kratka povijest AI-a

Umjetna inteligencija započela je kao područje sredinom dvadesetog stoljeća. U početku je simboličko zaključivanje bilo prevladavajući pristup, što je dovelo do brojnih važnih uspjeha, poput stručnih sustava – računalnih programa koji su mogli djelovati kao stručnjaci u nekim ograničenim problematičnim domenama. Međutim, ubrzo je postalo jasno da se takav pristup ne skalira dobro. Izdvajanje znanja od stručnjaka, predstavljanje tog znanja u računalu i održavanje baze znanja točnom pokazalo se vrlo složenim zadatkom, i previše skupim da bi bio praktičan u mnogim slučajevima. To je dovelo do takozvane [AI zime](https://en.wikipedia.org/wiki/AI_winter) 1970-ih.
...
> Slika Dmitry Soshnikov, [fotografija](https://unsplash.com/photos/r8LmVbUKgns) autorice [Marina Abrosimova](https://unsplash.com/@abrosimova_marina_foto), Unsplash
...
Godine 2012., [Konvolucijske neuronske mreže](../4-ComputerVision/07-ConvNets/README.md) prvi su put korištene za klasifikaciju slika, što je dovelo do značajnog smanjenja pogrešaka u klasifikaciji (s gotovo 30% na 16,4%). Godine 2015., arhitektura ResNet iz Microsoft Researcha [postigla je točnost na razini ljudske sposobnosti](https://doi.org/10.1109/ICCV.2015.123).

Od tada, neuronske mreže pokazale su vrlo uspješno ponašanje u mnogim zadacima:

---

Godina | Postignuta razina ljudske sposobnosti
------|--------------------------------------
