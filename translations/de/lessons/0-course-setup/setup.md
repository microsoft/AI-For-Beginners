...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T19:08:49+00:00",
...
**Studenten**, es gibt mehrere Möglichkeiten, das Curriculum zu nutzen. Zunächst kannst du einfach den Text lesen und den Code direkt auf GitHub durchsehen. Wenn du den Code in einem der Notebooks ausführen möchtest, [lies unsere Anweisungen](./how-to-run.md) und finde weitere Tipps dazu [in diesem Blogbeitrag](https://soshnikov.com/education/how-to-execute-notebooks-from-github/).

> **Note**: [Anweisungen, wie man den Code in diesem Curriculum ausführt](./how-to-run.md)
...
> **Eine Anmerkung zu den Quizfragen**: Alle Quizfragen sind [in dieser App](https://red-field-0a6ddfd03.1.azurestaticapps.net/) enthalten, insgesamt 50 Quizfragen mit jeweils drei Fragen. Sie sind in den Lektionen verlinkt, aber die Quiz-App kann lokal ausgeführt werden; folge den Anweisungen im `etc/quiz-app` Ordner.
