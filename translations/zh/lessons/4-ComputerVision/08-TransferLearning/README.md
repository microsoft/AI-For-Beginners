...
![VGG-16 提取的特征](../../../../../translated_images/zh/features.6291f9c7ba3a0b95.png)
...
![图像优化循环](../../../../../translated_images/zh/ideal-cat-loop.999fbb8ff306e044.png)
...
![理想猫](../../../../../translated_images/zh/ideal-cat.203dd4597643d6b0.png) | ![理想斑马](../../../../../translated_images/zh/ideal-zebra.7f70e8b54ee15a7a.png)
-----|-----
*理想猫* | *理想斑马*

类似的方法可以用来对神经网络进行所谓的**对抗性攻击**。假设我们想欺骗一个神经网络，让一只狗看起来像一只猫。如果我们拿一张被网络识别为狗的狗的图片，然后稍微调整它，直到网络开始将其分类为猫：

![狗的图片](../../../../../translated_images/zh/original-dog.8f68a67d2fe0911f.png) | ![被分类为猫的狗的图片](../../../../../translated_images/zh/adversarial-dog.d9fc7773b0142b89.png)
-----|-----
*狗的原始图片* | *被分类为猫的狗的图片*
