...
![VGG-16 提取的特征](../../../../../translated_images/features.6291f9c7ba3a0b95.zh.png)
...
![图像优化循环](../../../../../translated_images/ideal-cat-loop.999fbb8ff306e044.zh.png)
...
![理想猫](../../../../../translated_images/ideal-cat.203dd4597643d6b0.zh.png) | ![理想斑马](../../../../../translated_images/ideal-zebra.7f70e8b54ee15a7a.zh.png)
-----|-----
*理想猫* | *理想斑马*

类似的方法可以用来对神经网络进行所谓的**对抗性攻击**。假设我们想欺骗一个神经网络，让一只狗看起来像一只猫。如果我们拿一张被网络识别为狗的狗的图片，然后稍微调整它，直到网络开始将其分类为猫：

![狗的图片](../../../../../translated_images/original-dog.8f68a67d2fe0911f.zh.png) | ![被分类为猫的狗的图片](../../../../../translated_images/adversarial-dog.d9fc7773b0142b89.zh.png)
-----|-----
*狗的原始图片* | *被分类为猫的狗的图片*
