...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T18:01:57+00:00",
...
Ontdek de wereld van **Kunstmatige Intelligentie** (AI) met ons 12-weken durende curriculum van 24 lessen! Het bevat praktische lessen, quizzen en labs. Het curriculum is geschikt voor beginners en behandelt tools zoals TensorFlow en PyTorch, evenals ethiek in AI.
...
Voor een zachte introductie tot _AI in de Cloud_ onderwerpen kun je overwegen de leerlijn [Begin met kunstmatige intelligentie op Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) te volgen.
...
* **Labs** beschikbaar voor sommige onderwerpen, die je de kans geven om het geleerde materiaal toe te passen op een specifieke opdracht.
...
Deze voorbeelden zijn bedoeld om je te helpen AI-concepten te begrijpen voordat je aan het volledige curriculum begint.
...
- Hoe je de [code kunt uitvoeren in VSCode of Codepace](./lessons/0-course-setup/how-to-run.md)
...
Vergeet niet om deze repo een ster (🌟) te geven zodat je hem later makkelijker terugvindt.

## Ontmoet andere Leerlingen

Word lid van onze [officiële AI Discord-server](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) om andere cursisten te ontmoeten, te netwerken en ondersteuning te krijgen.
...
Als je vastloopt of vragen hebt over het bouwen van AI-apps, sluit je dan aan bij mede-cursisten en ervaren ontwikkelaars in discussies over MCP. Het is een ondersteunende community waar vragen welkom zijn en kennis vrij wordt gedeeld.
