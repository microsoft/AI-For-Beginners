...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:51:46+00:00",
...
Voor een eenvoudige introductie tot _AI in de Cloud_-onderwerpen kun je overwegen de leerroute [Aan de slag met kunstmatige intelligentie op Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) te volgen.

# Inhoud

|     |                                                                 Leslink                                                                  |                                           PyTorch/Keras/TensorFlow                                          | Lab                                                            |
| :-: | :------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: | ------------------------------------------------------------------------------ |
| 0  |                                 [Cursusinstellingen](./lessons/0-course-setup/setup.md)                                 |                      [Stel je ontwikkelomgeving in](./lessons/0-course-setup/how-to-run.md)                       |   |
...
- Hoe je [de code uitvoert in VSCode of een Codepace](./lessons/0-course-setup/how-to-run.md)  
