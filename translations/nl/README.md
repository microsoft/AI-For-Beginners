...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T19:55:31+00:00",
...
* **Neurale Architecturen** voor het werken met afbeeldingen en tekst. We behandelen recente modellen, maar kunnen enigszins achterlopen op de nieuwste ontwikkelingen.
...
Voor een eenvoudige introductie tot _AI in de Cloud_ onderwerpen kun je overwegen het [Get started with artificial intelligence on Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) leerpad te volgen.
...
| 04  |                   [Multi-layer Perceptron en het maken van ons eigen framework](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [Notebook](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [Lab](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |
...
Als je helemaal nieuw bent in AI en snel praktische voorbeelden wilt zien, bekijk dan onze [**Beginner-vriendelijke Voorbeelden**](./examples/README.md)! Deze omvatten:
...
Als je productfeedback hebt of vragen hebt tijdens het bouwen, bezoek dan ons [Azure AI Foundry Developer Forum](https://aka.ms/foundry/forum)
