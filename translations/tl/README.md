...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T11:08:38+00:00",
...
Tuklasin ang mundo ng **Artipisyal na Intelihensiya** (AI) gamit ang aming 12-linggong, 24-aralin na kurikulum! Kasama dito ang mga praktikal na aralin, pagsusulit, at mga laboratoryo. Ang kurikulum ay para sa mga baguhan at sumasaklaw sa mga tool tulad ng TensorFlow at PyTorch, pati na rin ang etika sa AI.  
...
* Iba't ibang mga diskarte sa Artipisyal na Intelihensiya, kabilang ang "lumang pamamaraan" na simbolikong diskarte gamit ang **Knowledge Representation** at pangangatwiran ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).  
* **Neural Networks** at **Deep Learning**, na nasa sentro ng modernong AI. Ipapakita namin ang mga konsepto sa likod ng mga mahahalagang paksa gamit ang code sa dalawang pinakasikat na framework - [TensorFlow](http://Tensorflow.org) at [PyTorch](http://pytorch.org).  
...
* Mas hindi karaniwang mga diskarte sa AI, tulad ng **Genetic Algorithms** at **Multi-Agent Systems**.  
...
* **Classic Machine Learning**, na mahusay na nailarawan sa aming [Machine Learning for Beginners Curriculum](http://github.com/Microsoft/ML-for-Beginners).  
...
| IV  |            [**Computer Vision**](./lessons/4-ComputerVision/README.md)             | [PyTorch](https://docs.microsoft.com/learn/modules/intro-computer-vision-pytorch/?WT.mc_id=academic-77998-cacaste) / [TensorFlow](https://docs.microsoft.com/learn/modules/intro-computer-vision-TensorFlow/?WT.mc_id=academic-77998-cacaste)| [Explore Computer Vision sa Microsoft Azure](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) |
...
| V  |            [**Natural Language Processing**](./lessons/5-NLP/README.md)             | [PyTorch](https://docs.microsoft.com/learn/modules/intro-natural-language-processing-pytorch/?WT.mc_id=academic-77998-cacaste) /[TensorFlow](https://docs.microsoft.com/learn/modules/intro-natural-language-processing-TensorFlow/?WT.mc_id=academic-77998-cacaste) | [Explore Natural Language Processing sa Microsoft Azure](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum)|
...
Kung ikaw ay ganap na bago sa AI at nais ng mabilis, hands-on na mga halimbawa, tingnan ang aming [**Mga Halimbawa para sa Baguhan**](./examples/README.md)! Kasama dito:
...
- Gumawa kami ng [setup lesson](./lessons/0-course-setup/setup.md) upang tulungan ka sa pagsasaayos ng iyong development environment. - Para sa mga guro, gumawa kami ng [curricula setup lesson](./lessons/0-course-setup/for-teachers.md) para sa inyo rin!
- Paano [Patakbuhin ang code sa VSCode o Codepace](./lessons/0-course-setup/how-to-run.md)

Sundin ang mga hakbang na ito:

Fork ang Repository: I-click ang "Fork" button sa kanang-itaas na bahagi ng pahinang ito.
...
> **Tungkol sa mga quiz**: Ang lahat ng mga quiz ay matatagpuan sa folder ng Quiz-app sa etc\quiz-app, o [Online Dito](https://ff-quizzes.netlify.app/). Ang mga ito ay naka-link mula sa loob ng mga aralin. Ang quiz app ay maaaring patakbuhin nang lokal o i-deploy sa Azure; sundin ang mga tagubilin sa folder na `quiz-app`. Ang mga ito ay unti-unting nilolokal.

## Kailangan ng Tulong

Mayroon ka bang mga mungkahi o nakakita ng mga maling spelling o error sa code? Mag-raise ng issue o gumawa ng pull request.
...
* **🙏 Pangunahing Kontribyutor:** [Evgenii Pishchik](https://github.com/Pe4enIks)
