...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:51:53+00:00",
...
Tuklasin ang mundo ng **Artificial Intelligence** (AI) gamit ang aming 12-linggong, 24-leksyon na kurikulum! Kasama dito ang mga praktikal na leksyon, pagsusulit, at mga lab. Ang kurikulum ay angkop para sa mga nagsisimula at sumasaklaw sa mga tool tulad ng TensorFlow at PyTorch, pati na rin ang etika sa AI
...
* **Neural Architectures** para sa pagtatrabaho sa mga imahe at teksto. Sasaklawin namin ang mga kamakailang modelo ngunit maaaring kulang sa pinakabagong estado-ng-sining.
* Mas hindi kilalang mga pamamaraan ng AI, tulad ng **Genetic Algorithms** at **Multi-Agent Systems**.
...
Para sa isang banayad na pagpapakilala sa mga paksa ng _AI sa Cloud_ maaari mong isaalang-alang ang pagkuha ng [Get started with artificial intelligence on Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) Learning Path.
...
* Materyal para sa paunang pagbasa
...
* **Labs** na available para sa ilang mga paksa, na nagbibigay sa iyo ng pagkakataon na subukan ang paglalapat ng mga natutunang materyal sa isang partikular na problema.
...
Kung ikaw ay ganap na bago sa AI at nais ng mabilis at praktikal na mga halimbawa, tingnan ang aming [**Mga Halimbawa para sa mga Baguhan**](./examples/README.md)! Kasama dito ang:
...
- 🖼️ **Image Classifier** - Magklasipika ng mga larawan na may detalyadong mga komento
- 💬 **Sentimyento ng Teksto** - Suriin ang positibo/negatibong teksto

Ang mga halimbawang ito ay idinisenyo upang tulungan kang maunawaan ang mga konsepto ng AI bago sumabak sa buong kurikulum.

### 📚 Pagsasaayos ng Buong Kurikulum

- Nilikha namin ang isang [setup lesson](./lessons/0-course-setup/setup.md) upang tulungan ka sa pagsasaayos ng iyong development environment. - Para sa mga Guro, gumawa rin kami ng isang [curricula setup lesson](./lessons/0-course-setup/for-teachers.md) para sa inyo!
...
> **Isang paalala tungkol sa mga pagsusulit**: Lahat ng pagsusulit ay nasa Quiz-app folder sa etc\quiz-app, o [Online Dito](https://ff-quizzes.netlify.app/) Nakalink mula sa loob ng mga aralin, ang quiz app ay maaaring patakbuhin nang lokal o i-deploy sa Azure; sundin ang mga tagubilin sa `quiz-app` folder. Unti-unti itong nilalokalisa.
...
Gumagawa ang aming koponan ng iba pang mga kurikulum! Tingnan ang:
...
Kung ikaw ay na-stuck o may mga tanong tungkol sa paggawa ng AI apps. Sumali sa mga kapwa nag-aaral at mga bihasang developer sa mga talakayan tungkol sa MCP. Ito ay isang suportadong komunidad kung saan malugod ang mga tanong at malayang naibabahagi ang kaalaman.
