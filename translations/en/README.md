...
**If you'd like additional languages supported, check out the list [here](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**  
...
Our team creates other learning materials! Check out:
