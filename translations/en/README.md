...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T14:55:33+00:00",
...
**If you want additional translation languages supported, they are listed [here](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
* **Conversational AI** and **Chat Bots**. There is a separate [Create conversational AI solutions](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum) learning path, and you can also refer to [this blog post](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) for more details.
* **Deep Mathematics** behind deep learning. For this, we recommend [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) by Ian Goodfellow, Yoshua Bengio and Aaron Courville, which is also available online at [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).
...
* Executable Jupyter Notebooks, often tailored to a specific framework (**PyTorch** or **TensorFlow**). These notebooks also contain a lot of theoretical content, so to fully understand the topic, you should go through at least one version of the notebook (either PyTorch or TensorFlow).
* **Labs** available for some topics, giving you a chance to apply what you've learned to practical problems.
* Some sections include links to [**MS Learn**](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) modules covering related subjects.
...
- We have created a [setup lesson](./lessons/0-course-setup/setup.md) to assist you with setting up your development environment. - For Educators, we have also created a [curriculum setup lesson](./lessons/0-course-setup/for-teachers.md)!
- How to [Run the code in VSCode or Codepace](./lessons/0-course-setup/how-to-run.md)
...
Don't forget to star (🌟) this repo to find it more easily later.

## Meet other Learners

Join our [official AI Discord server](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) to connect and network with other learners taking this course and get support.
...
> **A note about quizzes**: All quizzes are located in the Quiz-app folder at etc\quiz-app, or [Online Here](https://ff-quizzes.netlify.app/). They are linked within the lessons. The quiz app can be run locally or deployed to Azure; follow the instructions in the `quiz-app` folder. They are gradually being localized.

## Help Wanted

Do you have suggestions or found spelling or code errors? Please raise an issue or create a pull request.
