...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T19:36:58+00:00",
...
* Jupyter Notebooks executáveis, que frequentemente são específicos para o framework (**PyTorch** ou **TensorFlow**). O notebook executável também contém muito material teórico, então para entender o tópico é necessário passar por pelo menos uma versão do notebook (PyTorch ou TensorFlow).
...
- 💬 **Análise de Sentimentos de Texto** - Analise textos positivos/negativos

Estes exemplos foram criados para ajudá-lo a compreender conceitos de IA antes de mergulhar no currículo completo.
...
> **Uma nota sobre os questionários**: Todos os questionários estão contidos na pasta Quiz-app em etc\quiz-app, ou [Online Aqui](https://ff-quizzes.netlify.app/). Eles estão ligados dentro das lições, e a aplicação de questionários pode ser executada localmente ou implantada no Azure; siga as instruções na pasta `quiz-app`. Estão a ser gradualmente localizados.

## Ajuda Necessária

Tem sugestões ou encontrou erros de ortografia ou no código? Abra uma issue ou crie um pull request.
...
Se ficar preso ou tiver dúvidas sobre como criar aplicações de IA, junte-se a outros estudantes e desenvolvedores experientes em discussões sobre MCP. É uma comunidade de apoio onde perguntas são bem-vindas e o conhecimento é partilhado livremente.
