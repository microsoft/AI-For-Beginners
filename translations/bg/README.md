...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T08:54:35+00:00",
...
**Ако желаете да добавите допълнителни езици, списъкът с поддържани езици е наличен [тук](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**  
...
* Различни подходи към Изкуствения интелект, включително "стария добър" символичен подход с **Представяне на знания** и разсъждения ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).  
...
* **Невронни архитектури** за работа с изображения и текст. Ще разгледаме съвременни модели, но може да липсват някои от най-новите разработки.  
...
* **Разговорен AI** и **чатботове**. Има отделен [Създаване на решения за разговорен AI](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum) учебен път, а също така можете да се обърнете към [тази публикация в блога](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) за повече подробности.  
* **Дълбока математика** зад дълбокото обучение. За това бихме препоръчали [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) от Ian Goodfellow, Yoshua Bengio и Aaron Courville, която е достъпна и онлайн на [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).  

За леко въведение в темите за _AI в облака_ можете да разгледате [Започнете с изкуствения интелект в Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) учебен път.  
...
| 05  |            [Въведение в рамките (PyTorch/TensorFlow) и Overfitting](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Лаборатория](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
...
- Създадохме [урок за настройка](./lessons/0-course-setup/setup.md), който да ви помогне с настройката на вашата среда за разработка. - За преподаватели създадохме и [урок за настройка на учебна програма](./lessons/0-course-setup/for-teachers.md)!
...
## Тестове
> **Бележка относно тестовете**: Всички тестове се намират в папката Quiz-app в etc\quiz-app, или [Онлайн тук](https://ff-quizzes.netlify.app/). Те са свързани с уроците, като приложението за тестове може да се стартира локално или да се разположи в Azure; следвайте инструкциите в папката `quiz-app`. Постепенно се локализират.

## Търсим помощ

Имате предложения или сте открили правописни или кодови грешки? Създайте issue или направете pull request.
