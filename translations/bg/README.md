...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T11:16:43+00:00",
...
**Ако желаете да добавите допълнителни езици, списъкът с поддържани езици е [тук](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
|     |                                                                 Линк към урока                                                                  |                                           PyTorch/Keras/TensorFlow                                          | Лаборатория                                                            |
| :-: | :------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: | ------------------------------------------------------------------------------ |
...
* Изпълними Jupyter тетрадки, които често са специфични за рамката (**PyTorch** или **TensorFlow**). Изпълнимата тетрадка съдържа и много теоретичен материал, така че за да разберете темата, трябва да преминете поне една версия на тетрадката (или PyTorch, или TensorFlow).
...
- Създадохме [урок за настройка](./lessons/0-course-setup/setup.md), за да ви помогнем с настройката на вашата среда за разработка. - За преподаватели създадохме и [урок за настройка на учебната програма](./lessons/0-course-setup/for-teachers.md)!
