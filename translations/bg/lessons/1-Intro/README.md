...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-25T22:20:13+00:00",
...
![Обобщение на съдържанието за въведение в изкуствения интелект в рисунка](../../../../translated_images/ai-intro.bf28d1ac4235881c096f0ffdb320ba4102940eafcca4e9d7a55a03914361f8f3.bg.png)
...
През 2012 година [Конволюционни невронни мрежи](../4-ComputerVision/07-ConvNets/README.md) бяха използвани за първи път в класификация на изображения, което доведе до значително намаляване на грешките при класификация (от почти 30% до 16.4%). През 2015 година архитектурата ResNet на Microsoft Research [постигна точност на ниво човек](https://doi.org/10.1109/ICCV.2015.123).
...
2018 | [Автоматичен машинен превод](https://arxiv.org/abs/1803.05567) (от китайски на английски)
