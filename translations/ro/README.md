...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T11:02:59+00:00",
...
Explorează lumea **Inteligenței Artificiale** (AI) cu curriculumul nostru de 12 săptămâni, 24 lecții! Acesta include lecții practice, teste și laboratoare. Curriculumul este prietenos pentru începători și acoperă instrumente precum TensorFlow și PyTorch, precum și etica în AI.  
...
* **Rețele Neurale** și **Deep Learning**, care sunt esențiale pentru AI modern. Vom ilustra conceptele din spatele acestor subiecte importante folosind cod în două dintre cele mai populare cadre - [TensorFlow](http://Tensorflow.org) și [PyTorch](http://pytorch.org).  
...
* **Machine Learning Clasic**, care este bine descris în [Curriculumul nostru pentru Machine Learning pentru Începători](http://github.com/Microsoft/ML-for-Beginners).  
...
* **Matematica Avansată** din spatele deep learning. Pentru aceasta, recomandăm [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) de Ian Goodfellow, Yoshua Bengio și Aaron Courville, care este disponibil și online la [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).  

Pentru o introducere ușoară în subiectele _AI în Cloud_, ia în considerare parcurgerea traseului de învățare [Get started with artificial intelligence on Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum).  
...
| 22  |            [Învățare Profundă prin Recompensă](./lessons/6-Other/22-DeepRL/README.md)             |           [PyTorch](./lessons/6-Other/22-DeepRL/CartPole-RL-PyTorch.ipynb) /[TensorFlow](./lessons/6-Other/22-DeepRL/CartPole-RL-TF.ipynb)             | [Laborator](./lessons/6-Other/22-DeepRL/lab/README.md) |
...
* Jupyter Notebooks executabile, care sunt adesea specifice framework-ului (**PyTorch** sau **TensorFlow**). Notebook-ul executabil include și mult material teoretic, așa că pentru a înțelege subiectul trebuie să parcurgi cel puțin o versiune a notebook-ului (PyTorch sau TensorFlow).
...
### 🎯 Nou în AI? Începe aici!

Dacă ești complet nou în AI și vrei exemple rapide și practice, verifică [**Exemplele Prietenoase pentru Începători**](./examples/README.md)! Acestea includ:
...
- 💬 **Sentiment Textual** - Analizează text pozitiv/negativ

Aceste exemple sunt concepute pentru a te ajuta să înțelegi conceptele AI înainte de a te aprofunda în curriculum complet.
...
Alătură-te [serverului nostru oficial de Discord AI](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) pentru a cunoaște și a interacționa cu alți cursanți care urmează acest curs și pentru a primi suport.
...
> **O notă despre chestionare**: Toate chestionarele sunt conținute în folderul Quiz-app din etc\quiz-app, sau [Online Aici](https://ff-quizzes.netlify.app/). Ele sunt legate din lecții, iar aplicația de chestionare poate fi rulată local sau implementată pe Azure; urmează instrucțiunile din folderul `quiz-app`. Ele sunt treptat localizate.
...
* **✅ Creator de chestionare:** [Lateefah Bello](https://github.com/CinnamonXI), [MLSA](https://studentambassadors.microsoft.com/)
