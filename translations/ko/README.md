...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T19:25:14+00:00",
...
**추가 번역을 원하시면 [여기](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)에 지원 언어 목록이 있습니다.**  
...
* **지식 표현**과 추론을 포함한 "고전적인" 상징적 접근법([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence))을 포함한 다양한 인공지능 접근법.  
...
* 이미지와 텍스트 작업을 위한 **신경 아키텍처**. 최신 모델을 다루지만, 최첨단 기술에 대한 내용은 다소 부족할 수 있습니다.  
...
클라우드에서 _AI_를 다루는 주제에 대한 간단한 소개를 원하시면 [Azure에서 인공지능 시작하기](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) 학습 경로를 참고하세요.  
...
* 사전 학습 자료
* 실행 가능한 Jupyter 노트북, 주로 프레임워크(**PyTorch** 또는 **TensorFlow**)에 따라 다릅니다. 실행 가능한 노트북에는 많은 이론적 내용도 포함되어 있으므로 주제를 이해하려면 노트북 버전 중 하나(Pytorch 또는 TensorFlow)를 반드시 학습해야 합니다.
...
이 저장소를 나중에 쉽게 찾을 수 있도록 별(🌟)을 잊지 말고 추가하세요.
...
> **퀴즈에 대한 참고 사항**: 모든 퀴즈는 etc\quiz-app의 Quiz-app 폴더에 포함되어 있으며, [온라인에서도 이용 가능](https://ff-quizzes.netlify.app/)합니다. 퀴즈는 레슨 내에서 링크되어 있으며, 로컬에서 실행하거나 Azure에 배포할 수 있습니다. `quiz-app` 폴더의 지침을 따르세요. 퀴즈는 점차적으로 현지화되고 있습니다.
