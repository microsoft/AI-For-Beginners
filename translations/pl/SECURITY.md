...
Zamiast tego zgłoś je do Microsoft Security Response Center (MSRC) na stronie [https://msrc.microsoft.com/create-report](https://aka.ms/opensource/security/create-report).
...
Powinieneś otrzymać odpowiedź w ciągu 24 godzin. Jeśli z jakiegoś powodu jej nie otrzymasz, prosimy o ponowny kontakt e-mailowy, aby upewnić się, że otrzymaliśmy Twoją pierwotną wiadomość. Dodatkowe informacje można znaleźć na stronie [microsoft.com/msrc](https://aka.ms/opensource/security/msrc).
...
Jeśli zgłaszasz problem w ramach programu nagród za błędy, bardziej szczegółowe raporty mogą przyczynić się do wyższej nagrody. Odwiedź stronę [Microsoft Bug Bounty Program](https://aka.ms/opensource/security/bounty), aby uzyskać więcej informacji o naszych aktywnych programach.
