...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T19:28:45+00:00",
...
|![স্কেচনোট @girlie_mac https://twitter.com/girlie_mac](../../translated_images/ai-overview.0857791951d19500d0ef8b803d77110c738dcafc52306e6d68724742cd4af167.bn.png)|  
|:---:|  
| কৃত্রিম বুদ্ধিমত্তা শিক্ষার্থীদের জন্য - _স্কেচনোট [@girlie_mac](https://twitter.com/girlie_mac) দ্বারা_ |  

**কৃত্রিম বুদ্ধিমত্তা** (AI)-এর জগৎ অন্বেষণ করুন আমাদের ১২ সপ্তাহের, ২৪টি পাঠের পাঠ্যক্রমের মাধ্যমে! এতে রয়েছে ব্যবহারিক পাঠ, কুইজ এবং ল্যাব। এই পাঠ্যক্রমটি শিক্ষার্থীবান্ধব এবং এতে TensorFlow এবং PyTorch-এর মতো টুলস এবং AI-এর নৈতিকতা অন্তর্ভুক্ত।  
...
**যদি আপনি অতিরিক্ত অনুবাদের ভাষা যোগ করতে চান, তবে [এখানে](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) তালিকাভুক্ত ভাষাগুলি সমর্থিত।**  
...
* কৃত্রিম বুদ্ধিমত্তার বিভিন্ন পদ্ধতি, যার মধ্যে রয়েছে "পুরনো ভালো" প্রতীকী পদ্ধতি **জ্ঞান উপস্থাপনা** এবং যুক্তি ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence))।  
* **নিউরাল নেটওয়ার্ক** এবং **ডিপ লার্নিং**, যা আধুনিক AI-এর মূল। আমরা এই গুরুত্বপূর্ণ বিষয়গুলির ধারণাগুলি ব্যাখ্যা করব দুটি জনপ্রিয় ফ্রেমওয়ার্ক - [TensorFlow](http://Tensorflow.org) এবং [PyTorch](http://pytorch.org)-এ কোড ব্যবহার করে।  
* চিত্র এবং টেক্সট নিয়ে কাজ করার জন্য **নিউরাল আর্কিটেকচার**। আমরা সাম্প্রতিক মডেলগুলি কভার করব তবে কিছু ক্ষেত্রে সর্বাধুনিক প্রযুক্তি থেকে পিছিয়ে থাকতে পারি।  
...
* **ডিপ ম্যাথমেটিক্স** যা ডিপ লার্নিংয়ের পেছনে কাজ করে। এর জন্য, আমরা [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) বইটি পড়ার পরামর্শ দিই, যা Ian Goodfellow, Yoshua Bengio এবং Aaron Courville দ্বারা রচিত এবং অনলাইনে [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/) এ উপলব্ধ।  

ক্লাউডে _AI_-এর একটি সহজ ভূমিকা পেতে, আপনি [Get started with artificial intelligence on Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) শেখার পথ গ্রহণ করার কথা বিবেচনা করতে পারেন।  
...
| I  |               [**AI-তে পরিচিতি**](./lessons/1-Intro/README.md)      | | |  
...
* প্রি-রিডিং উপকরণ
* কার্যকরী Jupyter নোটবুক, যা প্রায়শই নির্দিষ্ট ফ্রেমওয়ার্ক (**PyTorch** বা **TensorFlow**) এর জন্য তৈরি। কার্যকরী নোটবুকে প্রচুর তাত্ত্বিক উপকরণও থাকে, তাই বিষয়টি বুঝতে হলে আপনাকে অন্তত একটি সংস্করণ (PyTorch বা TensorFlow) নোটবুকের মধ্য দিয়ে যেতে হবে।
...
আপনি যদি AI-এ সম্পূর্ণ নতুন হন এবং দ্রুত, হাতে-কলমে উদাহরণ চান, তাহলে আমাদের [**শুরুর জন্য বন্ধুত্বপূর্ণ উদাহরণ**](./examples/README.md) দেখুন! এতে অন্তর্ভুক্ত রয়েছে:
...
এই উদাহরণগুলো আপনাকে পুরো পাঠ্যক্রমে প্রবেশ করার আগে AI ধারণা বুঝতে সাহায্য করার জন্য তৈরি করা হয়েছে।

### 📚 পূর্ণ পাঠ্যক্রম সেটআপ

- আমরা একটি [সেটআপ পাঠ](./lessons/0-course-setup/setup.md) তৈরি করেছি যা আপনার ডেভেলপমেন্ট পরিবেশ সেটআপ করতে সাহায্য করবে। - শিক্ষকদের জন্য, আমরা একটি [পাঠ্যক্রম সেটআপ পাঠ](./lessons/0-course-setup/for-teachers.md) তৈরি করেছি!
...
আমাদের [অফিশিয়াল AI Discord সার্ভার](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum)-এ যোগ দিন, যেখানে আপনি এই কোর্সে অংশগ্রহণকারী অন্যান্য শিক্ষার্থীদের সাথে পরিচিত হতে এবং নেটওয়ার্ক করতে পারেন এবং সহায়তা পেতে পারেন।

যদি আপনি প্রোডাক্ট ফিডব্যাক দিতে চান বা কোড তৈরি করার সময় কোনো প্রশ্ন থাকে, আমাদের [Azure AI Foundry Developer Forum](https://aka.ms/foundry/forum)-এ যান।

## কুইজ

> **কুইজ সম্পর্কে একটি নোট**: সমস্ত কুইজ `Quiz-app` ফোল্ডারে `etc\quiz-app`-এ রয়েছে, অথবা [অনলাইনে এখানে](https://ff-quizzes.netlify.app/)। এগুলো পাঠের মধ্যে লিঙ্ক করা হয়েছে। কুইজ অ্যাপটি লোকালভাবে চালানো বা Azure-এ ডিপ্লয় করা যেতে পারে; `quiz-app` ফোল্ডারে নির্দেশনা অনুসরণ করুন। এগুলো ধীরে ধীরে স্থানীয় ভাষায় অনুবাদ করা হচ্ছে।

## সাহায্য প্রয়োজন

আপনার কোনো পরামর্শ আছে বা বানান বা কোডের ত্রুটি খুঁজে পেয়েছেন? একটি ইস্যু উত্থাপন করুন বা একটি পুল রিকোয়েস্ট তৈরি করুন।
...
যদি আপনি আটকে যান বা AI অ্যাপ তৈরি করার বিষয়ে কোনো প্রশ্ন থাকে, MCP নিয়ে আলোচনা করতে fellow learners এবং অভিজ্ঞ ডেভেলপারদের সাথে যোগ দিন। এটি একটি সহায়ক কমিউনিটি যেখানে প্রশ্ন স্বাগত এবং জ্ঞান মুক্তভাবে ভাগ করা হয়।

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

যদি আপনি প্রোডাক্ট ফিডব্যাক দিতে চান বা কোড তৈরি করার সময় কোনো ত্রুটি থাকে, এখানে যান:
