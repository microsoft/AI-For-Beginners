...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T11:11:21+00:00",
...
* Skirtingus dirbtinio intelekto metodus, įskaitant „seną gerą“ simbolinį metodą su **žinių reprezentacija** ir logika ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).  
...
Norėdami švelniai pradėti _DI debesyje_ temas, galite išklausyti [Pradėti dirbtinio intelekto mokymąsi Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) mokymosi kelią.  
...
| 20  |            [Dideli kalbos modeliai, užklausų programavimas ir mažo duomenų kiekio užduotys](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
| VI |            **Kiti AI metodai** || |
...
* **Laboratorijas**, kurios prieinamos kai kurioms temoms ir suteikia galimybę pritaikyti išmoktą medžiagą konkrečiai problemai.
...
Šie pavyzdžiai skirti padėti suprasti AI koncepcijas prieš pradedant visą mokymo programą.
...
> **Pastaba apie testus**: Visi testai yra Quiz-app aplanke, esančiame etc\quiz-app, arba [Internete čia](https://ff-quizzes.netlify.app/). Jie yra susieti su pamokomis, o testų programėlę galima paleisti lokaliai arba įdiegti į Azure; sekite instrukcijas `quiz-app` aplanke. Testai palaipsniui lokalizuojami.
...
Jei turite produktų atsiliepimų ar klaidų, kol kuriate, apsilankykite:
