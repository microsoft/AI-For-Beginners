...
> [ဤသင်တန်းအတွက် ထပ်မံရရှိနိုင်သော အရင်းအမြစ်များအားလုံးကို ကျွန်ုပ်တို့၏ Microsoft Learn စုစည်းမှုတွင် တွေ့နိုင်ပါသည်](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum)
...
| :-: | :------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: | ------------------------------------------------------------------------------ |
| 0  |                                 [သင်တန်း စတင်ပြင်ဆင်ခြင်း](./lessons/0-course-setup/setup.md)                                 |                      [သင်၏ ဖွံ့ဖြိုးရေး ပတ်ဝန်းကျင်ကို စတင်ပြင်ဆင်နည်း](./lessons/0-course-setup/how-to-run.md)                       |   |
