...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:31:29+00:00",
...
برای مقدمه‌ای ملایم بر موضوعات _هوش مصنوعی در ابر_، می‌توانید مسیر یادگیری [شروع با هوش مصنوعی در Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) را دنبال کنید.  
...
| 07  |            [شبکه‌های عصبی پیچشی](./lessons/4-ComputerVision/07-ConvNets/README.md) &  [معماری‌های CNN](./lessons/4-ComputerVision/07-ConvNets/CNN_Architectures.md)             |           [PyTorch](./lessons/4-ComputerVision/07-ConvNets/ConvNetsPyTorch.ipynb) /[TensorFlow](./lessons/4-ComputerVision/07-ConvNets/ConvNetsTF.ipynb)             | [آزمایشگاه](./lessons/4-ComputerVision/07-ConvNets/lab/README.md) |
...
| 20  |            [مدل‌های بزرگ زبان، برنامه‌نویسی با دستورات و وظایف کم‌شات](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
* مطالب پیش‌خوانی
* دفترچه‌های یادداشت Jupyter قابل اجرا، که اغلب مختص چارچوب (**PyTorch** یا **TensorFlow**) هستند. دفترچه یادداشت قابل اجرا همچنین شامل مطالب نظری زیادی است، بنابراین برای درک موضوع باید حداقل یک نسخه از دفترچه یادداشت (PyTorch یا TensorFlow) را مرور کنید.
...
- ما یک [درس تنظیمات](./lessons/0-course-setup/setup.md) ایجاد کرده‌ایم تا به شما در تنظیم محیط توسعه کمک کند. - برای مربیان، ما یک [درس تنظیمات برنامه درسی](./lessons/0-course-setup/for-teachers.md) نیز ایجاد کرده‌ایم!
...
به [سرور رسمی دیسکورد هوش مصنوعی](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) ما بپیوندید تا با سایر یادگیرندگان این دوره آشنا شوید و شبکه‌سازی کنید و پشتیبانی دریافت کنید.
...
## آزمون‌ها 
> **یادداشتی درباره آزمون‌ها**: تمامی آزمون‌ها در پوشه Quiz-app در مسیر etc\quiz-app قرار دارند، یا [به صورت آنلاین اینجا](https://ff-quizzes.netlify.app/) در دسترس هستند. این آزمون‌ها از داخل درس‌ها لینک شده‌اند. اپلیکیشن آزمون می‌تواند به صورت محلی اجرا شود یا در Azure مستقر شود؛ دستورالعمل‌ها را در پوشه `quiz-app` دنبال کنید. این آزمون‌ها به تدریج بومی‌سازی می‌شوند.
...
- [هوش مصنوعی مولد با JavaScript](https://github.com/microsoft/generative-ai-with-javascript)
- [هوش مصنوعی مولد با Java](https://github.com/microsoft/Generative-AI-for-beginners-java)
