...
**اگر می‌خواهید زبان‌های بیشتری برای ترجمه پشتیبانی شوند، لیست زبان‌های موجود [اینجا](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) قابل مشاهده است.**  
...
* **معماری‌های عصبی** برای کار با تصاویر و متن. ما مدل‌های اخیر را پوشش خواهیم داد، اما ممکن است در برخی موارد از آخرین پیشرفت‌ها عقب باشیم.  
...
* موارد تجاری استفاده از **هوش مصنوعی در کسب‌وکار**. پیشنهاد می‌کنیم مسیر یادگیری [مقدمه‌ای بر هوش مصنوعی برای کاربران کسب‌وکار](https://docs.microsoft.com/learn/paths/introduction-ai-for-business-users/?WT.mc_id=academic-77998-bethanycheum) را در Microsoft Learn یا [مدرسه کسب‌وکار هوش مصنوعی](https://www.microsoft.com/ai/ai-business-school/?WT.mc_id=academic-77998-bethanycheum) که با همکاری [INSEAD](https://www.insead.edu/) توسعه یافته است، دنبال کنید.  
...
| 20  |            [مدل‌های زبانی بزرگ، برنامه‌نویسی با پرامپت و وظایف کم‌شات](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
* مطالب پیش‌مطالعه  
* دفترچه‌های Jupyter اجرایی که اغلب به فریم‌ورک خاصی (**PyTorch** یا **TensorFlow**) اختصاص دارند. این دفترچه‌ها همچنین شامل مطالب نظری زیادی هستند، بنابراین برای درک موضوع باید حداقل یکی از نسخه‌های دفترچه (PyTorch یا TensorFlow) را مرور کنید.  
...
اگر کاملاً در هوش مصنوعی تازه‌کار هستید و می‌خواهید مثال‌های سریع و عملی ببینید، به [**مثال‌های مناسب مبتدیان**](./examples/README.md) ما سر بزنید! این مثال‌ها شامل:

- 🌟 **سلام دنیای هوش مصنوعی** - اولین برنامه هوش مصنوعی شما (تشخیص الگو)  
- 🧠 **شبکه عصبی ساده** - ساخت یک شبکه عصبی از ابتدا  
- 🖼️ **دسته‌بندی تصویر** - دسته‌بندی تصاویر با توضیحات دقیق  
- 💬 **احساسات متن** - تحلیل متن مثبت/منفی  

این مثال‌ها برای کمک به شما در درک مفاهیم هوش مصنوعی قبل از ورود به برنامه درسی کامل طراحی شده‌اند.

### 📚 راه‌اندازی برنامه درسی کامل

- ما یک [درس راه‌اندازی](./lessons/0-course-setup/setup.md) ایجاد کرده‌ایم تا به شما در راه‌اندازی محیط توسعه کمک کند.  
- برای مربیان، ما یک [درس راه‌اندازی برنامه درسی](./lessons/0-course-setup/for-teachers.md) نیز ایجاد کرده‌ایم!  
...
اگر در حین ساخت پروژه بازخورد محصول یا سوالی دارید، به [فروم توسعه‌دهندگان Azure AI Foundry](https://aka.ms/foundry/forum) مراجعه کنید.
...
* **🎨 تصویرگر Sketchnote:** [Tomomi Imura](https://twitter.com/girlie_mac)
...
- [Generative AI با Java](https://github.com/microsoft/Generative-AI-for-beginners-java)
