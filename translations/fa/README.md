...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T13:55:36+00:00",
...
[![درخواست‌های کشش GitHub](https://img.shields.io/github/issues-pr/microsoft/AI-For-Beginners.svg)](https://GitHub.com/microsoft/AI-For-Beginners/pulls/)  
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com)  

[![تماشاگران GitHub](https://img.shields.io/github/watchers/microsoft/AI-For-Beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/AI-For-Beginners/watchers/)  
...
دنیای **هوش مصنوعی** (AI) را با برنامه درسی ۱۲ هفته‌ای و ۲۴ درس ما کشف کنید! این برنامه شامل درس‌های عملی، آزمون‌ها و آزمایشگاه‌ها است. این برنامه درسی برای مبتدیان طراحی شده و ابزارهایی مانند TensorFlow و PyTorch و همچنین اخلاق در هوش مصنوعی را پوشش می‌دهد.  
...
* رویکردهای مختلف به هوش مصنوعی، از جمله رویکرد "قدیمی" نمادین با **نمایش دانش** و استدلال ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).  
* **شبکه‌های عصبی** و **یادگیری عمیق** که در هسته هوش مصنوعی مدرن قرار دارند. ما مفاهیم پشت این موضوعات مهم را با استفاده از کد در دو چارچوب محبوب - [TensorFlow](http://Tensorflow.org) و [PyTorch](http://pytorch.org) - توضیح خواهیم داد.  
* **معماری‌های عصبی** برای کار با تصاویر و متن. ما مدل‌های اخیر را پوشش خواهیم داد اما ممکن است در زمینه پیشرفته‌ترین مدل‌ها کمی کمبود داشته باشیم.  
* رویکردهای کمتر محبوب هوش مصنوعی، مانند **الگوریتم‌های ژنتیک** و **سیستم‌های چندعاملی**.  

آنچه در این برنامه درسی پوشش داده نخواهد شد:  
...
| 09  |            [اتواینکدرها و VAEs](./lessons/4-ComputerVision/09-Autoencoders/README.md)             |           [PyTorch](./lessons/4-ComputerVision/09-Autoencoders/AutoEncodersPyTorch.ipynb) / [TensorFlow](./lessons/4-ComputerVision/09-Autoencoders/AutoencodersTF.ipynb)             |  |
...
| 14  |            [ج嵀嵀嵀嵀嵀嵀嵀嵀嵀嵀嵀嵀嵀嵀嵀嵀嵀嵀
- 💬 **تحلیل احساسات متن** - تحلیل متن‌های مثبت/منفی
...
- ما یک [درس راه‌اندازی](./lessons/0-course-setup/setup.md) ایجاد کرده‌ایم تا به شما در تنظیم محیط توسعه کمک کند. - برای معلمان، ما یک [درس راه‌اندازی برنامه درسی](./lessons/0-course-setup/for-teachers.md) نیز ایجاد کرده‌ایم!
...
به [سرور رسمی دیسکورد هوش مصنوعی](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) بپیوندید تا با دیگر یادگیرندگان این دوره آشنا شوید و شبکه‌سازی کنید و پشتیبانی بگیرید.

اگر بازخوردی درباره محصول یا سوالاتی در حین ساخت دارید، به [فروم توسعه‌دهندگان Azure AI Foundry](https://aka.ms/foundry/forum) مراجعه کنید.

## آزمون‌ها

> **یادداشتی درباره آزمون‌ها**: تمام آزمون‌ها در پوشه Quiz-app در مسیر etc\quiz-app قرار دارند، یا [آنلاین اینجا](https://ff-quizzes.netlify.app/) موجود هستند. این آزمون‌ها از داخل درس‌ها لینک شده‌اند و می‌توانند به صورت محلی اجرا شوند یا به Azure مستقر شوند؛ دستورالعمل‌ها در پوشه `quiz-app` موجود است. این آزمون‌ها به تدریج بومی‌سازی می‌شوند.
...
اگر گیر کردید یا سوالی درباره ساخت برنامه‌های هوش مصنوعی دارید، به یادگیرندگان دیگر و توسعه‌دهندگان با تجربه در بحث‌های مربوط به MCP بپیوندید. این یک جامعه حمایتی است که در آن سوالات خوش‌آمد هستند و دانش به صورت آزادانه به اشتراک گذاشته می‌شود.
