...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T19:13:00+00:00",
...
|![طرح‌نگاری توسط @girlie_mac https://twitter.com/girlie_mac](../../translated_images/ai-overview.0857791951d19500d0ef8b803d77110c738dcafc52306e6d68724742cd4af167.fa.png)|
|:---:|
...
* **ریاضیات عمیق** پشت یادگیری عمیق. برای این، ما کتاب [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) نوشته ایان گودفلو، یوشوا بنگیو و آرون کورویل را توصیه می‌کنیم که به صورت آنلاین نیز در دسترس است [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).
...
| 19  |            [تشخیص موجودیت‌های نام‌گذاری‌شده](./lessons/5-NLP/19-NER/README.md)             |           [TensorFlow](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/19-NER/NER-TF.ipynb)             | [آزمایشگاه](./lessons/5-NLP/19-NER/lab/README.md) |
| 20  |            [مدل‌های زبان بزرگ، برنامه‌نویسی با دستورات و وظایف کم‌شات](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
* مطالب پیش‌خوانی
* دفترچه‌های یادداشت Jupyter قابل اجرا که اغلب مختص چارچوب هستند (**PyTorch** یا **TensorFlow**). دفترچه یادداشت قابل اجرا همچنین شامل مطالب نظری زیادی است، بنابراین برای درک موضوع باید حداقل یک نسخه از دفترچه یادداشت (PyTorch یا TensorFlow) را مرور کنید.
* **آزمایشگاه‌ها** که برای برخی موضوعات موجود هستند و به شما فرصت می‌دهند تا مطالبی که یاد گرفته‌اید را روی یک مسئله خاص اعمال کنید.
...
اگر کاملاً تازه‌وارد به هوش مصنوعی هستید و می‌خواهید مثال‌های سریع و عملی را ببینید، به [**مثال‌های مناسب برای مبتدیان**](./examples/README.md) ما نگاهی بیندازید! این موارد شامل:
...
- 💬 **تحلیل احساس متن** - بررسی مثبت/منفی بودن متن

این مثال‌ها طراحی شده‌اند تا به شما کمک کنند مفاهیم هوش مصنوعی را قبل از ورود به برنامه کامل درک کنید.

### 📚 تنظیم برنامه کامل

- ما یک [درس تنظیم](./lessons/0-course-setup/setup.md) ایجاد کرده‌ایم تا به شما در تنظیم محیط توسعه کمک کند. - برای مربیان، ما یک [درس تنظیم برنامه درسی](./lessons/0-course-setup/for-teachers.md) نیز ایجاد کرده‌ایم!
...
به [سرور رسمی دیسکورد هوش مصنوعی](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) ما بپیوندید تا با دیگر یادگیرندگان این دوره آشنا شوید و شبکه‌سازی کنید و از حمایت برخوردار شوید.

اگر بازخورد محصول یا سوالاتی در حین ساخت دارید، به [فروم توسعه‌دهندگان Azure AI Foundry](https://aka.ms/foundry/forum) مراجعه کنید.

## آزمون‌ها

> **نکته‌ای درباره آزمون‌ها**: تمام آزمون‌ها در پوشه Quiz-app در مسیر etc\quiz-app قرار دارند، یا [آنلاین اینجا](https://ff-quizzes.netlify.app/) موجود هستند. آن‌ها از داخل درس‌ها لینک شده‌اند. اپلیکیشن آزمون می‌تواند به صورت محلی اجرا شود یا در Azure مستقر شود؛ دستورالعمل‌ها را در پوشه `quiz-app` دنبال کنید. این آزمون‌ها به تدریج بومی‌سازی می‌شوند.

## درخواست کمک

آیا پیشنهاداتی دارید یا خطاهای املایی یا کدی پیدا کرده‌اید؟ یک issue مطرح کنید یا یک pull request ایجاد کنید.
...
اگر گیر کردید یا سوالی درباره ساخت اپلیکیشن‌های هوش مصنوعی دارید، به بحث‌های مربوط به MCP بپیوندید. این یک جامعه حمایتی است که در آن سوالات خوش‌آمد هستند و دانش به صورت آزادانه به اشتراک گذاشته می‌شود.

[![دیسکورد Microsoft Foundry](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

اگر بازخورد محصول دارید یا در حین ساخت خطاهایی پیدا کردید، به اینجا مراجعه کنید:
