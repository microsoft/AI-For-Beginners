...
Изучите мир **Искусственного интеллекта** (ИИ) с нашей 12-недельной учебной программой, включающей 24 урока! В нее входят практические занятия, тесты и лабораторные работы. Программа рассчитана на начинающих и охватывает инструменты, такие как TensorFlow и PyTorch, а также вопросы этики в ИИ.  
...
* **Нейронные сети** и **глубокое обучение**, которые лежат в основе современного ИИ. Мы объясним ключевые концепции этих тем с помощью кода в двух популярных фреймворках - [TensorFlow](http://Tensorflow.org) и [PyTorch](http://pytorch.org).  
...
* Менее популярные подходы к ИИ, такие как **генетические алгоритмы** и **многокомпонентные системы**.  
...
- Мы создали [урок по настройке](./lessons/0-course-setup/setup.md), чтобы помочь вам настроить вашу среду разработки. - Для преподавателей мы также создали [урок по настройке учебной программы](./lessons/0-course-setup/for-teachers.md)!
