...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:21:30+00:00",
...
Изучите мир **искусственного интеллекта** (ИИ) с нашей 12-недельной учебной программой, включающей 24 урока! Она содержит практические занятия, тесты и лабораторные работы. Программа подходит для начинающих и охватывает инструменты, такие как TensorFlow и PyTorch, а также вопросы этики в ИИ.
...
Для мягкого введения в темы _ИИ в облаке_ можно рассмотреть учебный путь [Начало работы с искусственным интеллектом на Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum).
...
* Исполняемые Jupyter-ноутбуки, которые часто адаптированы под конкретный фреймворк (**PyTorch** или **TensorFlow**). Ноутбук также содержит много теоретического материала, поэтому для понимания темы необходимо изучить хотя бы одну версию ноутбука (PyTorch или TensorFlow).
...
- 💬 **Анализ текста** - Анализ положительных/отрицательных текстов

Эти примеры помогут вам понять основные концепции ИИ перед изучением полного курса.
...
2. Клонируйте репозиторий: `git clone https://github.com/microsoft/AI-For-Beginners.git`  
3. Не забудьте поставить звезду (🌟) этому репозиторию, чтобы легче было его найти позже.  

## Познакомьтесь с другими учащимися  

Присоединяйтесь к нашему [официальному AI Discord серверу](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum), чтобы познакомиться и наладить связи с другими учащимися, проходящими этот курс, а также получить поддержку.  
