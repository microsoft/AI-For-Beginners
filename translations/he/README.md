...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T18:06:22+00:00",
...
גלו את עולם ה-**אינטליגנציה המלאכותית** (AI) עם תוכנית הלימודים שלנו בת 12 שבועות ו-24 שיעורים! היא כוללת שיעורים מעשיים, חידונים ומעבדות. התוכנית ידידותית למתחילים ומכסה כלים כמו TensorFlow ו-PyTorch, וכן אתיקה ב-AI.
...
**אם ברצונכם לתמוך בשפות תרגום נוספות, הרשימה נמצאת [כאן](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
* גישות שונות לאינטליגנציה מלאכותית, כולל הגישה הסימבולית ה"ישנה והטובה" עם **ייצוג ידע** והסקת מסקנות ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).
* **רשתות עצביות** ו**למידה עמוקה**, שהן בלב הליבה של ה-AI המודרני. נמחיש את המושגים מאחורי נושאים חשובים אלה באמצעות קוד בשתי המסגרות הפופולריות ביותר - [TensorFlow](http://Tensorflow.org) ו-[PyTorch](http://pytorch.org).
* **ארכיטקטורות עצביות** לעבודה עם תמונות וטקסט. נכסה מודלים עדכניים אך ייתכן שנחסר מעט מהמצב-של-האמנות.
* גישות AI פחות נפוצות, כגון **אלגוריתמים גנטיים** ו**מערכות רב-סוכנים**.
...
* **AI שיחתי** ו**בוטים לשיחה**. יש מסלול למידה נפרד [יצירת פתרונות AI שיחתיים](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum), וניתן גם לעיין ב-[פוסט בלוג זה](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) לפרטים נוספים.
* **מתמטיקה עמוקה** מאחורי למידה עמוקה. לשם כך, מומלץ [למידה עמוקה](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) מאת איאן גודפלו, יושוע בנג'יו ואהרון קורוויל, שגם זמינה באינטרנט ב-[https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).

להיכרות עדינה עם נושאי _AI בענן_ מומלץ לקחת את מסלול הלמידה [התחילו עם אינטליגנציה מלאכותית ב-Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum).
...
| I  |               [**הקדמה ל-AI**](./lessons/1-Intro/README.md)      | | |
| 01  |       [הקדמה והיסטוריה של AI](./lessons/1-Intro/README.md)       |           -                            | -  |
| II |              **AI סימבולי**              |
...
| III |                        [**הקדמה לרשתות עצביות**](./lessons/3-NeuralNetworks/README.md) |||
...
| 05  |            [מבוא למסגרות עבודה (PyTorch/TensorFlow) והתחמקות מהתאמה יתרה](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [מעבדה](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
...
* חומר לקריאה מקדימה
* מחברות Jupyter ניתנות להרצה, שלרוב מותאמות למסגרת עבודה מסוימת (**PyTorch** או **TensorFlow**). המחברת הניתנת להרצה כוללת גם הרבה חומר תיאורטי, לכן כדי להבין את הנושא יש לעבור לפחות על גרסה אחת של המחברת (בין אם PyTorch או TensorFlow).
* **מעבדות** זמינות לכמה נושאים, שמאפשרות לך לנסות ליישם את החומר שלמדת על בעיה ספציפית.
* חלק מהקטעים כוללים קישורים למודולים ב-[**MS Learn**](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) שמכסים נושאים קשורים.
...
דוגמאות אלו נועדו לעזור לך להבין מושגי AI לפני שתצלול לתכנית הלימודים המלאה.
...
אל תשכח לתת כוכב (🌟) למאגר כדי למצוא אותו בקלות מאוחר יותר.

## פגוש לומדים אחרים

הצטרף לשרת ה-Discord הרשמי שלנו ל-AI [כאן](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) כדי להכיר וליצור קשר עם לומדים אחרים שלקחו את הקורס ולקבל תמיכה.

אם יש לך משוב על המוצר או שאלות בזמן הבנייה, בקר בפורום המפתחים של Azure AI Foundry [כאן](https://aka.ms/foundry/forum)

## חידונים

> **הערה לגבי חידונים**: כל החידונים נמצאים בתיקיית Quiz-app ב-etc\quiz-app, או [באינטרנט כאן](https://ff-quizzes.netlify.app/) הם מקושרים מתוך השיעורים, אפליקציית החידונים יכולה לפעול מקומית או להיות מופעלת ב-Azure; עקוב אחרי ההוראות בתיקיית `quiz-app`. הם מתורגמים בהדרגה.
...
הצוות שלנו מייצר תכניות לימודים נוספות! בדוק:
