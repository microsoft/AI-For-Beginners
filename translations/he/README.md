...
|:---:|  
| בינה מלאכותית למתחילים - _איור מאת [@girlie_mac](https://twitter.com/girlie_mac)_ |  

גלו את עולם ה**בינה המלאכותית** (AI) עם תוכנית לימודים בת 12 שבועות ו-24 שיעורים! התוכנית כוללת שיעורים מעשיים, חידונים ומעבדות. היא ידידותית למתחילים ומכסה כלים כמו TensorFlow ו-PyTorch, וגם עוסקת באתיקה בבינה מלאכותית.  
...
* גישות שונות לבינה מלאכותית, כולל הגישה הסמלית ה"ישנה והטובה" עם **ייצוג ידע** והסקת מסקנות ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).  
* **רשתות נוירונים** ו**למידה עמוקה**, שהן בלב הבינה המלאכותית המודרנית. נמחיש את הרעיונות מאחורי נושאים חשובים אלו באמצעות קוד בשני מסגרות פופולריות - [TensorFlow](http://Tensorflow.org) ו-[PyTorch](http://pytorch.org).  
* **ארכיטקטורות נוירונים** לעבודה עם תמונות וטקסט. נסקור מודלים עדכניים, אך ייתכן שלא נעסוק במודלים המתקדמים ביותר.  
* גישות פחות פופולריות בבינה מלאכותית, כמו **אלגוריתמים גנטיים** ו**מערכות מרובות סוכנים**.  

מה לא נכלל בתוכנית זו:  
...
| 05  |            [מבוא למסגרות (PyTorch/TensorFlow) ותופעת ה-Overfitting](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [מעבדה](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
...
אם אתם חדשים לגמרי ב-AI ורוצים דוגמאות מעשיות ומהירות, עיינו ב-[**דוגמאות ידידותיות למתחילים**](./examples/README.md)! דוגמאות אלו כוללות:
