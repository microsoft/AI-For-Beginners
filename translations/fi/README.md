...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-08-28T19:09:36+00:00",
...
* **Neuroverkot** ja **syväoppiminen**, jotka ovat modernin tekoälyn ytimessä. Käymme läpi näiden tärkeiden aiheiden taustalla olevat käsitteet koodin avulla kahdessa suosituimmassa kehikossa - [TensorFlow](http://Tensorflow.org) ja [PyTorch](http://pytorch.org).  
...
Jos haluat lempeän johdannon _tekoäly pilvessä_ -aiheisiin, harkitse oppimispolkua [Aloita tekoälyllä Azure-pilvessä](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum).  
...
| 04  |                   [Monikerroksinen perceptron ja oman kehikon luominen](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [Notebook](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [Lab](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |  
| 05  |            [Johdanto Frameworkeihin (PyTorch/TensorFlow) ja Yliläräämiseen](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Lab](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
...
| 13  |            [Tekstin esittäminen. Bow/TF-IDF](./lessons/5-NLP/13-TextRep/README.md)             |           [PyTorch](./lessons/5-NLP/13-TextRep/TextRepresentationPyTorch.ipynb) / [TensorFlow](./lessons/5-NLP/13-TextRep/TextRepresentationTF.ipynb)             | |
| 14  |            [Semanttiset sanavektorit. Word2Vec ja GloVe](./lessons/5-NLP/14-Embeddings/README.md)             |           [PyTorch](./lessons/5-NLP/14-Embeddings/EmbeddingsPyTorch.ipynb) / [TensorFlow](./lessons/5-NLP/14-Embeddings/EmbeddingsTF.ipynb)             |  |
| 15  |            [Kielimallinnus. Omien sanavektorien kouluttaminen](./lessons/5-NLP/15-LanguageModeling/README.md)             |           [PyTorch](./lessons/5-NLP/15-LanguageModeling/CBoW-PyTorch.ipynb) / [TensorFlow](./lessons/5-NLP/15-LanguageModeling/CBoW-TF.ipynb)             | [Lab](./lessons/5-NLP/15-LanguageModeling/lab/README.md) |
| 16  |            [Toistuvat neuroverkot](./lessons/5-NLP/16-RNN/README.md)             |           [PyTorch](./lessons/5-NLP/16-RNN/RNNPyTorch.ipynb) / [TensorFlow](./lessons/5-NLP/16-RNN/RNNTF.ipynb)             |  |
| 17  |            [Generatiiviset toistuvat verkot](./lessons/5-NLP/17-GenerativeNetworks/README.md)             |           [PyTorch](./lessons/5-NLP/17-GenerativeNetworks/GenerativePyTorch.md) / [TensorFlow](./lessons/5-NLP/17-GenerativeNetworks/GenerativeTF.md)             | [Lab](./lessons/5-NLP/17-GenerativeNetworks/lab/README.md) |
| 18  |            [Transformerit. BERT.](./lessons/5-NLP/18-Transformers/READMEtransformers.md)             |           [PyTorch](./lessons/5-NLP/18-Transformers/TransformersPyTorch.ipynb) /[TensorFlow](./lessons/5-NLP/18-Transformers/TransformersTF.ipynb)             |  |
| 19  |            [Nimien tunnistus (Named Entity Recognition)](./lessons/5-NLP/19-NER/README.md)             |           [TensorFlow](./lessons/5-NLP/19-NER/NER-TF.ipynb)             | [Lab](./lessons/5-NLP/19-NER/lab/README.md) |
| 20  |            [Suuret kielimallit, kehotteiden ohjelmointi ja vähäisten esimerkkien tehtävät](./lessons/5-NLP/20-LangModels/READMELargeLang.md)             |           [PyTorch](./lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
Kloonaa Repository: `git clone https://github.com/microsoft/AI-For-Beginners.git`

Älä unohda tähdittää (🌟) tätä repoasi, jotta löydät sen helpommin myöhemmin.

## Tapaa muita oppijoita

Liity [viralliselle AI Discord-palvelimellemme](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) tapaamaan ja verkostoitumaan muiden kurssia käyvien oppijoiden kanssa sekä saamaan tukea.
...
## Visailut
> **Huomio tietovisoista**: Kaikki tietovisat löytyvät Quiz-app-kansiosta polusta etc\quiz-app, tai [Verkossa Täällä](https://ff-quizzes.netlify.app/). Ne on linkitetty oppituntien sisällä, ja tietovisasovellusta voi käyttää paikallisesti tai julkaista Azureen; seuraa ohjeita `quiz-app`-kansiossa. Tietovisoja lokalisoidaan vähitellen.
## Apua kaivataan
...
* **✅ Visailun laatija:** [Lateefah Bello](https://github.com/CinnamonXI), [MLSA](https://studentambassadors.microsoft.com/)
* **🙏 Ydinkontribuuttorit:** [Evgenii Pishchik](https://github.com/Pe4enIks)

## Muut oppimateriaalit

Tiimimme tuottaa myös muita oppimateriaaleja! Tutustu näihin:
