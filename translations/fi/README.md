...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:33:41+00:00",
...
Tutustu **tekoälyn** (AI) maailmaan 12 viikon ja 24 oppitunnin opetussuunnitelmamme avulla! Se sisältää käytännön oppitunteja, tietovisoja ja laboratorioita. Opetussuunnitelma on aloittelijaystävällinen ja kattaa työkalut kuten TensorFlow ja PyTorch sekä tekoälyn etiikan.
...
**Jos haluat lisätä tukikielivalikoimaa, tuetut kielet löytyvät [täältä](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
* Eri lähestymistapoja tekoälyyn, mukaan lukien "hyvä vanha" symbolinen lähestymistapa, jossa käytetään **tiedon esitystä** ja päättelyä ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).
* **Neuroverkot** ja **syväoppiminen**, jotka ovat modernin tekoälyn ytimessä. Havainnollistamme näiden tärkeiden aiheiden taustalla olevia käsitteitä koodin avulla kahdessa suosituimmassa kehitysympäristössä - [TensorFlow](http://Tensorflow.org) ja [PyTorch](http://pytorch.org).
* **Neuroarkkitehtuurit** kuvien ja tekstin käsittelyyn. Käymme läpi viimeisimpiä malleja, mutta ne eivät välttämättä ole aivan huippuluokkaa.
...
| 02  |       [Tiedon esitys ja asiantuntijajärjestelmät](./lessons/2-Symbolic/README.md)       |            [Asiantuntijajärjestelmät](./lessons/2-Symbolic/Animals.ipynb) /  [Ontologia](./lessons/2-Symbolic/FamilyOntology.ipynb) /[Käsitteiden verkko](./lessons/2-Symbolic/MSConceptGraph.ipynb)                             |  |
| III |                        [**Johdanto neuroverkkoihin**](./lessons/3-NeuralNetworks/README.md) |||
| 03  |                [Perceptron](./lessons/3-NeuralNetworks/03-Perceptron/README.md)                 |                       [Notebook](./lessons/3-NeuralNetworks/03-Perceptron/Perceptron.ipynb)                      | [Lab](./lessons/3-NeuralNetworks/03-Perceptron/lab/README.md) |
| 04  |                   [Monikerroksinen perceptroni ja oman kehyksen luominen](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [Notebook](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [Lab](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |
| 05  |            [Johdanto kehyksiin (PyTorch/TensorFlow) ja ylisovittaminen](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Lab](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
...
| 06  |            [Johdanto koneelliseen näkön. OpenCV](./lessons/4-ComputerVision/06-IntroCV/README.md)             |           [Notebook](./lessons/4-ComputerVision/06-IntroCV/OpenCV.ipynb)         | [Lab](./lessons/4-ComputerVision/06-IntroCV/lab/README.md) |
...
| 11  |            [Kohteiden tunnistus](./lessons/4-ComputerVision/11-ObjectDetection/README.md)             |         [TensorFlow](./lessons/4-ComputerVision/11-ObjectDetection/ObjectDetection.ipynb)             | [Lab](./lessons/4-ComputerVision/11-ObjectDetection/lab/README.md) |
...
* Ennakkolukemista
* Suoritettavia Jupyter-muistikirjoja, jotka ovat usein kehyspesifisiä (**PyTorch** tai **TensorFlow**). Suoritettava muistikirja sisältää myös paljon teoreettista materiaalia, joten aiheen ymmärtämiseksi sinun tulee käydä läpi vähintään yksi muistikirjan versio (joko PyTorch tai TensorFlow).
* Joillekin aiheille on tarjolla **labroja**, jotka antavat sinulle mahdollisuuden kokeilla oppimasi materiaalin soveltamista tiettyyn ongelmaan.
...
- Olemme luoneet [asennustunnin](./lessons/0-course-setup/setup.md) auttamaan sinua kehitysympäristön asennuksessa. - Opettajille olemme myös luoneet [opetussuunnitelman asennustunnin](./lessons/0-course-setup/for-teachers.md)!
- Kuinka [suorittaa koodi VSCode- tai Codepace-ympäristössä](./lessons/0-course-setup/how-to-run.md)
...
Liity viralliseen [AI Discord -palvelimeemme](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) tavata ja verkostoitua muiden tämän kurssin osallistujien kanssa ja saada tukea.

Jos sinulla on tuotepalautetta tai kysymyksiä rakentamisen aikana, käy [Azure AI Foundry Developer Forumissa](https://aka.ms/foundry/forum)

## Kyselyt

> **Huomautus kyselyistä**: Kaikki kyselyt löytyvät Quiz-app-kansiosta polussa etc\quiz-app, tai [verkkossa täällä](https://ff-quizzes.netlify.app/) Ne on linkitetty oppituntien sisällä, kyselysovellus voidaan suorittaa paikallisesti tai ottaa käyttöön Azureen; noudata ohjeita `quiz-app`-kansiossa. Ne ovat asteittain lokalisoitavina.
