...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:34:57+00:00",
...
* **Neuroverkot** ja **syväoppiminen**, jotka ovat modernin tekoälyn ytimessä. Havainnollistamme näiden tärkeiden aiheiden käsitteitä koodin avulla kahdessa suosituimmassa kehyksessä - [TensorFlow](http://Tensorflow.org) ja [PyTorch](http://pytorch.org).  
* **Neuraaliset arkkitehtuurit** kuvien ja tekstin käsittelyyn. Käsittelemme uusia malleja, mutta emme välttämättä kata aivan uusinta teknologiaa.  
...
Hellävaraiseksi johdatukseksi _tekoäly pilvessä_ -aiheisiin voit harkita [Aloita tekoälyn käyttö Azurella](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) -oppimispolkua.  
...
| 03  |                [Perceptron](./lessons/3-NeuralNetworks/03-Perceptron/README.md)                 |                       [Muistikirja](./lessons/3-NeuralNetworks/03-Perceptron/Perceptron.ipynb)                      | [Lab](./lessons/3-NeuralNetworks/03-Perceptron/lab/README.md) |
| 04  |                   [Monikerroksinen Perceptron ja oman kehyksen luominen](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [Muistikirja](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [Lab](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |
...
* **Labit**, jotka ovat saatavilla joillekin aiheille ja antavat mahdollisuuden soveltaa oppimaasi materiaalia tiettyyn ongelmaan.
...
Nämä esimerkit on suunniteltu auttamaan sinua ymmärtämään tekoälyn peruskäsitteitä ennen kuin sukellat koko oppimateriaalin pariin.

### 📚 Koko oppimateriaalin asennus

- Olemme luoneet [asennusoppaan](./lessons/0-course-setup/setup.md) auttamaan kehitysympäristön asennuksessa. - Opettajille olemme luoneet myös [opetussuunnitelman asennusoppaan](./lessons/0-course-setup/for-teachers.md)!
- Kuinka [ajaa koodi VSCode- tai Codespace-ympäristössä](./lessons/0-course-setup/how-to-run.md)
...
> **Huomio kyselyistä**: Kaikki kyselyt löytyvät Quiz-app-kansiosta polusta etc\quiz-app, tai [verkossa täällä](https://ff-quizzes.netlify.app/). Ne on linkitetty oppitunneilta, ja kyselysovellusta voi ajaa paikallisesti tai julkaista Azureen; seuraa ohjeita `quiz-app`-kansiossa. Kyselyitä lokalisoidaan vähitellen.
...
* **✅ Kyselyiden luoja:** [Lateefah Bello](https://github.com/CinnamonXI), [MLSA](https://studentambassadors.microsoft.com/)
...
### LangChain
[![LangChain4j aloittelijoille](https://img.shields.io/badge/LangChain4j%20aloittelijoille-22C55E?style=for-the-badge&&labelColor=E5E7EB&color=0553D6)](https://aka.ms/langchain4j-for-beginners)
[![LangChain.js aloittelijoille](https://img.shields.io/badge/LangChain.js%20aloittelijoille-22C55E?style=for-the-badge&labelColor=E5E7EB&color=0553D6)](https://aka.ms/langchainjs-for-beginners?WT.mc_id=m365-94501-dwahlin)
