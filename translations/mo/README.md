...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T15:52:06+00:00",
...
透過我們為期12週、共24課的課程，探索**人工智能**（AI）的世界！課程包含實用的教學、測驗和實驗室。此課程適合初學者，涵蓋 TensorFlow 和 PyTorch 等工具，以及 AI 倫理議題。
...
* **神經網絡**與**深度學習**，這是現代 AI 的核心。我們將透過兩個最受歡迎的框架——[TensorFlow](http://Tensorflow.org) 和 [PyTorch](http://pytorch.org) 的程式碼，說明這些重要主題背後的概念。
...
* **商業中 AI 的應用案例**。建議參考 Microsoft Learn 上的 [商業用戶 AI 入門](https://docs.microsoft.com/learn/paths/introduction-ai-for-business-users/?WT.mc_id=academic-77998-bethanycheum) 學習路徑，或與 [INSEAD](https://www.insead.edu/) 合作開發的 [AI 商業學院](https://www.microsoft.com/ai/ai-business-school/?WT.mc_id=academic-77998-bethanycheum)。
...
* **對話式 AI**與**聊天機器人**。有專門的 [建立對話式 AI 解決方案](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum) 學習路徑，也可參考[這篇部落格文章](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/)了解更多細節。
* 深度學習背後的**深奧數學**。推薦閱讀 Ian Goodfellow、Yoshua Bengio 和 Aaron Courville 的 [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618)，線上版本可見於 [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/)。
...
如果你是 AI 完全新手，想要快速且實用的範例，請參考我們的 [**初學者友善範例**](./examples/README.md)！內容包括：

- 🌟 **Hello AI World** - 你的第一個 AI 程式（模式識別）
- 🧠 **簡單神經網絡** - 從零開始建立神經網絡  
- 🖼️ **影像分類器** - 帶有詳細註解的影像分類器
- 💬 **文字情感分析** - 分析正面/負面文字
...
- 我們已製作了一個[設置課程](./lessons/0-course-setup/setup.md)，協助你建立開發環境。 - 教師專用，我們也準備了[課程設置教學](./lessons/0-course-setup/for-teachers.md)！
...
如果你在開發過程中有產品反饋或疑問，歡迎造訪我們的[Azure AI Foundry 開發者論壇](https://aka.ms/foundry/forum)

## 測驗

> **關於測驗的小提醒**：所有測驗都放在 etc\quiz-app 的 Quiz-app 資料夾中，或可[線上使用](https://ff-quizzes.netlify.app/)。測驗連結會出現在課程中，測驗應用程式可在本地執行或部署到 Azure；請依照 `quiz-app` 資料夾中的說明操作。測驗內容正逐步進行在地化。
...
如果你在開發 AI 應用時遇到困難或有任何問題，歡迎加入 MCP 的學習者與資深開發者討論社群。這裡是個支持彼此、歡迎提問並自由分享知識的友善社群。
