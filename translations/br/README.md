...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:06:13+00:00",
...
|![Sketchnote by @girlie_mac https://twitter.com/girlie_mac](../../translated_images/ai-overview.0857791951d19500d0ef8b803d77110c738dcafc52306e6d68724742cd4af167.br.png)|
|:---:|
| AI For Beginners - _Sketchnote por [@girlie_mac](https://twitter.com/girlie_mac)_ |

Explore o mundo da **Inteligência Artificial** (IA) com nosso currículo de 12 semanas e 24 lições! Inclui lições práticas, quizzes e laboratórios. O currículo é amigável para iniciantes e cobre ferramentas como TensorFlow e PyTorch, além de ética em IA.
...
* Diferentes abordagens para Inteligência Artificial, incluindo a abordagem simbólica "antiga e boa" com **Representação do Conhecimento** e raciocínio ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).
* **Redes Neurais** e **Aprendizado Profundo**, que estão no núcleo da IA moderna. Ilustraremos os conceitos por trás desses tópicos importantes usando código em dois dos frameworks mais populares - [TensorFlow](http://Tensorflow.org) e [PyTorch](http://pytorch.org).
* **Arquiteturas Neurais** para trabalhar com imagens e texto. Cobriremos modelos recentes, mas pode faltar um pouco do estado da arte.
...
* Jupyter Notebooks executáveis, que frequentemente são específicos para o framework (**PyTorch** ou **TensorFlow**). O notebook executável também contém muito material teórico, então para entender o tópico você precisa passar por pelo menos uma versão do notebook (seja PyTorch ou TensorFlow).
...
Junte-se ao nosso [servidor oficial de Discord de IA](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) para conhecer e fazer networking com outros aprendizes que estão fazendo este curso e obter suporte.
