...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T08:05:56+00:00",
...
![Resumo do conteúdo de Introdução à IA em um doodle](../../../../translated_images/ai-intro.bf28d1ac4235881c096f0ffdb320ba4102940eafcca4e9d7a55a03914361f8f3.br.png)

> Sketchnote por [Tomomi Imura](https://twitter.com/girlie_mac)

## [Quiz pré-aula](https://ff-quizzes.netlify.app/en/ai/quiz/1)

**Inteligência Artificial** é uma disciplina científica empolgante que estuda como podemos fazer com que computadores exibam comportamentos inteligentes, ou seja, realizem aquelas coisas em que os seres humanos são bons.
...
IA Fraca | IA Forte
---------------------------------------|-------------------------------------
IA Fraca refere-se a sistemas de IA projetados e treinados para uma tarefa específica ou um conjunto limitado de tarefas.|IA Forte, ou Inteligência Artificial Geral (AGI), refere-se a sistemas de IA com inteligência e compreensão em nível humano.
...
Para ver a ambiguidade do termo *inteligência*, tente responder à pergunta: "Um gato é inteligente?". Diferentes pessoas tendem a dar respostas diferentes a essa pergunta, pois não há um teste universalmente aceito para provar se a afirmação é verdadeira ou não. E se você acha que há - tente aplicar um teste de QI ao seu gato...
...
✅ Você já foi enganado por um chatbot ao pensar que estava conversando com um humano? Como ele te convenceu?
...
---------------------------------------|-------------------------------------
Uma abordagem de cima para baixo modela a maneira como uma pessoa raciocina para resolver um problema. Isso envolve extrair **conhecimento** de um ser humano e representá-lo em uma forma legível por computador. Também precisamos desenvolver uma maneira de modelar o **raciocínio** dentro de um computador. | Uma abordagem de baixo para cima modela a estrutura do cérebro humano, consistindo em um grande número de unidades simples chamadas **neurônios**. Cada neurônio age como uma média ponderada de suas entradas, e podemos treinar uma rede de neurônios para resolver problemas úteis fornecendo **dados de treinamento**.

Existem também outras abordagens possíveis para inteligência:

* Uma abordagem **Emergente**, **Sinergética** ou **multiagente** baseia-se no fato de que comportamentos inteligentes complexos podem ser obtidos pela interação de um grande número de agentes simples. De acordo com a [cibernética evolucionária](https://en.wikipedia.org/wiki/Global_brain#Evolutionary_cybernetics), a inteligência pode *emergir* de comportamentos mais simples e reativos no processo de *transição de metasistema*.

* Uma abordagem **Evolutiva**, ou **algoritmo genético**, é um processo de otimização baseado nos princípios da evolução.

Consideraremos essas abordagens mais tarde no curso, mas agora nos concentraremos em duas direções principais: de cima para baixo e de baixo para cima.
...
Alternativamente, podemos tentar modelar os elementos mais simples dentro de nosso cérebro – um neurônio. Podemos construir uma chamada **rede neural artificial** dentro de um computador e, em seguida, tentar ensiná-la a resolver problemas fornecendo exemplos. Esse processo é semelhante à forma como um recém-nascido aprende sobre seu ambiente ao fazer observações.
...
Nos últimos anos, testemunhamos grandes sucessos com modelos de linguagem de grande escala, como BERT e GPT-3. Isso aconteceu principalmente devido ao fato de que há uma grande quantidade de dados de texto geral disponível, permitindo treinar modelos para capturar a estrutura e o significado dos textos, pré-treiná-los em coleções de textos gerais e, em seguida, especializar esses modelos para tarefas mais específicas. Aprenderemos mais sobre [Processamento de Linguagem Natural](../5-NLP/README.md) mais adiante neste curso.

## 🚀 Desafio

Faça um tour pela internet para determinar onde, na sua opinião, a IA é mais eficazmente utilizada. É em um aplicativo de mapeamento, algum serviço de conversão de fala para texto ou em um videogame? Pesquise como o sistema foi construído.
