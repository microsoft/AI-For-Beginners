...
**Nếu bạn muốn hỗ trợ thêm các ngôn ngữ, danh sách các ngôn ngữ được hỗ trợ có thể được tìm thấy [tại đây](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**  
...
* Tài liệu đọc trước
* Các Jupyter Notebook có thể thực thi, thường được thiết kế riêng cho từng framework (**PyTorch** hoặc **TensorFlow**). Notebook này cũng chứa nhiều tài liệu lý thuyết, vì vậy để hiểu chủ đề, bạn cần xem qua ít nhất một phiên bản của notebook (PyTorch hoặc TensorFlow).
