...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:42:56+00:00",
...
Khám phá thế giới của **Trí Tuệ Nhân Tạo** (AI) với chương trình học 12 tuần, 24 bài học! Nó bao gồm các bài học thực hành, bài kiểm tra và phòng thí nghiệm. Chương trình học thân thiện với người mới bắt đầu và bao gồm các công cụ như TensorFlow và PyTorch, cũng như đạo đức trong AI
...
* Các phương pháp tiếp cận khác nhau về Trí Tuệ Nhân Tạo, bao gồm phương pháp "cổ điển" biểu tượng với **Biểu diễn Kiến thức** và suy luận ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).
...
* **Kiến trúc Nơ-ron** để làm việc với hình ảnh và văn bản. Chúng tôi sẽ đề cập đến các mô hình gần đây nhưng có thể hơi thiếu về trạng thái nghệ thuật mới nhất.
...
* Tài liệu đọc trước
* Các Jupyter Notebook có thể chạy được, thường dành riêng cho framework (**PyTorch** hoặc **TensorFlow**). Notebook có thể chạy cũng chứa nhiều tài liệu lý thuyết, vì vậy để hiểu chủ đề bạn cần xem ít nhất một phiên bản của notebook (hoặc PyTorch hoặc TensorFlow).
* **Phòng thí nghiệm** có sẵn cho một số chủ đề, giúp bạn có cơ hội thử áp dụng kiến thức đã học vào một vấn đề cụ thể.
* Một số phần có liên kết đến các module [**MS Learn**](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) bao gồm các chủ đề liên quan.

## Bắt đầu

### 🎯 Mới với AI? Bắt đầu tại đây!

Nếu bạn hoàn toàn mới với AI và muốn các ví dụ thực hành nhanh, hãy xem [**Ví dụ thân thiện với người mới bắt đầu**](./examples/README.md)! Bao gồm:
...
- Chúng tôi đã tạo một [bài học thiết lập](./lessons/0-course-setup/setup.md) để giúp bạn thiết lập môi trường phát triển. - Dành cho Giảng viên, chúng tôi cũng đã tạo một [bài học thiết lập chương trình học](./lessons/0-course-setup/for-teachers.md) cho bạn!
...
> **Lưu ý về bài kiểm tra**: Tất cả các bài kiểm tra được chứa trong thư mục Quiz-app tại etc\quiz-app, hoặc [Trực tuyến tại đây](https://ff-quizzes.netlify.app/) Chúng được liên kết trong các bài học, ứng dụng quiz có thể chạy cục bộ hoặc triển khai lên Azure; làm theo hướng dẫn trong thư mục `quiz-app`. Chúng đang dần được bản địa hóa.
...
Nếu bạn bị mắc kẹt hoặc có bất kỳ câu hỏi nào về việc xây dựng ứng dụng AI. Hãy tham gia cùng các học viên và nhà phát triển có kinh nghiệm trong các cuộc thảo luận về MCP. Đây là một cộng đồng hỗ trợ, nơi các câu hỏi được chào đón và kiến thức được chia sẻ tự do.
