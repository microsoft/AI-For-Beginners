...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T18:48:44+00:00",
...
|![Sketchnote by @girlie_mac https://twitter.com/girlie_mac](../../translated_images/ai-overview.0857791951d19500d0ef8b803d77110c738dcafc52306e6d68724742cd4af167.hu.png)|
|:---:|
| AI Kezdőknek – _Sketchnote [@girlie_mac](https://twitter.com/girlie_mac) tollából_ |

Fedezd fel a **Mesterséges Intelligencia** (MI) világát 12 hét, 24 lecke során! Gyakorlati leckéket, kvízeket és laborokat tartalmaz. A tananyag kezdőknek szól, és olyan eszközöket fed le, mint a TensorFlow és a PyTorch, valamint az MI etikai kérdéseit is.
...
**Ha további nyelveken szeretnél fordítást, az elérhető nyelvek listája [itt található](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
* A mesterséges intelligencia különböző megközelítéseit, beleértve a „régi jó” szimbolikus megközelítést a **tudásreprezentációval** és a következtetéssel ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).
* A **neurális hálózatokat** és a **mélytanulást**, amelyek a modern MI alapját képezik. Ezeknek a fontos témáknak a fogalmait két népszerű keretrendszer – a [TensorFlow](http://Tensorflow.org) és a [PyTorch](http://pytorch.org) – kódpéldáin keresztül mutatjuk be.
* **Neurális architektúrákat** képek és szövegek feldolgozásához. Bemutatjuk a legújabb modelleket, bár lehet, hogy nem teljesen naprakészek a legmodernebb technológiák terén.
* Kevésbé ismert MI megközelítéseket, mint például a **genetikus algoritmusok** és a **többügynökös rendszerek**.

A tananyag nem foglalkozik:

> [A tanfolyam további anyagai megtalálhatók a Microsoft Learn gyűjteményünkben](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum)

* Az **üzleti MI** eseteivel. Érdemes megnézni a [Bevezetés az üzleti felhasználók MI-jébe](https://docs.microsoft.com/learn/paths/introduction-ai-for-business-users/?WT.mc_id=academic-77998-bethanycheum) tanulási útvonalat a Microsoft Learn-en, vagy az [AI Business School](https://www.microsoft.com/ai/ai-business-school/?WT.mc_id=academic-77998-bethanycheum) programot, amelyet az [INSEAD](https://www.insead.edu/) közreműködésével fejlesztettek ki.
* A **klasszikus gépi tanulást**, amelyről részletesen szól a [Gépi tanulás kezdőknek tananyagunk](http://github.com/Microsoft/ML-for-Beginners).
* Gyakorlati MI alkalmazásokat, amelyeket a **[Kognitív Szolgáltatások](https://azure.microsoft.com/services/cognitive-services/?WT.mc_id=academic-77998-bethanycheum)** segítségével építenek. Ehhez ajánljuk a Microsoft Learn moduljait a [képfeldolgozás](https://docs.microsoft.com/learn/paths/create-computer-vision-solutions-azure-cognitive-services/?WT.mc_id=academic-77998-bethanycheum), a [természetes nyelvfeldolgozás](https://docs.microsoft.com/learn/paths/explore-natural-language-processing/?WT.mc_id=academic-77998-bethanycheum), a **[Generatív MI az Azure OpenAI szolgáltatással](https://learn.microsoft.com/en-us/training/paths/develop-ai-solutions-azure-openai/?WT.mc_id=academic-77998-bethanycheum)** és más témákban.
* Specifikus gépi tanulási **felhőkeretrendszereket**, mint például az [Azure Machine Learning](https://azure.microsoft.com/services/machine-learning/?WT.mc_id=academic-77998-bethanycheum), a [Microsoft Fabric](https://learn.microsoft.com/en-us/training/paths/get-started-fabric/?WT.mc_id=academic-77998-bethanycheum) vagy az [Azure Databricks](https://docs.microsoft.com/learn/paths/data-engineer-azure-databricks?WT.mc_id=academic-77998-bethanycheum). Érdemes megnézni a [Gépi tanulási megoldások építése és üzemeltetése Azure Machine Learninggel](https://docs.microsoft.com/learn/paths/build-ai-solutions-with-azure-ml-service/?WT.mc_id=academic-77998-bethanycheum) és a [Gépi tanulási megoldások építése és üzemeltetése Azure Databricks-szel](https://docs.microsoft.com/learn/paths/build-operate-machine-learning-solutions-azure-databricks/?WT.mc_id=academic-77998-bethanycheum) tanulási útvonalakat.
* **Konverzációs MI** és **chatbotok**. Van külön [Konverzációs MI megoldások létrehozása](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum) tanulási útvonal, és további részletekért ajánljuk [ezt a blogbejegyzést](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/).
...
Az _MI a felhőben_ témakörök finom bevezetéséhez érdemes lehet elvégezni a [Mesterséges intelligencia kezdőknek az Azure-on](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) tanulási útvonalat.
...
| 05  |            [Bevezetés a keretrendszerekbe (PyTorch/TensorFlow) és a túltanulás](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Labor](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
...
| 10  |            [Generatív ellenfelek hálózatai és művészi stílusátvitel](./lessons/4-ComputerVision/10-GANs/README.md)             |           [PyTorch](./lessons/4-ComputerVision/10-GANs/GANPyTorch.ipynb) / [TensorFlow](./lessons/4-ComputerVision/10-GANs/GANTF.ipynb)             |  |
...
| 19  |            [Név szerinti entitás felismerés](./lessons/5-NLP/19-NER/README.md)             |           [TensorFlow](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/19-NER/NER-TF.ipynb)             | [Labor](./lessons/5-NLP/19-NER/lab/README.md) |
...
* Előolvasási anyag
* Futatható Jupyter jegyzetfüzetek, amelyek gyakran a keretrendszerhez kötöttek (**PyTorch** vagy **TensorFlow**). A futtatható jegyzetfüzet sok elméleti anyagot is tartalmaz, ezért a téma megértéséhez legalább az egyik verziót (PyTorch vagy TensorFlow) végig kell nézni.
* Bizonyos témákhoz elérhető **laborok**, amelyek lehetőséget adnak arra, hogy a tanultakat egy konkrét problémán próbáld ki.
* Egyes szakaszok tartalmaznak linkeket a [**MS Learn**](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) moduljaihoz, amelyek kapcsolódó témákat fednek le.

## Kezdés

### 🎯 Új vagy az MI-ben? Innen indulj!

Ha teljesen új vagy az MI-ben és gyors, gyakorlati példákat keresel, nézd meg a [**Kezdőknek szóló példáinkat**](./examples/README.md)! Ezek tartalmazzák:

- 🌟 **Hello AI World** - Az első MI programod (mintafelismerés)
- 🧠 **Egyszerű neurális hálózat** - Építs neurális hálózatot a nulláról  
- 🖼️ **Kép osztályozó** - Képeket osztályozz részletes magyarázatokkal
...
- Készítettünk egy [beállító leckét](./lessons/0-course-setup/setup.md), hogy segítsünk a fejlesztői környezeted beállításában. - Oktatóknak is van egy [tananyag-beállító lecke](./lessons/0-course-setup/for-teachers.md)!
- Hogyan [futtasd a kódot VSCode-ban vagy Codepace-ben](./lessons/0-course-setup/how-to-run.md)

Kövesd ezeket a lépéseket:

Forkold a tárolót: Kattints a "Fork" gombra a jobb felső sarokban.
...
## Ismerkedj más tanulókkal

Csatlakozz hivatalos [AI Discord szerverünkhöz](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum), hogy találkozz és kapcsolatot építs más tanulókkal, akik ezt a tanfolyamot végzik, és hogy támogatást kapj.

Ha termék-visszajelzésed vagy kérdésed van a fejlesztés közben, látogass el az [Azure AI Foundry fejlesztői fórumra](https://aka.ms/foundry/forum)

## Kvízek

> **Megjegyzés a kvízekhez**: Minden kvíz az etc\quiz-app mappában található, vagy [online itt](https://ff-quizzes.netlify.app/). A leckékből hivatkozunk rájuk, a kvíz alkalmazás helyben futtatható vagy Azure-ra telepíthető; kövesd az utasításokat a `quiz-app` mappában. Folyamatosan lokalizáljuk őket.

## Segítséget kérünk

Van javaslatod, vagy találtál helyesírási vagy kódhibát? Nyiss egy issue-t vagy hozz létre egy pull requestet.
...
Ha termék-visszajelzésed vagy hibákba ütközöl fejlesztés közben, látogass el:
