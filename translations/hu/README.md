...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-07T14:05:52+00:00",
...
|:---:|  
| AI Kezdőknek - _Sketchnote készítette: [@girlie_mac](https://twitter.com/girlie_mac)_ |  

Fedezd fel a **Mesterséges Intelligencia** (MI) világát 12 hetes, 24 leckéből álló tananyagunkkal! Gyakorlati órákat, kvízeket és laborokat tartalmaz. A tananyag kezdőbarát, és olyan eszközöket is bemutat, mint a TensorFlow és PyTorch, valamint az MI etikai kérdéseit.
...
**Ha további nyelveken szeretnéd látni a fordítást, a támogatott nyelvek listája [itt található](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**  
...
* **Neurális architektúrákat** képek és szövegek feldolgozásához. Bár a legújabb modelleket bemutatjuk, lehet, hogy nem teljesen naprakészek.  
...
> [Az összes további forrást megtalálod a kurzushoz a Microsoft Learn gyűjteményünkben](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum)  
...
Egy könnyed bevezetéshez az _MI a felhőben_ témákhoz érdemes lehet részt venni a [Bevezetés a mesterséges intelligenciába az Azure-on](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) tanulási útvonalon.

# Tartalom

|     |                                                                 Lecke linkje                                                                  |                                           PyTorch/Keras/TensorFlow                                          | Labor                                                            |
| :-: | :------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: | ------------------------------------------------------------------------------ |
...
| 04  |                   [Többrétegű perceptron és saját keretrendszer létrehozása](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [Notebook](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [Labor](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |  
| 05  |            [Bevezetés a keretrendszerekbe (PyTorch/TensorFlow) és a túltanulásba](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Gyakorlat](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
| IV  |            [**Számítógépes látás**](./lessons/4-ComputerVision/README.md)             | [PyTorch](https://docs.microsoft.com/learn/modules/intro-computer-vision-pytorch/?WT.mc_id=academic-77998-cacaste) / [TensorFlow](https://docs.microsoft.com/learn/modules/intro-computer-vision-TensorFlow/?WT.mc_id=academic-77998-cacaste)| [Számítógépes látás felfedezése a Microsoft Azure-on](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) |
| 06  |            [Bevezetés a számítógépes látásba. OpenCV](./lessons/4-ComputerVision/06-IntroCV/README.md)             |           [Jegyzetfüzet](./lessons/4-ComputerVision/06-IntroCV/OpenCV.ipynb)         | [Gyakorlat](./lessons/4-ComputerVision/06-IntroCV/lab/README.md) |
| 07  |            [Konvolúciós neurális hálók](./lessons/4-ComputerVision/07-ConvNets/README.md) &  [CNN architektúrák](./lessons/4-ComputerVision/07-ConvNets/CNN_Architectures.md)             |           [PyTorch](./lessons/4-ComputerVision/07-ConvNets/ConvNetsPyTorch.ipynb) /[TensorFlow](./lessons/4-ComputerVision/07-ConvNets/ConvNetsTF.ipynb)             | [Gyakorlat](./lessons/4-ComputerVision/07-ConvNets/lab/README.md) |
| 08  |            [Előre betanított hálók és transzfer tanulás](./lessons/4-ComputerVision/08-TransferLearning/README.md) és [Tanítási trükkök](./lessons/4-ComputerVision/08-TransferLearning/TrainingTricks.md)             |           [PyTorch](./lessons/4-ComputerVision/08-TransferLearning/TransferLearningPyTorch.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Gyakorlat](./lessons/4-ComputerVision/08-TransferLearning/lab/README.md) |
...
| 11  |            [Objektumfelismerés](./lessons/4-ComputerVision/11-ObjectDetection/README.md)             |         [TensorFlow](./lessons/4-ComputerVision/11-ObjectDetection/ObjectDetection.ipynb)             | [Gyakorlat](./lessons/4-ComputerVision/11-ObjectDetection/lab/README.md) |
...
| V  |            [**Természetes nyelvfeldolgozás**](./lessons/5-NLP/README.md)             | [PyTorch](https://docs.microsoft.com/learn/modules/intro-natural-language-processing-pytorch/?WT.mc_id=academic-77998-cacaste) /[TensorFlow](https://docs.microsoft.com/learn/modules/intro-natural-language-processing-TensorFlow/?WT.mc_id=academic-77998-cacaste) | [Természetes nyelvfeldolgozás felfedezése a Microsoft Azure-on](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum)|
...
| 17  |            [Generatív rekurzív hálók](./lessons/5-NLP/17-GenerativeNetworks/README.md)             |           [PyTorch](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/17-GenerativeNetworks/GenerativePyTorch.ipynb) / [TensorFlow](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/17-GenerativeNetworks/GenerativeTF.ipynb)             | [Gyakorlat](./lessons/5-NLP/17-GenerativeNetworks/lab/README.md) |
...
| 19  |            [Név entitás felismerés](./lessons/5-NLP/19-NER/README.md)             |           [TensorFlow](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/19-NER/NER-TF.ipynb)             | [Gyakorlat](./lessons/5-NLP/19-NER/lab/README.md) |
...
| 22  |            [Mély megerősítéses tanulás](./lessons/6-Other/22-DeepRL/README.md)             |           [PyTorch](./lessons/6-Other/22-DeepRL/CartPole-RL-PyTorch.ipynb) /[TensorFlow](./lessons/6-Other/22-DeepRL/CartPole-RL-TF.ipynb)             | [Gyakorlat](./lessons/6-Other/22-DeepRL/lab/README.md) |
...
* Futtatható Jupyter jegyzetfüzetek, amelyek gyakran keretrendszer-specifikusak (**PyTorch** vagy **TensorFlow**). A jegyzetfüzetek sok elméleti anyagot is tartalmaznak, így a téma megértéséhez legalább az egyik verziót (PyTorch vagy TensorFlow) érdemes átnézni.
* **Gyakorlatok**, amelyek néhány témához elérhetők, és lehetőséget adnak az anyag alkalmazására egy konkrét problémán.
...
- Létrehoztunk egy [beállítási leckét](./lessons/0-course-setup/setup.md), amely segít a fejlesztési környezet beállításában. - Oktatóknak létrehoztunk egy [tanterv beállítási leckét](./lessons/0-course-setup/for-teachers.md) is!
...
Ha termék-visszajelzésed vagy kérdéseid vannak az építés során, látogasd meg az [Azure AI Foundry fejlesztői fórumot](https://aka.ms/foundry/forum).

## Kvízek
> **Megjegyzés a kvízekről**: Minden kvíz az etc\quiz-app mappában található, vagy [Online itt](https://ff-quizzes.netlify.app/). A leckékből érhetők el, a kvíz alkalmazás helyben futtatható vagy Azure-ra telepíthető; kövesd az `quiz-app` mappában található utasításokat. Fokozatosan lokalizálásra kerülnek.
## Segítség Kérve
