...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T19:43:11+00:00",
...
- Geliştirme ortamınızı kurmanıza yardımcı olmak için bir [kurulum dersi](./lessons/0-course-setup/setup.md) oluşturduk. - Eğitmenler için ayrıca bir [müfredat kurulum dersi](./lessons/0-course-setup/for-teachers.md) de hazırladık!
...
> **Quizler hakkında bir not**: Tüm quizler, etc\quiz-app klasöründeki Quiz-app klasöründe veya [Çevrimiçi Burada](https://ff-quizzes.netlify.app/) yer almaktadır. Derslerin içinden bağlantılıdır ve quiz uygulaması yerel olarak çalıştırılabilir veya Azure'a dağıtılabilir; `quiz-app` klasöründeki talimatları izleyin. Quizler kademeli olarak yerelleştirilmektedir.
...
Eğer takılırsanız veya yapay zeka uygulamaları oluşturma hakkında sorularınız olursa, diğer öğrenciler ve deneyimli geliştiricilerle MCP hakkında tartışmalara katılın. Soruların memnuniyetle karşılandığı ve bilginin özgürce paylaşıldığı destekleyici bir topluluk.
