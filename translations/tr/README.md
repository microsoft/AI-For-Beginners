...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T17:22:01+00:00",
...
|:---:|
| Yeni Başlayanlar için Yapay Zeka - _Sketchnote [@girlie_mac](https://twitter.com/girlie_mac) tarafından_ |

12 haftalık, 24 derslik müfredatımızla **Yapay Zeka** (AI) dünyasını keşfedin! Pratik dersler, quizler ve laboratuvarlar içerir. Müfredat yeni başlayanlar için uygundur ve TensorFlow ile PyTorch gibi araçların yanı sıra yapay zekada etik konularını da kapsar.
...
* Yapay Zekaya farklı yaklaşımlar, "iyi eski" sembolik yaklaşım dahil olmak üzere **Bilgi Temsili** ve akıl yürütme ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).
* Modern yapay zekanın temelinde yer alan **Sinir Ağları** ve **Derin Öğrenme**. Bu önemli konuların arkasındaki kavramları, en popüler iki framework olan [TensorFlow](http://Tensorflow.org) ve [PyTorch](http://pytorch.org) ile kod örnekleriyle göstereceğiz.
* Görüntü ve metinle çalışmak için **Sinirsel Mimariler**. Güncel modelleri kapsayacağız ancak en son teknolojilerde biraz eksik olabilir.
* Daha az popüler AI yaklaşımları, örneğin **Genetik Algoritmalar** ve **Çoklu Ajan Sistemleri**.

Bu müfredatta yer almayanlar:
...
* **İş dünyasında AI** kullanımına dair iş vakaları. Microsoft Learn'de [İş kullanıcıları için AI'ya Giriş](https://docs.microsoft.com/learn/paths/introduction-ai-for-business-users/?WT.mc_id=academic-77998-bethanycheum) öğrenme yolunu veya [AI İş Okulu](https://www.microsoft.com/ai/ai-business-school/?WT.mc_id=academic-77998-bethanycheum) programını, [INSEAD](https://www.insead.edu/) iş birliğiyle geliştirilmiş olanı tercih edebilirsiniz.
* Klasik **Makine Öğrenimi**, bu konuda [Yeni Başlayanlar için Makine Öğrenimi Müfredatı](http://github.com/Microsoft/ML-for-Beginners) iyi bir kaynaktır.
...
* Belirli ML **Bulut Çerçeveleri**, örneğin [Azure Machine Learning](https://azure.microsoft.com/services/machine-learning/?WT.mc_id=academic-77998-bethanycheum), [Microsoft Fabric](https://learn.microsoft.com/en-us/training/paths/get-started-fabric/?WT.mc_id=academic-77998-bethanycheum) veya [Azure Databricks](https://docs.microsoft.com/learn/paths/data-engineer-azure-databricks?WT.mc_id=academic-77998-bethanycheum). [Azure Machine Learning ile Makine Öğrenimi Çözümleri Oluşturma ve İşletme](https://docs.microsoft.com/learn/paths/build-ai-solutions-with-azure-ml-service/?WT.mc_id=academic-77998-bethanycheum) ve [Azure Databricks ile Makine Öğrenimi Çözümleri Oluşturma ve İşletme](https://docs.microsoft.com/learn/paths/build-operate-machine-learning-solutions-azure-databricks/?WT.mc_id=academic-77998-bethanycheum) öğrenme yollarını kullanabilirsiniz.
* **Konuşma AI'sı** ve **Sohbet Botları**. Ayrı bir [Konuşma AI çözümleri oluşturma](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum) öğrenme yolu vardır ve daha fazla detay için [bu blog yazısına](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) bakabilirsiniz.
...
_Bulutta AI_ konularına yumuşak bir giriş için [Azure'da yapay zekaya başlama](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) öğrenme yolunu düşünebilirsiniz.
...
| 15  |            [Dil Modelleme. Kendi gömme modellerinizi eğitme](./lessons/5-NLP/15-LanguageModeling/README.md)             |           [PyTorch](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/15-LanguageModeling/CBoW-PyTorch.ipynb) / [TensorFlow](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/15-LanguageModeling/CBoW-TF.ipynb)             | [Lab](./lessons/5-NLP/15-LanguageModeling/lab/README.md) |
...
* Ön okuma materyali
* Çoğunlukla belirli bir çerçeveye (**PyTorch** veya **TensorFlow**) özgü çalıştırılabilir Jupyter Notebook'lar. Çalıştırılabilir notebook ayrıca çok fazla teorik materyal içerir, bu yüzden konuyu anlamak için en az bir versiyonunu (PyTorch veya TensorFlow) incelemeniz gerekir.
* Bazı konular için, öğrendiğiniz materyali belirli bir probleme uygulama fırsatı sunan **Laboratuvarlar**.
...
AI konusunda tamamen yeniseniz ve hızlı, uygulamalı örnekler arıyorsanız, [**Yeni Başlayanlar için Örnekler**](./examples/README.md) sayfamıza göz atın! Bunlar şunları içerir:
...
- 💬 **Metin Duygu Analizi** - Pozitif/negatif metni analiz et
...
- Geliştirme ortamınızı kurmanıza yardımcı olmak için bir [kurulum dersi](./lessons/0-course-setup/setup.md) hazırladık. - Eğitmenler için de bir [müfredat kurulum dersi](./lessons/0-course-setup/for-teachers.md) oluşturduk!
- Kodu [VSCode veya Codepace'de nasıl çalıştıracağınız](./lessons/0-course-setup/how-to-run.md) hakkında bilgi edinin
...
Daha sonra kolayca bulabilmek için bu repoya yıldız (🌟) vermeyi unutmayın.

## Diğer Öğrenenlerle Tanışın

Bu kursu alan diğer öğrenenlerle tanışmak, iletişim kurmak ve destek almak için [resmi AI Discord sunucumuza](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) katılın.

Ürün geri bildirimi veya sorularınız varsa, geliştirme sırasında [Azure AI Foundry Geliştirici Forumu](https://aka.ms/foundry/forum) adresini ziyaret edin.

## Quizler

> **Quizler hakkında bir not**: Tüm quizler etc\quiz-app klasöründeki Quiz-app klasöründe bulunur veya [Çevrimiçi Burada](https://ff-quizzes.netlify.app/) erişilebilir. Quizler derslerin içinde bağlantılıdır, quiz uygulaması yerel olarak çalıştırılabilir veya Azure'a dağıtılabilir; `quiz-app` klasöründeki talimatları izleyin. Quizler kademeli olarak yerelleştirilmektedir.
...
* **✅ Quiz Oluşturucuları:** [Lateefah Bello](https://github.com/CinnamonXI), [MLSA](https://studentambassadors.microsoft.com/)
...
AI uygulamaları geliştirirken takılırsanız veya sorularınız olursa, MCP hakkında tartışmalara katılmak için diğer öğrenenler ve deneyimli geliştiricilerle buluşun. Burası soruların hoş karşılandığı ve bilginin özgürce paylaşıldığı destekleyici bir topluluktur.

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

Ürün geri bildirimi veya geliştirme sırasında hatalar için:
