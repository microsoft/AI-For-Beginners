...
# Yapay Zeka Başlangıç Eğitim Müfredatı
...
12 haftalık, 24 derslik müfredatımızla **Yapay Zeka** (AI) dünyasını keşfedin! Pratik dersler, sınavlar ve laboratuvarlar içerir. Müfredat başlangıç seviyesine uygundur ve TensorFlow ve PyTorch gibi araçların yanı sıra yapay zekada etik konularını da kapsar.
...
>
> Bu depo, indirme boyutunu önemli ölçüde artıran 50'den fazla dil çevirisini içerir. Çevirileri olmadan kopyalamak için, seyrek kontrolü kullanın:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> Bu, kursu tamamlamak için ihtiyacınız olan her şeyi çok daha hızlı indirme ile sunar.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

**Ek dil çevirilerinin desteklenmesini istiyorsanız, desteklenen diller listesi [burada](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md) bulunmaktadır**
...
**[Dersin Akış Haritası](http://soshnikov.com/courses/ai-for-beginners/mindmap.html)**

Bu müfredatta öğrenecekleriniz:

* **Bilgi Temsili** ve akıl yürütmeyle birlikte, "eski iyi" sembolik yaklaşımlar dahil olmak üzere Yapay Zeka'ya farklı yaklaşımlar ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence)).
* Modern yapay zekanın temelinde yer alan **Sinir Ağları** ve **Derin Öğrenme**. Bu önemli konuların arkasındaki kavramları, iki popüler framework olan [TensorFlow](http://Tensorflow.org) ve [PyTorch](http://pytorch.org) ile kod örnekleri üzerinden göstereceğiz.
* Görüntü ve metinle çalışmak için **Sinir Mimarileri**. Güncel modelleri kapsayacağız ancak en son teknolojilerde biraz eksik olabilir.
* Daha az yaygın AI yaklaşımları, örneğin **Genetik Algoritmalar** ve **Çoklu Ajan Sistemleri**.

Bu müfredatta kapsam dışı bırakılanlar:

> [Bu kursa ait tüm ek kaynakları Microsoft Learn koleksiyonumuzda bulun](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum)

* **İş Dünyasında AI** uygulamalarının iş örnekleri. Microsoft Learn'de bulunan [İş kullanıcıları için AI’ya giriş](https://docs.microsoft.com/learn/paths/introduction-ai-for-business-users/?WT.mc_id=academic-77998-bethanycheum) veya [AI İş Okulu](https://www.microsoft.com/ai/ai-business-school/?WT.mc_id=academic-77998-bethanycheum) eğitim yollarını öneririz; bu okullar [INSEAD](https://www.insead.edu/) ile işbirliğiyle geliştirilmiştir.
* Klasik **Makine Öğrenmesi**, bu konuda detaylı açıklamalar [Makine Öğrenmesine Giriş Müfredatımızda](http://github.com/Microsoft/ML-for-Beginners) yer almaktadır.
* **[Cognitive Services](https://azure.microsoft.com/services/cognitive-services/?WT.mc_id=academic-77998-bethanycheum)** kullanılarak yapılan pratik AI uygulamaları. Bunun için Microsoft Learn'de bulunan [görüntü](https://docs.microsoft.com/learn/paths/create-computer-vision-solutions-azure-cognitive-services/?WT.mc_id=academic-77998-bethanycheum), [doğal dil işleme](https://docs.microsoft.com/learn/paths/explore-natural-language-processing/?WT.mc_id=academic-77998-bethanycheum) ve **[Azure OpenAI Hizmeti ile Üretken AI](https://learn.microsoft.com/en-us/training/paths/develop-ai-solutions-azure-openai/?WT.mc_id=academic-77998-bethanycheum)** modülleriyle başlamanızı öneririz.
* Belirli ML **Bulut Çerçeveleri**, örneğin [Azure Machine Learning](https://azure.microsoft.com/services/machine-learning/?WT.mc_id=academic-77998-bethanycheum), [Microsoft Fabric](https://learn.microsoft.com/en-us/training/paths/get-started-fabric/?WT.mc_id=academic-77998-bethanycheum) veya [Azure Databricks](https://docs.microsoft.com/learn/paths/data-engineer-azure-databricks?WT.mc_id=academic-77998-bethanycheum). Önerilen eğitim yolları arasında [Azure Machine Learning ile makine öğrenimi çözümleri oluşturma ve işletme](https://docs.microsoft.com/learn/paths/build-ai-solutions-with-azure-ml-service/?WT.mc_id=academic-77998-bethanycheum) ve [Azure Databricks ile makine öğrenim çözümleri oluşturma ve işletme](https://docs.microsoft.com/learn/paths/build-operate-machine-learning-solutions-azure-databricks/?WT.mc_id=academic-77998-bethanycheum) bulunmaktadır.
* **Konuşma AI** ve **Sohbet Botları**. Bunun için ayrı bir [Konuşma AI çözümleri oluşturma](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum) eğitim yolu vardır; ayrıca detay için [bu blog yazısını](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) inceleyebilirsiniz.
* Derin öğrenmenin arkasındaki **Derin Matematik**. Bu konuda, çevrimiçi olarak da bulunan Ian Goodfellow, Yoshua Bengio ve Aaron Courville'un yazdığı [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) kitabını tavsiye ederiz: [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).

_Cloud_ üzerindeki yapay zeka konularına nazik bir giriş için [Azure'da yapay zekaya başlamak](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) öğrenim yolunu tercih edebilirsiniz.

# İçerik

|     |                                                                 Ders Bağlantısı                                                                  |                                           PyTorch/Keras/TensorFlow                                          | Laboratuvar                                                            |
| :-: | :------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: | ------------------------------------------------------------------------------ |
| 0  |                                 [Kurs Ayarları](./lessons/0-course-setup/setup.md)                                 |                      [Geliştirme Ortamınızı Kurun](./lessons/0-course-setup/how-to-run.md)                       |   |
| I  |               [**Yapay Zekaya Giriş**](./lessons/1-Intro/README.md)      | | |
| 01  |       [Yapay Zeka Tanıtımı ve Tarihi](./lessons/1-Intro/README.md)       |           -                            | -  |
| II |              **Sembolik AI**              |
...
| IV  |            [**Bilgisayarlı Görü](./lessons/4-ComputerVision/README.md)             | [PyTorch](https://docs.microsoft.com/learn/modules/intro-computer-vision-pytorch/?WT.mc_id=academic-77998-cacaste) / [TensorFlow](https://docs.microsoft.com/learn/modules/intro-computer-vision-TensorFlow/?WT.mc_id=academic-77998-cacaste)| [Microsoft Azure'da Bilgisayarlı Görüyü Keşfet](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) |
| 06  |            [Bilgisayarlı Görüye Giriş. OpenCV](./lessons/4-ComputerVision/06-IntroCV/README.md)             |           [Defter](./lessons/4-ComputerVision/06-IntroCV/OpenCV.ipynb)         | [Laboratuvar](./lessons/4-ComputerVision/06-IntroCV/lab/README.md) |
...
| 20  |            [Büyük Dil Modelleri, İstek Programlama ve Az-Veri Görevleri](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
Eğer AI’ya tamamen yeniseniz ve hızlı, uygulamalı örnekler istiyorsanız, [**Yeni Başlayanlar için Örnekler**](./examples/README.md) sayfasına göz atın! Bunlar şunları içerir:

- 🌟 **Merhaba AI Dünyası** - İlk AI programınız (örüntü tanıma)  
- 🧠 **Basit Sinir Ağı** - Baştan bir sinir ağı oluşturun  
- 🖼️ **Görüntü Sınıflandırıcı** - Ayrıntılı yorumlarla görüntü sınıflandırma  
- 💬 **Metin Duygu Analizi** - Pozitif/negatif metin analiz edin

Bu örnekler, tam müfredata girmeden önce AI kavramlarını anlamanıza yardımcı olmak için tasarlanmıştır.
...
- Eğitmenler için de bir [müfredat kurulum dersi](./lessons/0-course-setup/for-teachers.md) hazırladık!
...
Bu depoyu daha sonra daha kolay bulabilmek için yıldız (🌟) vermeyi unutmayın.
...
Oluşturma sırasında ürün geri bildirimi veya sorularınız varsa [Azure AI Foundry Developer Forum’u](https://aka.ms/foundry/forum) ziyaret edin.

## Quizler 

> **Quizler hakkında bir not**: Tüm quizler, etc\quiz-app içindeki Quiz-app klasöründe bulunur veya [Çevrimiçi Burada](https://ff-quizzes.netlify.app/) erişilebilir. Derslerin içinde linklenmiştir. Quiz uygulaması yerel olarak çalıştırılabilir veya Azure’a dağıtılabilir; `quiz-app` klasöründeki talimatları izleyin. Quizler yavaş yavaş yerelleştirilmektedir.

## Yardım İstiyoruz

Önerileriniz var mı veya yazım ya da kod hataları mı buldunuz? Bir sorun açın veya pull request oluşturun.
...
AI uygulamaları oluştururken takılırsanız veya sorularınız olursa, MCP hakkında tartışmalara katılmak için diğer öğrenenler ve deneyimli geliştiricilerle buluşun. Burası soruların hoş karşılandığı ve bilginin özgürce paylaşıldığı destekleyici bir topluluktur.

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/nTYy5BXMWG)

Ürün geri bildirimi ya da oluşan hatalar için:
