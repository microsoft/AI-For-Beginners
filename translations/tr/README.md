...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:25:25+00:00",
...
|![@girlie_mac tarafından yapılmış Sketchnote https://twitter.com/girlie_mac](../../translated_images/ai-overview.0857791951d19500d0ef8b803d77110c738dcafc52306e6d68724742cd4af167.tr.png)|  
|:---:|  
| Yeni Başlayanlar için Yapay Zeka - _[@girlie_mac](https://twitter.com/girlie_mac) tarafından yapılmış Sketchnote_ |  
...
* Modern yapay zekanın temelini oluşturan **Sinir Ağları** ve **Derin Öğrenme**. Bu önemli konuların arkasındaki kavramları, en popüler iki çerçeve olan [TensorFlow](http://Tensorflow.org) ve [PyTorch](http://pytorch.org) ile kod kullanarak açıklayacağız.  
...
* **İş Dünyasında Yapay Zeka** kullanımına dair iş vakaları. Microsoft Learn'de [İş kullanıcıları için yapay zekaya giriş](https://docs.microsoft.com/learn/paths/introduction-ai-for-business-users/?WT.mc_id=academic-77998-bethanycheum) öğrenme yolunu veya [AI Business School](https://www.microsoft.com/ai/ai-business-school/?WT.mc_id=academic-77998-bethanycheum)'u inceleyebilirsiniz.  
...
Bulut konularında _Yapay Zeka_'ya nazik bir giriş yapmak için [Azure'da yapay zeka ile tanışın](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) öğrenme yolunu inceleyebilirsiniz.  
...
| 04  |                   [Çok Katmanlı Perceptron ve Kendi Çerçevemizi Oluşturmak](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [Notebook](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [Lab](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |
| 05  |            [Çerçevelere Giriş (PyTorch/TensorFlow) ve Aşırı Uyum](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [Lab](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
| IV  |            [**Bilgisayarla Görü**](./lessons/4-ComputerVision/README.md)             | [PyTorch](https://docs.microsoft.com/learn/modules/intro-computer-vision-pytorch/?WT.mc_id=academic-77998-cacaste) / [TensorFlow](https://docs.microsoft.com/learn/modules/intro-computer-vision-TensorFlow/?WT.mc_id=academic-77998-cacaste)| [Microsoft Azure'da Bilgisayarla Görü Keşfet](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) |
...
* Ön okuma materyali
* Çalıştırılabilir Jupyter Notebooks, genellikle çerçeveye özgü (**PyTorch** veya **TensorFlow**). Çalıştırılabilir notebook ayrıca çok fazla teorik materyal içerir, bu yüzden konuyu anlamak için notebook'un en az bir versiyonunu (PyTorch veya TensorFlow) incelemeniz gerekir.
* **Lab'ler** bazı konular için mevcuttur ve öğrendiğiniz materyali belirli bir probleme uygulama fırsatı sunar.
...
AI'ye tamamen yeniyseniz ve hızlı, uygulamalı örnekler arıyorsanız, [**Yeni Başlayanlar İçin Örnekler**](./examples/README.md) bölümüne göz atın! Bunlar şunları içerir:

- 🌟 **Merhaba AI Dünyası** - İlk AI programınız (desen tanıma)
- 🧠 **Basit Sinir Ağı** - Sıfırdan bir sinir ağı oluşturun  
- 🖼️ **Görüntü Sınıflandırıcı** - Görüntüleri detaylı açıklamalarla sınıflandırın
- 💬 **Metin Duygusu** - Olumlu/olumsuz metinleri analiz edin
...
- [Kodunuzu VSCode veya Codepace'te nasıl çalıştıracağınızı](./lessons/0-course-setup/how-to-run.md) öğrenin.
...
Ürünle ilgili geri bildirimleriniz veya sorularınız varsa, [Azure AI Foundry Geliştirici Forumu'nu](https://aka.ms/foundry/forum) ziyaret edin.

## Quizler 

> **Quizler hakkında bir not**: Tüm quizler, etc\quiz-app klasöründeki Quiz-app klasöründe veya [çevrimiçi burada](https://ff-quizzes.netlify.app/) bulunur. Derslerin içinden bağlantılıdır ve quiz uygulaması yerel olarak çalıştırılabilir veya Azure'a dağıtılabilir; `quiz-app` klasöründeki talimatları izleyin. Quizler kademeli olarak yerelleştirilmektedir.

## Yardım İstiyoruz

Önerileriniz var mı veya yazım ya da kod hataları mı buldunuz? Bir sorun bildirin veya bir pull request oluşturun.
...
* **✅ Quiz Yaratıcısı:** [Lateefah Bello](https://github.com/CinnamonXI), [MLSA](https://studentambassadors.microsoft.com/)
...
Eğer takılırsanız veya yapay zeka uygulamaları oluşturma hakkında sorularınız varsa, diğer öğrenciler ve deneyimli geliştiricilerle MCP hakkında tartışmalara katılın. Soruların memnuniyetle karşılandığı ve bilginin özgürce paylaşıldığı destekleyici bir topluluk.
