...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-19T11:58:52+00:00",
...
|![Sketchnote by @girlie_mac https://twitter.com/girlie_mac](../../translated_images/ai-overview.0857791951d19500d0ef8b803d77110c738dcafc52306e6d68724742cd4af167.cs.png)|
|:---:|
...
**Pokud si přejete mít podporu dalších jazyků, jsou podporované jazyky uvedeny [zde](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
* **Neuronové sítě** a **hluboké učení**, které jsou jádrem moderní AI. Koncepty těchto důležitých témat si ukážeme pomocí kódu ve dvou nejpopulárnějších frameworcích - [TensorFlow](http://Tensorflow.org) a [PyTorch](http://pytorch.org).
...
* **Konverzační AI** a **chatboti**. Existuje samostatná učební cesta [Vytváření konverzačních AI řešení](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum), a také můžete odkazovat na [tento blogový příspěvek](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) pro více detailů.
...
> **Poznámka ke kvízům**: Všechny kvízy jsou umístěny ve složce Quiz-app v etc\quiz-app, nebo [online zde](https://ff-quizzes.netlify.app/). Jsou propojeny z lekcí, aplikaci kvízů lze spustit lokálně nebo nasadit do Azure; postupujte podle pokynů ve složce `quiz-app`. Postupně jsou lokalizovány.
