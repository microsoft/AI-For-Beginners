...
* **신경망 (Neural Networks)** 과 **딥러닝(Deep Learning)** 은 현대 인공 지능에서 핵심입니다. We will illustrate the concepts behind these important topics using code in two of the most popular frameworks - [TensorFlow](http://Tensorflow.org) and [PyTorch](http://pytorch.org).
