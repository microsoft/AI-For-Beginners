...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-25T17:12:27+00:00",
...
* **Reti Neurali** e **Deep Learning**, che sono al centro dell'AI moderna. Illustreremo i concetti dietro questi argomenti importanti usando codice in due dei framework più popolari - [TensorFlow](http://Tensorflow.org) e [PyTorch](http://pytorch.org).
...
Per un'introduzione dolce ai temi di _AI nel Cloud_ potresti considerare il percorso di apprendimento [Inizia con l'intelligenza artificiale su Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum).
...
| 20  |            [Modelli Linguistici di Grandi Dimensioni, Programmazione di Prompt e Task Few-Shot](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
* **Lab** disponibili per alcuni argomenti, che offrono l'opportunità di applicare quanto appreso a un problema specifico.
...
### 🎯 Sei nuovo nell'AI? Inizia da qui!

Se sei completamente nuovo nell'AI e vuoi esempi pratici e veloci, dai un'occhiata ai nostri [**Esempi per Principianti**](./examples/README.md)! Questi includono:
...
Questi esempi sono pensati per aiutarti a comprendere i concetti di AI prima di immergerti nel curriculum completo.

### 📚 Configurazione del Curriculum Completo

- Abbiamo creato una [lezione di configurazione](./lessons/0-course-setup/setup.md) per aiutarti a impostare il tuo ambiente di sviluppo. - Per gli educatori, abbiamo creato anche una [lezione di configurazione del curriculum](./lessons/0-course-setup/for-teachers.md)!
...
Unisciti al nostro [server Discord ufficiale AI](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) per incontrare e fare rete con altri studenti che seguono questo corso e ricevere supporto.
...
> **Una nota sui quiz**: Tutti i quiz si trovano nella cartella Quiz-app in etc\quiz-app, o [Online Qui](https://ff-quizzes.netlify.app/) Sono collegati all'interno delle lezioni; l'app quiz può essere eseguita localmente o distribuita su Azure; segui le istruzioni nella cartella `quiz-app`. Stanno gradualmente venendo localizzati.
