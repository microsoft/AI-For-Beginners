...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-12T19:20:10+00:00",
...
|![由 @girlie_mac 繪製的手繪筆記 https://twitter.com/girlie_mac](../../translated_images/ai-overview.0857791951d19500d0ef8b803d77110c738dcafc52306e6d68724742cd4af167.hk.png)|  
|:---:|  
| 人工智能入門 - _手繪筆記由 [@girlie_mac](https://twitter.com/girlie_mac)_ |  

探索 **人工智能** (AI) 的世界，透過我們為期 12 週、共 24 節課的課程！課程包括實用的教學、測驗和實驗室練習。這是一個適合初學者的課程，涵蓋了像 TensorFlow 和 PyTorch 這些工具，以及 AI 的倫理議題。  
...
* 不同的人工智能方法，包括「經典」的符號方法，使用 **知識表示** 和推理 ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence))。  
* **神經網絡** 和 **深度學習**，這是現代 AI 的核心。我們將使用兩個最受歡迎的框架 [TensorFlow](http://Tensorflow.org) 和 [PyTorch](http://pytorch.org) 的程式碼來說明這些重要主題的概念。  
* 用於處理圖像和文本的 **神經架構**。我們會涵蓋一些近期的模型，但可能不包括最前沿的技術。  
...
* **AI 在商業中的應用案例**。建議參加 [Introduction to AI for business users](https://docs.microsoft.com/learn/paths/introduction-ai-for-business-users/?WT.mc_id=academic-77998-bethanycheum) 或 [AI Business School](https://www.microsoft.com/ai/ai-business-school/?WT.mc_id=academic-77998-bethanycheum)，這是與 [INSEAD](https://www.insead.edu/) 合作開發的學習路徑。  
...
* **對話式 AI** 和 **聊天機器人**。有一個單獨的 [Create conversational AI solutions](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum) 學習路徑，你也可以參考 [這篇部落格文章](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) 獲取更多細節。  
* **深度學習的數學基礎**。建議參考 Ian Goodfellow、Yoshua Bengio 和 Aaron Courville 所著的 [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618)，也可以在線上閱讀 [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/)。  
...
* 預讀材料
* 可執行的 Jupyter 筆記本，通常針對框架 (**PyTorch** 或 **TensorFlow**) 而設計。可執行的筆記本也包含大量理論材料，因此要理解主題，至少需要閱讀一個版本的筆記本（PyTorch 或 TensorFlow）。
...
如果你對 AI 完全陌生並希望快速上手，請查看我們的 [**初學者友好示例**](./examples/README.md)! 包括：
...
- 我們已經製作了一個[設置課程](./lessons/0-course-setup/setup.md)，幫助你設置開發環境。- 對於教育工作者，我們也準備了一個[課程設置教學](./lessons/0-course-setup/for-teachers.md)！
...
加入我們的[官方 AI Discord 伺服器](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum)，與其他學習者交流和建立聯繫，並獲得支持。
