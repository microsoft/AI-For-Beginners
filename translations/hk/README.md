...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T14:03:46+00:00",
...
|:---:|  
| 人工智能入門 - _由 [@girlie_mac](https://twitter.com/girlie_mac) 繪製的速寫筆記_ |  

探索 **人工智能** (AI) 的世界，透過我們的 12 週、24 節課的課程！課程包括實用的教學、測驗和實驗室練習。這是一個適合初學者的課程，涵蓋了 TensorFlow 和 PyTorch 等工具，以及人工智能的倫理問題。  
...
* 不同的人工智能方法，包括「經典」的符號方法，透過 **知識表示** 和推理 ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence))。  
* **神經網絡** 和 **深度學習**，這些是現代人工智能的核心。我們會使用兩個最流行的框架 - [TensorFlow](http://Tensorflow.org) 和 [PyTorch](http://pytorch.org) 的程式碼來解釋這些重要主題的概念。  
* **神經架構** 用於處理影像和文字。我們會涵蓋最近的模型，但可能不包括最新的技術。  
...
* **對話式人工智能** 和 **聊天機器人**。有一個單獨的 [建立對話式人工智能解決方案](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum) 學習路徑，你也可以參考 [這篇博客文章](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) 了解更多細節。  
* **深度學習的數學基礎**。建議參考 Ian Goodfellow、Yoshua Bengio 和 Aaron Courville 的 [深度學習](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618)，也可以在線上閱讀 [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/)。  

如果你想要輕鬆入門 _雲端人工智能_ 主題，可以考慮參加 [在 Azure 上開始人工智能](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum) 學習路徑。  

# 課程內容  

|     |                                                                 課程連結                                                                  |                                           PyTorch/Keras/TensorFlow                                          | 實驗室                                                            |  
| :-: | :------------------------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------: | ------------------------------------------------------------------------------ |  
| 0  |                                 [課程設置](./lessons/0-course-setup/setup.md)                                 |                      [設置你的開發環境](./lessons/0-course-setup/how-to-run.md)                       |   |  
...
* **實驗室**，適用於某些主題，讓您有機會將所學的材料應用於特定問題。
* 某些部分包含指向 [**MS Learn**](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) 模組的連結，涵蓋相關主題。

## 開始學習

### 🎯 AI 新手？從這裡開始！

如果您對 AI 完全陌生，並希望快速上手，請查看我們的 [**初學者友好範例**](./examples/README.md)！包括：
...
這些例子旨在幫助你在深入學習完整課程之前，先了解 AI 的概念。

### 📚 完整課程設置

- 我們已經製作了一個[設置課程](./lessons/0-course-setup/setup.md)，幫助你設置開發環境。 - 對於教育工作者，我們也準備了一個[課程設置課程](./lessons/0-course-setup/for-teachers.md)！
- 如何[在 VSCode 或 Codepace 中運行代碼](./lessons/0-course-setup/how-to-run.md)

請按照以下步驟操作：

分叉此倉庫：點擊本頁右上角的 "Fork" 按鈕。
...
> **關於測驗的說明**：所有測驗都包含在 etc\quiz-app 的 Quiz-app 文件夾中，或者可以[在線訪問](https://ff-quizzes.netlify.app/)。它們在課程中有鏈接，測驗應用可以在本地運行或部署到 Azure，請按照 `quiz-app` 文件夾中的指示操作。測驗正在逐步本地化。

## 尋求幫助

你有建議或發現拼寫或代碼錯誤嗎？請提交問題或創建拉取請求。
...
如果你遇到困難或對構建 AI 應用有任何疑問，請加入學習者和經驗豐富的開發者的討論，這是一個支持性的社區，歡迎提問並自由分享知識。
