...
![展示五個序列詞嵌入分類器的圖片。](../../../../../translated_images/embedding-classifier-example.b77f021a7ee67eee.hk.png)
...
![展示 CBoW 和 Skip-Gram 將詞轉換為向量的算法圖片。](../../../../../translated_images/example-algorithms-for-converting-words-to-vectors.fbe9207a726922f6.hk.png)
