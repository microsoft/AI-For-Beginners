...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T08:16:18+00:00",
...
* วิธีการต่าง ๆ ในการสร้างปัญญาประดิษฐ์ รวมถึงวิธีการเชิงสัญลักษณ์แบบ "ดั้งเดิม" ด้วย **การแทนความรู้** และการให้เหตุผล ([GOFAI](https://en.wikipedia.org/wiki/Symbolic_artificial_intelligence))  
...
สำหรับการแนะนำเบื้องต้นเกี่ยวกับหัวข้อ _AI ในคลาวด์_ คุณสามารถลองเรียนรู้เส้นทาง [Get started with artificial intelligence on Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum)  
...
| 13  |            [การแทนข้อความด้วย Bow/TF-IDF](./lessons/5-NLP/13-TextRep/README.md)             |           [PyTorch](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/13-TextRep/TextRepresentationPyTorch.ipynb) / [TensorFlow](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/13-TextRep/TextRepresentationTF.ipynb)             | |
...
* เนื้อหาอ่านล่วงหน้า
* Jupyter Notebooks ที่สามารถรันได้ ซึ่งมักจะเฉพาะเจาะจงกับ Framework (**PyTorch** หรือ **TensorFlow**) Notebook ที่สามารถรันได้ยังมีเนื้อหาทฤษฎีมากมาย ดังนั้นเพื่อให้เข้าใจหัวข้อ คุณจำเป็นต้องผ่าน Notebook อย่างน้อยหนึ่งเวอร์ชัน (PyTorch หรือ TensorFlow)
* **Labs** สำหรับบางหัวข้อ ซึ่งเปิดโอกาสให้คุณลองนำสิ่งที่เรียนรู้ไปใช้แก้ปัญหาเฉพาะ
...
- เราได้สร้าง [บทเรียนการตั้งค่า](./lessons/0-course-setup/setup.md) เพื่อช่วยคุณตั้งค่าสภาพแวดล้อมการพัฒนา - สำหรับผู้สอน เราได้สร้าง [บทเรียนการตั้งค่าสำหรับหลักสูตร](./lessons/0-course-setup/for-teachers.md) ให้คุณด้วย!
...
เข้าร่วม [เซิร์ฟเวอร์ Discord AI อย่างเป็นทางการ](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) เพื่อพบปะและสร้างเครือข่ายกับผู้เรียนคนอื่นๆ ที่กำลังเรียนคอร์สนี้ และรับการสนับสนุน
...
## แบบทดสอบ
> **หมายเหตุเกี่ยวกับแบบทดสอบ**: แบบทดสอบทั้งหมดอยู่ในโฟลเดอร์ Quiz-app ที่ etc\quiz-app หรือ [ออนไลน์ที่นี่](https://ff-quizzes.netlify.app/) แบบทดสอบเหล่านี้ถูกเชื่อมโยงจากบทเรียนต่าง ๆ โดยแอปแบบทดสอบสามารถรันได้ทั้งในเครื่องหรือปรับใช้บน Azure; ทำตามคำแนะนำในโฟลเดอร์ `quiz-app` แบบทดสอบกำลังถูกแปลเป็นภาษาท้องถิ่นอย่างต่อเนื่อง
...
* **🙏 ผู้สนับสนุนหลัก:** [Evgenii Pishchik](https://github.com/Pe4enIks)
