...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-07T13:50:27+00:00",
...
> [Βρείτε όλους τους πρόσθετους πόρους για αυτό το μάθημα στη συλλογή μας στο Microsoft Learn](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum)  
...
| 06  |            [Εισαγωγή στην Όραση Υπολογιστών. OpenCV](./lessons/4-ComputerVision/06-IntroCV/README.md)             |           [Σημειωματάριο](./lessons/4-ComputerVision/06-IntroCV/OpenCV.ipynb)         | [Εργαστήριο](./lessons/4-ComputerVision/06-IntroCV/lab/README.md) |
...
| 15  |            [Μοντελοποίηση Γλώσσας. Εκπαίδευση δικών σας Ενσωματώσεων](./lessons/5-NLP/15-LanguageModeling/README.md)             |           [PyTorch](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/15-LanguageModeling/CBoW-PyTorch.ipynb) / [TensorFlow](https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/5-NLP/15-LanguageModeling/CBoW-TF.ipynb)             | [Εργαστήριο](./lessons/5-NLP/15-LanguageModeling/lab/README.md) |
...
| 20  |            [Μεγάλα Μοντέλα Γλώσσας, Προγραμματισμός Προτροπών και Εργασίες Λίγων Παραδειγμάτων](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
| IX  |            **Επιπλέον** | | |
| 25  |            [Δίκτυα Πολλαπλών Τρόπων, CLIP και VQGAN](./lessons/X-Extras/X1-MultiModal/README.md)             |           [Σημειωματάριο](./lessons/X-Extras/X1-MultiModal/Clip.ipynb)    | |
...
* Ορισμένες ενότητες περιέχουν συνδέσμους σε [**MS Learn**](https://learn.microsoft.com/en-us/collections/7w28iy2xrqzdj0?WT.mc_id=academic-77998-bethanycheum) modules που καλύπτουν συναφή θέματα.
...
Μην ξεχάσετε να βάλετε αστέρι (🌟) σε αυτό το repo για να το βρείτε πιο εύκολα αργότερα.
...
* **🔥 Συντάκτρια:** [Jen Looper](https://twitter.com/jenlooper), PhD  
...
- [Web Development για Αρχάριους](https://aka.ms/webdev-beginners)  
...
- [Mastering GitHub Copilot για Agentic χρήση](https://github.com/microsoft/Mastering-GitHub-Copilot-for-Paired-Programming)  
