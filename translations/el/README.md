...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:31:11+00:00",
...
[![Παρακολουθήσεις GitHub](https://img.shields.io/github/watchers/microsoft/AI-For-Beginners.svg?style=social&label=Watch)](https://GitHub.com/microsoft/AI-For-Beginners/watchers/)  
[![Διακλαδώσεις GitHub](https://img.shields.io/github/forks/microsoft/AI-For-Beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/AI-For-Beginners/network/)  
...
Εξερευνήστε τον κόσμο της **Τεχνητής Νοημοσύνης** (AI) με το 12-εβδομάδων, 24-μαθημάτων πρόγραμμα σπουδών μας! Περιλαμβάνει πρακτικά μαθήματα, κουίζ και εργαστήρια. Το πρόγραμμα είναι φιλικό για αρχάριους και καλύπτει εργαλεία όπως το TensorFlow και το PyTorch, καθώς και θέματα ηθικής στην AI.  
...
Για μια ήπια εισαγωγή στα θέματα _AI στο Cloud_, μπορείτε να παρακολουθήσετε το [Get started with artificial intelligence on Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum).  
...
| 04  |                   [Πολυεπίπεδος Αντιληπτήρας και Δημιουργία του Δικού μας Πλαισίου](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [Notebook](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [Εργαστήριο](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |
...
- 🌟 **Γεια σου Κόσμε της Τεχνητής Νοημοσύνης** - Το πρώτο σας πρόγραμμα ΤΝ (αναγνώριση μοτίβων)
...
Κλωνοποίηση του Αποθετηρίου: Πατήστε το κουμπί "Fork" στην πάνω δεξιά γωνία αυτής της σελίδας.
...
Γίνετε μέλος του [επίσημου Discord server για AI](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) για να γνωρίσετε και να δικτυωθείτε με άλλους μαθητές που παρακολουθούν αυτό το μάθημα και να λάβετε υποστήριξη.
...
* **🙏 Βασικοί Συνεργάτες:** [Evgenii Pishchik](https://github.com/Pe4enIks)
...
Αν κολλήσετε ή έχετε ερωτήσεις σχετικά με την ανάπτυξη εφαρμογών AI, γίνετε μέλος της κοινότητας μαθητών και έμπειρων προγραμματιστών για συζητήσεις σχετικά με MCP. Είναι μια υποστηρικτική κοινότητα όπου οι ερωτήσεις είναι ευπρόσδεκτες και η γνώση μοιράζεται ελεύθερα.
