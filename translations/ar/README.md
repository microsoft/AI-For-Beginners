...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-17T13:45:14+00:00",
...
|![رسم توضيحي من @girlie_mac https://twitter.com/girlie_mac](../../translated_images/ai-overview.0857791951d19500d0ef8b803d77110c738dcafc52306e6d68724742cd4af167.ar.png)|  
|:---:|  
| الذكاء الاصطناعي للمبتدئين - _رسم توضيحي من [@girlie_mac](https://twitter.com/girlie_mac)_ |  

استكشف عالم **الذكاء الاصطناعي** (AI) من خلال منهج دراسي يمتد على مدار 12 أسبوعًا و24 درسًا! يتضمن دروسًا عملية، اختبارات، ومعامل. المنهج مناسب للمبتدئين ويغطي أدوات مثل TensorFlow وPyTorch، بالإضافة إلى أخلاقيات الذكاء الاصطناعي.  
...
* **الذكاء الاصطناعي الحواري** و**روبوتات الدردشة**. هناك مسار تعليمي منفصل [إنشاء حلول الذكاء الاصطناعي الحواري](https://docs.microsoft.com/learn/paths/create-conversational-ai-solutions/?WT.mc_id=academic-77998-bethanycheum)، ويمكنك أيضًا الرجوع إلى [هذا المنشور](https://soshnikov.com/azure/hello-bot-conversational-ai-on-microsoft-platform/) لمزيد من التفاصيل.  
* **الرياضيات العميقة** وراء التعلم العميق. لهذا، نوصي بكتاب [Deep Learning](https://www.amazon.com/Deep-Learning-Adaptive-Computation-Machine/dp/0262035618) من تأليف إيان جودفيلو، يوشوا بنجيو وآرون كورفيل، والمتوفر أيضًا عبر الإنترنت على [https://www.deeplearningbook.org/](https://www.deeplearningbook.org/).  

للحصول على مقدمة لطيفة حول موضوعات _الذكاء الاصطناعي في السحابة_، يمكنك أخذ مسار التعلم [ابدأ مع الذكاء الاصطناعي على Azure](https://docs.microsoft.com/learn/paths/get-started-with-artificial-intelligence-on-azure/?WT.mc_id=academic-77998-bethanycheum).  
...
| 04  |                   [بيرسيبترون متعدد الطبقات وإنشاء إطار عمل خاص بنا](./lessons/3-NeuralNetworks/04-OwnFramework/README.md)                   |        [دفتر ملاحظات](./lessons/3-NeuralNetworks/04-OwnFramework/OwnFramework.ipynb)        | [مختبر](./lessons/3-NeuralNetworks/04-OwnFramework/lab/README.md) |
| 05  |            [مقدمة إلى الأطر (PyTorch/TensorFlow) والإفراط في التكيّف](./lessons/3-NeuralNetworks/05-Frameworks/README.md)             |           [PyTorch](./lessons/3-NeuralNetworks/05-Frameworks/IntroPyTorch.ipynb) / [Keras](./lessons/3-NeuralNetworks/05-Frameworks/IntroKeras.ipynb) / [TensorFlow](./lessons/3-NeuralNetworks/05-Frameworks/IntroKerasTF.ipynb)             | [مختبر](./lessons/3-NeuralNetworks/05-Frameworks/lab/README.md) |
...
| 20  |            [نماذج اللغة الكبيرة، برمجة المطالبات والمهام قليلة الأمثلة](./lessons/5-NLP/20-LangModels/README.md)             |           [PyTorch](https://microsoft.github.io/AI-For-Beginners/lessons/5-NLP/20-LangModels/GPT-PyTorch.ipynb) | |
...
* دفاتر ملاحظات Jupyter القابلة للتنفيذ، والتي غالبًا ما تكون مخصصة للإطار (**PyTorch** أو **TensorFlow**). يحتوي دفتر الملاحظات القابل للتنفيذ أيضًا على الكثير من المواد النظرية، لذا لفهم الموضوع، تحتاج إلى مراجعة نسخة واحدة على الأقل من دفتر الملاحظات (إما PyTorch أو TensorFlow).
...
إذا كنت جديدًا تمامًا في الذكاء الاصطناعي وترغب في أمثلة عملية وسريعة، تحقق من [**الأمثلة المناسبة للمبتدئين**](./examples/README.md)! تتضمن هذه:

- 🌟 **مرحبًا بعالم الذكاء الاصطناعي** - برنامجك الأول في الذكاء الاصطناعي (التعرف على الأنماط)
...
- قمنا بإنشاء [درس إعداد](./lessons/0-course-setup/setup.md) لمساعدتك في إعداد بيئة التطوير الخاصة بك. - وللمعلمين، قمنا بإنشاء [درس إعداد المناهج](./lessons/0-course-setup/for-teachers.md) خصيصًا لكم!
...
انضم إلى [خادم Discord الرسمي للذكاء الاصطناعي](https://aka.ms/genai-discord?WT.mc_id=academic-105485-bethanycheum) للتواصل مع متعلمين آخرين يأخذون هذا المساق واحصل على الدعم.

إذا كان لديك ملاحظات على المنتج أو أسئلة أثناء البناء، قم بزيارة [منتدى مطوري Azure AI Foundry](https://aka.ms/foundry/forum)

## الاختبارات 

> **ملاحظة حول الاختبارات**: جميع الاختبارات موجودة في مجلد Quiz-app في etc\quiz-app، أو [عبر الإنترنت هنا](https://ff-quizzes.netlify.app/) وهي مرتبطة من داخل الدروس. يمكن تشغيل تطبيق الاختبار محليًا أو نشره على Azure؛ اتبع التعليمات في مجلد `quiz-app`. يتم ترجمتها تدريجيًا.

## مطلوب مساعدة

هل لديك اقتراحات أو وجدت أخطاء إملائية أو في الكود؟ قم بإنشاء مشكلة أو طلب سحب.

## شكر خاص

* **✍️ المؤلف الرئيسي:** [دميتري سوشنيكوف](http://soshnikov.com)، دكتوراه
* **🔥 المحرر:** [جين لوبر](https://twitter.com/jenlooper)، دكتوراه
* **🎨 رسام الملاحظات التخطيطية:** [تومومي إيمورا](https://twitter.com/girlie_mac)
...
إذا واجهت صعوبة أو كانت لديك أسئلة حول بناء تطبيقات الذكاء الاصطناعي. انضم إلى متعلمين آخرين ومطورين ذوي خبرة في مناقشات حول MCP. إنها مجتمع داعم حيث يتم الترحيب بالأسئلة ومشاركة المعرفة بحرية.
